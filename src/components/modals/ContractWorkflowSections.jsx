          ...
          <div className="space-y-1">
            {jaminan.map(j => (
              <div key={j.id} className="flex items-center justify-between text-xs bg-surface p-2 rounded-lg">
                ...
                {j.file_jaminan && <a href={resolveFileUrl(j.file_jaminan)} target="_blank" rel="noreferrer" className="text-blue-600"><Download size={12} /></a>}
              </div>
            ))}
          </div>
        )}
          ...
          <div className="space-y-1">
            {documents.map(d => (
              <div key={d.id} className="flex items-center justify-between text-xs bg-surface p-2 rounded-lg">
                <span>{d.nama}</span>
                <div className="flex items-center gap-2">
                  <a href={resolveFileUrl(d.file_path)} target="_blank" rel="noreferrer" className="text-blue-600"><Download size={12} /></a>
                  {canEdit && (
