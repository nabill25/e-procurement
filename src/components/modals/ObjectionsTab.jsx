            ...
            return (
              <div key={obj.id} className="border border-border rounded-xl p-4 bg-white shadow-sm space-y-3">
                ...
                <div>
                  ...
                  {obj.attachment_path && (
                    <a href={`http://localhost:3001${obj.attachment_path}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-[10px] text-blue-600 hover:underline mt-2">
