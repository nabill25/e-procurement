...
<style type="text/css">
  .konfirmasi-pendaftaran-page small { font-weight: bold; font-size: 11.5px }
</style>

<div class="row konfirmasi-pendaftaran-page">
    ...
    <div class="card">
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body">
          ...
          <?php // Tindak lanjut kelengkapan dokumen dari verifikator (fitur 2026-09-01)
          $this->load->library("libtindaklanjut"); $libTL = new libtindaklanjut();
          if ($libTL->adaPermintaanTerbuka($this->ID)) {
            echo $libTL->panelPenyedia($this->ID);
          }
          ?>
                    ...
                    <tr>
                      ...
                      <td style="width: 83%">
                        ...
                        if ($rekanan->getField("WAJIB") == '*') {
                           echo '<span class="text-danger">'.$rekanan->getField("WAJIB").'</span>';
                        } else {
                          echo "";
                        } ?>
                        <?php
                      ...
                      <td style="width: 15%" class="text-center">
                        <img class="simbol" src="images/<?=$rekanan->getField("SIMBOL")?>.png" alt="Status kelengkapan">
                      </td>
                    </tr>
                      <?php
              ...
              <?php
                ...
                ?>
                    <tr>
                      ...
                      <td style="width: 83%">
                       ...
                       <?php
                        if ($rekanan_keuangan->getField("WAJIB") == '*') {
                           echo '<span class="text-danger">'.$rekanan_keuangan->getField("WAJIB").'</span>';
                        } else {
                          echo "";
                        } ?>
                      ...
                      <td style="width: 15%" class="text-center">
                        <img class="simbol" src="images/<?=$rekanan_keuangan->getField("SIMBOL")?>.png" alt="Status kelengkapan">
                      </td>
                    </tr>
                      <?php
                    ...
                    <tr>
                      ...
                      <td style="width: 83%">
                        ...
                        if ($rekanan_perpajakan->getField("WAJIB") == '*') {
                           echo '<span class="text-danger">'.$rekanan_perpajakan->getField("WAJIB").'</span>';
                        } else {
                          echo "";
                        } ?>
                        <?php
                      ...
                      <td style="width: 15%" class="text-center">
                        <img class="simbol" src="images/<?=$rekanan_perpajakan->getField("SIMBOL")?>.png" alt="Status kelengkapan">
                      </td>
                    </tr>
                      <?php
                    ...
                    <tr>
                      ...
                      <td style="width: 83%">
                        ...
                        if ($rekanan_teknis ->getField("WAJIB") == '*') {
                           echo '<span class="text-danger">'.$rekanan_teknis  ->getField("WAJIB").'</span>';
                        } else {
                          echo "";
                        } ?>
                        <?php
                      ...
                      <td style="width: 15%" class="text-center">
                        <img class="simbol" src="images/<?=$rekanan_teknis->getField("SIMBOL")?>.png" alt="Status kelengkapan">
                      </td>
                    </tr>
                      <?php
