 ...
 *
 * Email PENGINGAT OTOMATIS ke PENYEDIA (dikirim oleh cron
 * cronjobs_reminder_kelengkapan) kalau dokumen belum juga dilengkapi.
 * Dipanggil lewat: main/loadUrl/email/rekanan_reminder_lengkapi/<REKANAN_ID>
 */
...
$tindakLanjut->selectByRekananId($reqId);
$catatanPermintaan = '';
while ($tindakLanjut->nextRow()) {
    if ($tindakLanjut->getField("JENIS") == 'PERMINTAAN') {
        $catatanPermintaan = $tindakLanjut->getField("CATATAN");
    }
}
?>
    ...
    <table align="center" style="vertical-align:top;width:600px;max-width:600px;background-color:#fff;" width="600">
      <tbody><tr><td style="width:596px;padding:30px 30px 40px;" width="596">
        ...
        <p style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          ...
          Ini adalah <b>pengingat</b> bahwa dokumen perusahaan Anda masih menunggu untuk dilengkapi
          pada sistem <a href="<?= SYSTEM_NAME_URL ?>">e-Procurement - <?= SYSTEM_NAME_PT ?></a>.
          Proses verifikasi Anda belum bisa dilanjutkan sampai dokumen dilengkapi.
        </p>
        ...
        <table style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          ...
          <tr>
            ...
            <td bgcolor="#FFF" style="padding:4px 8px;border:none;"><i><?= nl2br(htmlspecialchars($catatanPermintaan)) ?></i></td>
          </tr>
          <?php endif; ?>
        </table>
        ...
        <p style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          ...
          lengkapi dokumen yang diminta, lalu tekan tombol <b>&ldquo;Sudah Saya Lengkapi&rdquo;</b>.
        </p>
