 ...
 *
 * Email ke VERIFIKATOR: penyedia sudah konfirmasi melengkapi berkas.
 * Dipanggil lewat: main/loadUrl/email/rekanan_sudah_lengkap/<REKANAN_ID>
 */
    ...
    <table align="center" style="vertical-align:top;width:600px;max-width:600px;background-color:#fff;" width="600">
      <tbody><tr><td style="width:596px;padding:30px 30px 40px;" width="596">
        ...
        <p style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          <b>Verifikator yang terhormat,</b><br>
          Penyedia berikut telah menyatakan sudah melengkapi dokumen yang diminta pada sistem
          <a href="<?= SYSTEM_NAME_URL ?>">e-Procurement - <?= SYSTEM_NAME_PT ?></a>. Mohon diperiksa kembali.
        </p>
        ...
        <table style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          ...
          <?php if ($catatan): ?>
          <tr>
            <td bgcolor="#FFF" style="padding:4px 8px;border:none;vertical-align:top;">Keterangan Penyedia</td>
        ...
        <p style="text-align:left;font-size:12px;line-height:18px;font-family:'Helvetica',Arial,sans-serif;font-weight:200;">
          ...
          buka halaman Validasi Rekanan, periksa ulang dokumen penyedia tersebut lewat menu
          <b>Tindak Lanjut Kelengkapan</b>.
        </p>
