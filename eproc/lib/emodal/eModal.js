    ...
    define(['jquery'], function ($, root) {
        ...
        function _getFooter(buttons) {
            ...
            if (buttons) {
                ...
                messageFotter.append('<button class="x btn btn-primary close-modal" data-dismiss=modal type=button>Close</button>');
            }
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                // return $('<div class="modal fade" tabindex="-1"><style>.modal-xl{width:calc(100% - 80px);}</style>'
                return $('<div class="modal fade" tabindex="-1"><style>.modal-xl{width:calc(100%);}</style>'
                ...
                // + ' <div class=modal-header><button type=button class="x close" data-dismiss=modal></button><h4 class=modal-title></h4></div>'
                + '</div>'
                + '</div>'
                + '</div>')
