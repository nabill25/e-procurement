...
function tambahRekanan(rekanan_id, nama, alamat, email)
{
	...
	if(rv == true)
	{
		...
		$("#tbodyRekanan").append('<tr><td>'+nama+'</td><td>'+alamat+'</td><td>'+email+'</td><td><input type="hidden" name="reqRekananId[]" value="'+rekanan_id+'"><a title="#" onclick="$(this).parent().parent().remove();"><img src="images/button_cancel.png" width="16" height="16" border="0" /></a></td></tr>');
		eModal.close();
	}
}
