	        ...
	        <tbody>
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <h1 style="font-size: 20px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000; margin-bottom: 10%;">Undangan e-Reverse Auction</h1> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; "> 
	            	...
	            	Menunjuk paket pengadaan "<?= $paketInfo->nama?>", kami bermaksud mengundang Saudara untuk melaksanakan e-Reverse Auction, pada: <br>
	              </p> 

	            	<?php 
              	$realDateBidding = getFormattedDate($exBiddingMulai[0]).' '.addWIB($exBiddingMulaiTime[0].':'.$exBiddingMulaiTime[1]).' selama '.$reqBidingMenit.' menit';
								?>
	              ...
	              <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; " width="100%">
                	  <tr>
									      ...
									      <td style="padding:4px 8px;"><?= ucwords($realDateBidding) ?></td>
									  </tr> 
									  <tr>
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	               Berdasarkan Jadwal di atas penyedia barang jasa harap login melalui aplikasi <a href="<?php echo base_url()?>" target="_blank">e-Procurement - <?php echo SYSTEM_NAME_PT ?></a> pilih detil paket pekerjaan "<?php echo $paketInfo->nama?>" kemudian klik menu Klarifikasi & e-Reverse Auction. 
               	</p>
