  ...
  <head>
    ...
    $(function(){
      $('#ffAddFileKontrak').form({
        url:'contracting_json/addfilejaminan',
        onSubmit:function(){ 
            ...
            <form id="ffAddFileKontrak" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  ...
                  <input type="text" name="reqTanggal" id="reqTanggal" class="form-control easyui-datebox span9" value="<?= dateToPageCheck($datajaminan->getField('TANGGAL_JAMINAN'))?>" required style="width: 110%"/>  
                </div>
              </div>  
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label>File</label>
                  <input type="file" name="reqLinkFile" id="reqLinkFilePDF" class="easyui-validatebox" <?php if ($datajaminan->getField('FILE_JAMINAN')) { } else { echo 'required'; } ?> validType="fileType['docx','zip', 'pdf']" />
                  <?= UPLOAD_PDF_ZIP_DOC_10MB ?>
                  <input type="hidden" name="reqLinkFileTemp" id="reqLinkFileTemp" value="<?= $datajaminan->getField('FILE_JAMINAN') ?>" />
