...
<div class="row">
  ...
  <div class="form-group col-md-9 text-right">
    <a href="main/loadUrl/report/contracting_rekapitulasi_excel" class="<?= CLASS_BTN_PRIMARY ?> text-white" title="Lihat Kontrak"><span class="fa fa-file"></span> &nbsp; Download Laporan </a>
