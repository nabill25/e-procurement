      ...
      <div class="card-content">
        <div class="p-1">
          <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
            <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Approve Kontrak</strong>
          </div> 
          <div class="p-1" >
            <form id="ffApproveKontrak" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label>Nama Pemeriksa</label>
                  <input type="text" name="reqPemeriksaNama" id="reqPemeriksaNama" class="form-control easyui-validatebox span9" required/>
                </div>
              </div> 
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label>Jabatan Pemeriksa</label>
                  <input type="text" name="reqPemeriksaJabatan" id="reqPemeriksaJabatan" class="form-control easyui-validatebox span9" required/>
                </div>
              </div> 
