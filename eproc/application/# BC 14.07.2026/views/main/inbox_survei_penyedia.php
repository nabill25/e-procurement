...
$dataInbox->selectByPenerima(array("A.PARENT" => 0, "A.INBOXCATEGORYID" => '2', "A.PENERIMA" => $this->REKANAN_ID)); // 1:RFI 2:Survey 3:Complain
?>
		    ...
		    <div class="form-group col-md-12">
		        <div class="card-body area-datatable"> 
		          <div class="form-body">  
		            <section id="lists">
		                <div id="basic-list">
		                    <input type="text" class="search form-control round border-primary mb-1" placeholder="Cari Survei . . ." />
		                    <div class="row">
		                    ...
		                    <ul class="list-group list" style="height: 700px; overflow-y: scroll;"> 
		                    	...
		                    	while ($dataInbox->nextRow()) { 
													$dataInboxReplay->selectByPenerima(array("A.PARENT" => $dataInbox->getField("INBOXID"), "A.INBOXCATEGORYID" => '2', "A.CREATED_BY" => $this->REKANAN_ID), -1, -1); // 1:RFI 2:Survey 3:Complain
		                        ...
		                        <li class="list-group-item" style="background-color: <?= $background ?>;">
		                            <h3 class="name">
                    					...
                    					<a onclick="openAdd('main/loadUrl/main/inbox_survei_detail?id=<?=$dataInbox->getField("INBOXID")?>')" class="icon-list iconsize" data-toggle="tooltip" data-placement="bottom" title="Detail"></a> &nbsp; 
                    					<a href="main/index/inbox_survei_penyedia_add?id=<?=$dataInbox->getField("INBOXID")?>" class="icon-action-undo iconsize" data-toggle="tooltip" data-placement="bottom" title="Reply"></a>  
		                            </h3> 
		                        </li> 
		                    	<?php 
		                    	} ?>
