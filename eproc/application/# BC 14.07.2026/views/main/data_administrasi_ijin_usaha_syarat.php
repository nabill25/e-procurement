...
$reqIjinUsaha = httpFilterRequest('reqIjinUsaha');
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(function(){
          ...
          <?php
          if($reqIjinUsaha == 1){
            echo "top.setElementValue('reqDataIjinUsahaLabel','Data Lengkap');";
          }elseif($reqIjinUsaha == 3){
            echo "top.setElementValue('reqDataIjinUsahaSIUJKLabel','Data Lengkap');";
          }elseif($reqIjinUsaha == 4){
            echo "top.setElementValue('reqDataIjinUsahaSIUILabel','Data Lengkap');";
          }elseif($reqIjinUsaha == 5){
            echo "top.setElementValue('reqDataIjinUsahaLainLabel','Data Lengkap');";
          }
          echo "top.reloadIjinUsaha(".$reqIjinUsaha.");";
          echo 'top.closePopup();';
          ?>
                }
            });
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Data Administrasi - Ijin <?=$reqBidang?></strong>
        </div>
        <div class="p-1">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            <div class="col-md-12">
              <!-- <div class="judul-grup"></div> -->
              <?php
              if($reqMode == "insert")
              {
              ?>
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  ...
                  <input type="text" name="reqIjinUsaha" class="easyui-combobox span3"  id="reqIjinUsaha"
                              data-options="valueField:'id',textField:'text',url:'ijin_usaha_json/combo'"  value="<?=$reqIjinUsaha?>" />
                </div>
              </div>
              <?php
              }
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  ...
                  <input name="reqNomorIjin" type="text" title="Nomor ijin harus diisi" class="form-control easyui-validatebox span9" required id="reqNomorIjin" value="<?=$reqNomor?>" size="50" />
                </div>
              </div>

              <div class="row">
                <div class="form-group col-md-2 mb-2">
                  <label style="width: 100%">Tanggal ijin</label>
                  <input type="text" style="width: 150px" title="Tanggal ijin harus diisi" class="form-control easyui-datebox" name="reqTanggalIjin" id="reqTanggalIjin" value="<?=dateToPageCheck($reqTanggalIjin)?>" required />
                </div>
                <div class="form-group col-md-2 mb-2">
                  <label style="width: 100%">Tanggal berakhir</label>
                  <input type="text" style="width: 150px" title="Tanggal berakhir harus diisi" class="form-control easyui-datebox span4" name="reqTanggalBerakhir" id="reqTanggalBerakhir" value="<?=dateToPageCheck($reqTanggalBerakhir)?>" required />
                </div>
              </div>

              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label>Pemberi ijin</label>
                  <input name="reqInstansiPemberiIjin" title="Instansi harus diisi" class="form-control easyui-validatebox span9" type="text" id="reqInstansiPemberiIjin" value="<?=$reqInstansi?>" size="80" required />
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label style="width: 100%">File</label>
                   <input type="file" name="reqLinkFile" id="reqLinkFilePDF" size="30" <?php if($reqLinkFileTemp == "") { ?> required <?php } ?> class="easyui-validatebox span9"  validType="fileType['pdf']" />
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                          ...
                          <td><input type="hidden" name="reqBidangUsahaId[]" value="<?=$rekanan_bidang_usaha->getField("BIDANG_USAHA_ID")?>" /><a title="#" onclick="$(this).parent().parent().remove();"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php
                        }
                        ?>
