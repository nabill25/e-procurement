  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Pengumuman Prakualifikasi </h4>
            ...
            <form id="ff" class="easyui-form form-horizontal" method="post" data-options="novalidate:true" enctype="multipart/form-data">
                <div class="col-md-12">
                    ...
                    ?>
                        ...
                        <iframe src="<?=$FILE_DIR.str_replace("'", "''", $paket_dokumen->getField("PATH_FILE"))?>" style="width:100%; height:900px;"></iframe>
                        <?php
                            }
                        ?>
                </div>
