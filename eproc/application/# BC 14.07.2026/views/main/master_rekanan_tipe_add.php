...
$rekanan_tipe->selectByParams(array("REKANAN_TIPE_ID" => $reqId));
$rekanan_tipe->firstRow();
$reqNama = $rekanan_tipe->getField("NAMA");
$reqStatus = $rekanan_tipe->getField("STATUS");
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Bantuk Usaha</strong>
        </div>
        <div class="p-1">
            ...
            <div class="form-group col-md-12 mb-2">
              ...
              <fieldset class="ccheckboxsas">
                <div class="d-inline-block">
                  ...
                  if ($reqStatus == '1') { ?>
                    <label>
                      <input type="radio" name="reqStatus" value="1" checked="">
                      <span style="margin-right:10px"> Aktif </span>
                    </label>
                    <label>
                      <input type="radio" name="reqStatus" value="0">
                      <span style="margin-right:10px"> Non Aktif </span>
                    </label>
                  <?php
                  } elseif ($reqStatus == '0') { ?>
                    <label>
                      <input type="radio" name="reqStatus" value="1">
                      <span style="margin-right:10px"> Aktif </span>
                    </label>
                    <label>
                      <input type="radio" name="reqStatus" value="0" checked="">
                      <span style="margin-right:10px"> Non Aktif </span>
                    </label>
                  <?php
                  } else { ?>
