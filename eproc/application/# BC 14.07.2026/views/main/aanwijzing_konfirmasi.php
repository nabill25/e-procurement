...
<link href="lib/aanwijzing/css/core.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
	...
	function refresh() {
	  $.getJSON("json/aanwijzing_konfirmasi_json/json/?reqId=<?=$reqId?>", function(json) {
		if(json.length) {
    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">                          	
      <tbody>
        <tr class="judul-kolom">
          <th colspan="100">Monitoring rekanan yang telah konfirmasi.</th>
        </tr>
        <tr class="gelap">
          ...
          {
          ?>
              <td width="20%" style="text-align:center"><strong><?=$arrPaketRekanan[$i]["REKANAN"]?></strong></td>
          <?php
          }
          ?>
        </tr>
