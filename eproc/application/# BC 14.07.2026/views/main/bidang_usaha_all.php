...
<body class="body-popup">
        	...
        	<div class="col-md-12 col-treegrid">
            	<div class="area-konten-atas">
             	...
             	<div id="idpencarian" class="area-pencarian" style="padding:10px">
                	<input class="" placeholder="  Pencarian K B L I  &  S B U" name="reqPencarian" aria-controls="example" type="search" style="width:100%; border-radius:20px; height: 30px; padding-left: 20px;">
                </div>
				<div id="tableContainer" class="tableContainer tableContainer-treegrid">
                	<table id="treeSatker" class="easyui-treegrid" style="width:100%;height:100px"
                            data-options="
                                url: 'bidang_usaha_json/jsonaktifall',
                                method: 'get',
                                idField: 'id',
                                treeField: 'text'
                            ">
    ...
    $(document).ready( function () {
		...
		$('input[name=reqPencarian]').change(function() {
			...
			var urlApp = 'bidang_usaha_json/jsonaktifall/?reqSearch='+ value;
			$('#treeSatker').treegrid(
			{
				url: urlApp
			});	
