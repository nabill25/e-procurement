...
$(document).ready(function() {
	...
	$(function(){
		$('#ff').form({
			url:'rekanan_json/data_administrasi_umum_perorangan_ubah',
			onSubmit:function(){
        ...
        <div class="card">
            ...
            <div class="card-content collapse show border-info border-darken-2">
              <div class="card-body">
                ...
                if ($reqStatusValidasi == '1') {  echo NOTIF_PENYEDIA_TERVERIFIKASI;  } ?>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-5 mb-2">
                      <label>NPWP</label> <br>
                      <?php if (file_exists('uploads/rekanan/'.$reqNPWPFileTemp)) { ?>
                      <a href="<?= base_url('uploads/rekanan/').$reqNPWPFileTemp ?>" class="badge badge-primary">Download file NPWP</a>
                      <?php } ?>
                  ...
                  <div class="row">
                    <div class="form-group col-md-7 mb-2">
                      <label>No. KTP</label>
                      <input type="text" class="form-control easyui-validatebox span4" value="<?=$reqKTP?>" name="reqKTP" id="reqKTP" maxlength="20" required readonly="">
                    </div> 
                    <div class="form-group col-md-5 mb-2">
                      <label>KTP</label> <br>
                      <?php if (file_exists('uploads/rekanan/'.$reqKTPFileTemp)) { ?>
                      <a href="<?= base_url('uploads/rekanan/').$reqKTPFileTemp ?>" class="badge badge-primary">Download file KTP</a>
                      <?php } ?>
                  ...
                  <div class="row">
                    <div class="form-group col-md-7 mb-2">
                      <label style="width: 100%">No. PKP</label>
                      <input type="text" class="form-control easyui-validatebox span4" value="<?=$reqPKP?>" name="reqPKP" id="reqPKP" onkeydown="return format_PKP(event);" maxlength="20" required readonly>
                    </div> 
                    <div class="form-group col-md-2 mb-2">
                      <label>PKP</label> <br>
                      <?php if (file_exists('uploads/rekanan/'.$reqPKPFileTemp) && $reqPKPFileTemp != '' ) { ?>
                      <a href="<?= base_url('uploads/rekanan/').$reqPKPFileTemp ?>" class="badge badge-primary">Download file PKP</a>
                      <?php } ?>
                    </div>  
                    <div class="form-group col-md-2 mb-2">
                      <label style="width: 100%"> Tanggal </label> 
                      <input type="text" style="width:120px" name="reqMasaBerlakuPKP" title="Tanggal harus diisi" id="reqMasaBerlakuPKP" class="form-control easyui-datebox" value="<?=isset($reqMasaBerlakuPKP)?$reqMasaBerlakuPKP:''?>"  readonly/>
                    </div> 
                  </div>    
                  ...
                  <div class="form-actions">
                    <a href="main/index/data_administrasi_umum_perorangan" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a> 
