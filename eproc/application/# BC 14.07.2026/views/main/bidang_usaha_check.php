                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        if ($reqKualifikasiRekanan == '3') { // 1:Kecil 2:Non-kecil 3:kecil/non-kecil
                          $paket_bidang_usaha_check->selectByParamsBidangUsaha(array("a.BIDANG_USAHA_ID" => $bidang_usaha_id));
                        } else {
                          $paket_bidang_usaha_check->selectByParamsBidangUsaha(array("a.BIDANG_USAHA_ID" => $bidang_usaha_id, 'b.REKANAN_KUALIFIKASI_ID' => $reqKualifikasiRekanan));
                        }
                        $no=1;
