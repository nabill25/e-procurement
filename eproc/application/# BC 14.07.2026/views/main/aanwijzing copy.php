...
<div class="span12">
 <div class="card">
  <h3 class="card-heading simple">Aanwijzing</h3>
   <div class="card-body">
            ...
            <tr>
              ...
              if($this->USER_TYPE_ID == 3 || $this->USER_TYPE_ID == 7)
              {
                  if($aanwijzing_publish->getField("PUBLISH") == 0)
                  {
                      ...
                      {
              ?>
                          <a title="#" onClick="publishAanwijzing();" id="btnPublish" class="btn-cetak">Publish</a>
              <?
                      }
                  }
              ?>
                  <a href="main/loadUrl/report/aanwijzing_cetak_pdf/?reqId=<?=$reqId?>" target="_blank" class="btn-cetak">Cetak</a>
              <?
              }
              else
              {
              ...
              ?>
                  <a href="main/loadUrl/report/aanwijzing_cetak_pdf/?reqId=<?=$reqId?>" target="_blank" <?=$style?> id="btnCetak"  class="btn-cetak">Cetak</a>
              <?
              }
              ?>
              </td>
