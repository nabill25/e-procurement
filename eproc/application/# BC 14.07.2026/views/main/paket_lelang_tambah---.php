...
function CekHPSMaksimal(id)
{
  ...
  if (converttotalHPS > converttotalMaks) {
    alertError3('Harga Perkiraan tidak boleh diatas Harga Perkiraan yang sudah di tetapkan yaitu '+formatNumber(numMaks)) ;
    ...
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">
          <?php
          if($cekPermohonanCount == 0 && $reqId == "")
          { echo 'Tambah Pengadaan'; } else { echo 'Edit Pengadaan  <a class="'.CLASS_BTN_INFO.'" onclick="openAdd(\'main/loadUrl/main/permohonan_lelang_panitia_add/?reqId='.$reqPermohonanId.'\')"> Lihat Detail Permohonan</a>'; } ?>
          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-1 mb-2">
                ...
                <input type="text" name="reqMataUang" class="form-control easyui-combobox span2" data-options="valueField:'id',textField:'text',url:'mata_uang_json/comboMataUang'"  value="<?=$reqMataUang?>" style="width:100%" readonly/>
              </div>
              <div class="form-group col-md-11 mb-2">
                <label>Harga Perkiraan</label>
                <input title="Nilai pekerjaan harus diisi" class="form-control span9 easyui-validatebox"  name="reqNilaiPekerjaan" type="text" id="reqNilaiPekerjaan" value="<?=$reqNilaiPekerjaan?>"  readonly pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" OnBlur="CekHPSMaksimal('reqNilaiPekerjaan')" data-type="currency"/>
            ...
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                ...
                <input title="Lokasi pekerjaan harus diisi" class="form-control easyui-validatebox span3"  name="reqLokasiPekerjaan" type="text" id="reqLokasiPekerjaan" value="<?=isset($reqLokasiPekerjaan) ? $reqLokasiPekerjaan : $this->libbreadcrumb->unitkerja($this->UNIT_KERJA_ID) ?>" readonly />
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12 mb-2">
              ...
              <div class="form-group col-md-3 mb-2">
                ...
                <input type="text" name="reqJenisPekerjaan" class="easyui-combobox span3" id="reqIjinUsaha"
                        data-options="valueField:'id',textField:'text',url:'paket_jenis_json/combo',
                                        ...
                                        }"  value="<?=isset($reqJenisPekerjaan) ? $reqJenisPekerjaan : ''?>" style="width: 300%"/>
              </div>
              <div class="form-group col-md-3 mb-2">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-2 mb-2" id="tPassingGrade" <?php if ($reqMetodeEvaluasi == '2') {} else { ?> style="display:none" <?php } ?>>
