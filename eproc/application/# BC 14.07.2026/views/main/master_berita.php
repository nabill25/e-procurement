		...
		/* Click event handler */
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_berita_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_berita_add/?reqId="+anSelectedId);
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("berita_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("berita_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Berita dan Pengumuman</h4>
