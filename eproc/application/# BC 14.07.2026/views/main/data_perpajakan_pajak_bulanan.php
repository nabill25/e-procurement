  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Laporan Pajak Bulanan(PPN)
          <?php
          ...
          if (array_intersect($this->libsession->cekStatusValidasiRekanan(), $arrStatusValidasi)) {
            ...
            if ($this->libsession->cekChecklist('ppn') || ($reqStatusUser == '0' && $reqStatusValidasi == '1')) // Check Checlist Verifikator
            {
                  ...
                  <table class="table table-bordered table mb-0">
                    <tbody>
                      <tr class="judul-kolom">
                        ...
                        <th>Nomor</th>
                        <th>Tanggal</th>
                        <th class="text-center" style="width:15%">File PPN</th>
                      </tr>
                      <?php
                      if ($rekanan_ppn->countRow() == 0) {
                        echo '<tr>
                      ...
                      ?>
                       <tr >
                           ...
                           if ($rekanan_ppn->getField("PATH_FILE")) {
                            echo '<td class="text-center"><a target="_blank" href="'.base_url('uploads/ppn_pph/').$rekanan_ppn->getField("PATH_FILE").'" class="badge badge-primary">Download file</a></td>';
                           } else {
                            echo '<td class="text-center"><span class="badge badge-danger">Belum upload</span></td>';
                           }
                            ?>
                      </tr>
                      <?php $i++;}}else{
