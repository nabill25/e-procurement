  ...
  <input type="hidden" id="tahun" value="<?=$getTahun?>">
    ...
    *************************************-->
    ...
    if ($getTahun != 'all'){
        ...
        $sumTenderFinal = $sumTenderFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "1", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumTenderTerbatasFinal = $sumTenderTerbatasFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "3", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumTenderCepatFinal = $sumTenderCepatFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "7", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumPengadaanLangsungFinal = $sumPengadaanLangsungFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "2", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumPenunjukanLangsungFinal = $sumPenunjukanLangsungFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "5", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumPembelianLangsungFinal = $sumPembelianLangsungFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "6", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumTenderKualifikasiFinal = $sumTenderKualifikasiFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "10", "TAHUN_PERMOHONAN" => $getTahun));
        ...
        $sumOfflineFinal = $sumOfflineFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "9", "TAHUN_PERMOHONAN" => $getTahun));

        $countPurchasingPemerintah = $countPurchasingPemerintah->getCountByParams(array( "A.PAKET_METODE_LELANG_ID" => "12", "TAHUN_PERMOHONAN" => $getTahun));
        $sumPurchasingPemerintah = $sumPurchasingPemerintah->getSumByParams(array( "A.PAKET_METODE_LELANG_ID" => "12", "TAHUN_PERMOHONAN" => $getTahun));
        $sumPurchasingPemerintahFinal = $sumPurchasingPemerintahFinal->getSumFinalByParams(array( "A.PAKET_METODE_LELANG_ID" => "12", "TAHUN_PERMOHONAN" => $getTahun));
    } else {
        $tahun = '';
