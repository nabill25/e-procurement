...
$dokumen->selectByParams(array("TEMPLATE_ID" => $reqId));
$dokumen->firstRow();
          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
            ...
            <div class="row">
              <div class="form-group col-md-8 mb-2">
                ...
                <input type="file" name="reqLinkFile" id="reqLinkFile" size="30" <?php if($reqLinkFileTemp == "") { ?> class="easyui-validatebox span9" <?php } ?> maxlength="1" validType="fileType['zip','pdf','doc']"/>
