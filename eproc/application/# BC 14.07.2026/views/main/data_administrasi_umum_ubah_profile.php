...
$(document).ready(function() {
  ...
  $('#reqBankId, #reqKota, #reqKecamatan, #reqKelurahan').combobox({
              ...
              <div class="card-body">
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3 mb-2">
                      <label style="width: 100%">Kelurahan <?=isset($reqKelurahan) ? $reqKelurahan : ''?></label>
                  ...
                  <div class="row">
                    <div class="form-group col-md-3 mb-2">
                      ...
                      <input type="text" name="reqKodepos" value="<?=$reqKodepos?>" title="Kodepos harus diisi" class="form-control easyui-validatebox span2" maxlength="6" onkeypress="return isNumberKey(event)" required  />
                    </div>
                    <!-- <div class="form-group col-md-2 mb-2">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-5 mb-2">
                      ...
                      <input type="text" name="reqTeleponNo" id="reqTeleponNo" class="form-control easyui-validatebox span3" value="<?=$reqTeleponNo?>" maxlength="20" onkeypress="return isNumberKey(event)" required>
                    </div>
                    <div class="form-group col-md-1 mb-2">
                    ...
                    <div class="form-group col-md-5 mb-2">
                      <label>&nbsp;</label>
                      <input type="text" name="reqFaxNo" id="reqFaxNo" class="form-control easyui-validatebox span3" value="<?=$reqFaxNo?>" maxlength="20" onkeypress="return isNumberKey(event)">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-md-6 mb-2">
                      ...
                      <input type="text" name="reqKontakPerson" id="reqKontakPerson" class="form-control easyui-validatebox span3" value="<?=$reqKontakPerson?>" placeholder="Narahubung" required>
                    </div>
                    <div class="form-group col-md-6 mb-2">
                      <label>No. HP</label>
                      <input type="text" name="reqKontakPersonHp" id="reqKontakPersonHp" class="form-control easyui-validatebox span3" value="<?=$reqKontakPersonHp?>" maxlength="20" onkeypress="return isNumberKey(event)" required>
                    </div>
                  </div>
                 ...
                 <div class="row">
                  <div class="form-group col-md-12 mb-2">
                    <label>Company Profile <?= UPLOAD_PDF_2MB ?></label><br>
                    <input type="file" name="reqLinkFile2" id="reqLinkFile2PDF" size="30" <?php if($tempCPFILE == "") { ?> required <?php } ?> class="easyui-validatebox"  validType="fileType['pdf']" />
                    <input type="hidden" name="reqLinkFile2TempNama" value="<?=$tempCPFILE?>">
                    <?php
                    if ($tempCPFILE) {
                       echo "File :".$tempCPFILE;
                     } ?>
                  </div>
                </div>
