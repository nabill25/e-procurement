...
if ($getTahun != 'all'){
 ...
 $countRUP->selectByParams(array(),-1,-1," AND A.PERMOHONAN_PAKET_ID IS NULL AND A.TAHUN = '".$getTahun."' ");
 $countTotalRUP = $countRUP->countRow();
 $sumPaguRUP->sumPaguByParams(array(),-1,-1," AND A.PERMOHONAN_PAKET_ID IS NULL AND A.TAHUN = '".$getTahun."' ");
 $sumPaguRUP->firstRow();
 $sumTotalPaguRUP = $sumPaguRUP->getField('TOTAL_PAGU');
 $sumTotalRABRUP = $sumPaguRUP->getField('TOTAL_RAB');

 $sumHPSRUP->sumHpsByParams(array("A.TAHUN_ANGGARAN" => $getTahun),-1,-1);
 $sumHPSRUP->firstRow();
 $sumTotalHPSRUP = $sumHPSRUP->getField('NILAI_HPS_PR');

 // Badge
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('1') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status1 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('2') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status2 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('3') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status3 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('4') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status4 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('5') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status5 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('6') AND A.TAHUN_ANGGARAN = '".$getTahun."' ");
 $status6 = $countPersiapan->countRow();

} else {
 $tahun = '';
 $countRUP->selectByParams(array(),-1,-1,"  AND A.PERMOHONAN_PAKET_ID IS NULL");
 $countTotalRUP = $countRUP->countRow();
 $sumPaguRUP->sumPaguByParams(array(),-1,-1," AND A.PERMOHONAN_PAKET_ID IS NULL ");
 $sumPaguRUP->firstRow();
 $sumTotalPaguRUP = $sumPaguRUP->getField('TOTAL_PAGU');
 $sumTotalRABRUP = $sumPaguRUP->getField('TOTAL_RAB');

 $sumHPSRUP->sumHpsByParams(array(),-1,-1);
 $sumHPSRUP->firstRow();
 $sumTotalHPSRUP = $sumHPSRUP->getField('NILAI_HPS_PR');

 // Badge
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('1')");
 $status1 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('2')");
 $status2 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('3')");
 $status3 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('4')");
 $status4 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('5')");
 $status5 = $countPersiapan->countRow();
 $countPersiapan->selectByParamsPersiapan(array(),-1,-1," AND A.APPROVAL_PERMOHONAN_PAKET_ANALISA IN ('6')");
 $status6 = $countPersiapan->countRow();
}
...
<div class="row">
  <div class="form-group col-md-3">
    ...
    <select class="form-control" id="setyear" onChange="return window.location = $(this).val()">
      <?php
      $selected = '';
      $url = base_url('main/index/dashboardperencanadiv?tahun=');
      $kurangdari = date('Y') - 5;
