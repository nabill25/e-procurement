...
$unit_kerja->firstRow();
$reqKode = $unit_kerja->getField("KODE");
$reqNama = $unit_kerja->getField("NAMA");
$reqAlamat = $unit_kerja->getField("ALAMAT");
$reqLokasi = $unit_kerja->getField("LOKASI");
$reqTelepon = $unit_kerja->getField("TELEPON");
$reqFax = $unit_kerja->getField("FAX");
$reqEmail = $unit_kerja->getField("EMAIL");
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Perusahaan</strong>
        </div>
        <div class="p-1">
          <form id="ff" class="form-horizontal" role="form" method="post" novalidate style="padding:0 50px">
            <div class="row">
              <div class="form-group col-md-4 mb-2">
                <label>Kode</label>
                <input type="text" name="reqKode" value="<?=$reqKode?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-4 mb-2">
                <label>Lokasi</label>
                <input type="text" name="reqLokasi" value="<?=$reqLokasi?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
              <div class="form-group col-md-4 mb-2">
                <label>Telepon</label>
                <input type="text" name="reqTelepon" value="<?=$reqTelepon?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
              <div class="form-group col-md-4 mb-2">
                <label>Fax</label>
                <input type="text" name="reqFax" value="<?=$reqFax?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                <label>Email</label>
                <input type="text" name="reqEmail" value="<?=$reqEmail?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12 mb-2">
