        ...
        ?>
         ...
         <form id="ff" method="post" class="form-horizontal" role="form">
          ...
          <table class="table table-striped table-hover" id="tbl_bidang">
            <tr>
              <td> 
                  <input value="42" name="reqApprove" id="" type="radio" style="cursor:pointer" checked="" /> &nbsp; Setujui dan teruskan ke Validator Keuangan &nbsp;&nbsp;
                  <input value="3241" name="reqApprove" id="" type="radio" style="cursor:pointer"/> &nbsp; Kembalikan ke Verifikator
              </td>
            </tr>
            <tr> 
              <td>Catatan <br>
