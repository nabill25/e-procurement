                            ...
                            <tr onClick="">
                              ...
                              <td>
                                ...
                                if ($aktif_auction2 == '1' && $cekAktif == '1') {
                                  ...
                                  echo "* * * *  * * * * ";
                                  echo substr($paket_rekanan->getField("KODE_REKANAN"), 0, 12);
                                }
                                ?>
                              </td>
                              <?php 
              ...
              <div class="col-md-4">
                <div class="col-md-12 text-center">
                  ...
                  if ($paketInfo->penawaran_harga_maksimal == '') {
                    echo '<span class="badge badge-danger" style="margin-bottom:1%">e-Reverse Auction belum bisa dimulai <a href="'.base_url('main/index/paket_lelang_tambah_auction/?reqId='.$reqId).'">klik disini</a></span>';
                  } else {
                    if ($aktif_auction2 == '0' && $cekAktif == '1') {
                    ?>
                ...
                <div class="col-md-12">
                 ...
                 ?>
                  ...
                  <span class="pull-right"><small>
                    ...
                    <?php 
                    if ($paketInfo->penawaran_harga_maksimal) { // Nilai HPS harus  ?>
                    <h4>Harga Perkiraan: <?php echo numberToIna($paketInfo->nilai_owner_estimate); ?></h4>
                    <?php } ?>
                  </span>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() { 
    // update otomatis harga maksimal
    $('#btnSubmit').click();
  });
</script>
