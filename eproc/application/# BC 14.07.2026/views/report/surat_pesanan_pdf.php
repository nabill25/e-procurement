...
/* LOGIN CHECK */
if($this->USER_LOGIN_ID == "" || ($this->USER_TYPE_ID != '12')) { //12:Pengelola Kontrak, 20:Pemeriksa kontrak
...
$html .= file_get_contents(base_url()."main/loadUrl/report/surat_pesanan?reqId=".$reqId."&reqConRekId=".$reqConRekId."&reqSuratPesananId=".$reqSuratPesananId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));	
...
ob_end_clean();
$mpdf->Output('Kontrak-'.SYSTEM_NAME.'-'.$unitkerja.'.pdf','I');
exit;
//==============================================================
//==============================================================
//==============================================================
