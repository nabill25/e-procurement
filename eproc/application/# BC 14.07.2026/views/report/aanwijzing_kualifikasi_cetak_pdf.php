...
{
	$paket_rekanan->selectByParamsPaketLelang(array("PAKET_ID" => $reqId, "REKANAN_ID" => $reqToken), -1, -1, " AND TANGGAL_DAFTAR IS NOT NULL");
...
$html .= file_get_contents(SYSTEM_URL_EMAIL."/main/loadUrl/report/aanwijzing_kualifikasi_cetak/?reqId=".$reqId, false, stream_context_create($arrContextOptions));
