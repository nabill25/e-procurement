...
$html .= file_get_contents(base_url()."main/loadUrl/report/klarifikasi_cetak/?reqId=".$reqId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));						
