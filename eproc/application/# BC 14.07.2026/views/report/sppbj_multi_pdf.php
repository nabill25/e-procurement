...
if($this->USER_LOGIN_ID == "" || ($this->USER_TYPE_ID != '12' && $this->USER_TYPE_ID != '20')) { //12:Pengelola Kontrak, 20:Pemeriksa kontrak
...
$html .= file_get_contents(base_url()."main/loadUrl/report/sppbj_multi?reqId=".$reqId."&reqRekananId=".$reqRekananId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));
