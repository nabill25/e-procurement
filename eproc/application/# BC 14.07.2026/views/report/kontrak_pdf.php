...
/* LOGIN CHECK */
if($this->USER_LOGIN_ID == "" || $this->USER_TYPE_ID != '12') { //12:Pengelola Kontrak
...
$html .= file_get_contents(base_url()."main/loadUrl/report/kontrak?reqId=".$reqId."&reqPaketId=".$reqPaketId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));	
