  ...
  class PaketEvaluasiPersonil extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$str = "
				...
				VALUES (".$this->getField("PAKET_EVAL_PERSONIL_ID").", ".$this->getField("PAKET_ID").", '".$this->getField("JABATAN")."', 
				   ...
				   '".$this->getField("NILAI")."', '".$this->getField("NILAI_MINIMUM")."', '".$this->getField("SKA")."', '".$this->getField("CV")."')"; 
	...
	function deleteIn()
	{
        $str = "DELETE FROM PAKET_EVAL_PERSONIL
                WHERE 
                  PAKET_ID = '".$this->getField("PAKET_ID")."' AND NOT PAKET_EVAL_PERSONIL_ID IN (".$this->getField("PAKET_EVAL_PERSONIL_ID").")"; 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='')
	{
		$str = "SELECT PAKET_EVAL_PERSONIL_ID, PAKET_ID, JABATAN, 
                   PENDIDIKAN, PENGALAMAN, JUMLAH, 
                   NILAI, NILAI_MINIMUM, SKA, CV, (SELECT NAMA FROM PENDIDIKAN X WHERE X.PENDIDIKAN_ID = PENDIDIKAN) PENDIDIKAN_NAMA,
