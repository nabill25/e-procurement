  ...
  class PaketEvaluasiSertifikatLain extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->query = $str;
		$this->id = $this->getField("PAKET_EVAL_SERTIFIKAT_LAIN_ID");	
	...
	function updateSertifikat()
	{
		...
		$str = "UPDATE PAKET_EVAL_SERTIFIKAT_LAIN SET
				...
				WHERE PAKET_EVAL_SERTIFIKAT_LAIN_ID = '".$this->getField("PAKET_EVAL_SERTIFIKAT_LAIN_ID")."'
				"; 
				$this->query = $str;
		return $this->execQuery($str);
    }
	...
	function deleteNotIn()
	{
        $str = "DELETE FROM PAKET_EVAL_SERTIFIKAT_LAIN
                WHERE 
                  PAKET_ID = '".$this->getField("PAKET_ID")."' AND PAKET_EVAL_SERTIFIKAT_LAIN_ID NOT IN (".$this->getField("PAKET_EVAL_SERTIFIKAT_LAIN_ID").") "; 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='')
	{
		$str = "SELECT PAKET_EVAL_SERTIFIKAT_LAIN_ID, PAKET_ID, NAMA, 
		  				 NILAI_MINIMUM, NILAI, KETERANGAN, NILAI_MINIMAL,
