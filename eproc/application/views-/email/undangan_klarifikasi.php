...
$reqTanggalUndangan = getFormattedDate($paketundangan->getField("TANGGAL_UNDANGAN"));
	          ...
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                ...
	                Anda telah diundang untuk melakukan klarifikasi, dengan rincian sebagai berikut:
	              </p>
	              ...
	              <p>
	                ...
	                <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; " width="100%">
			            <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">Tanggal Undangan</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$reqTanggalUndangan .' '.$reqJam?></td>
						        </tr>
							    <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4; width:180px;">Peserta</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$reqPeserta?></td>
						        </tr>
							    <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">Pelaksanaan</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$reqPelaksanaan?></td>
						        </tr>
							    <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">Tempat / Lokasi</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$reqTempat?></td>
					        </tr>
							    <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">Keterangan</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$reqKeterangan?></td>
					        </tr>
	                </table>
	              </p> 
