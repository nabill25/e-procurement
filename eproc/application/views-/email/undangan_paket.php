	        ...
	        <tbody>
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <h1 style="font-size: 20px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000; margin-bottom: 10%;">Undangan Pengadaan</h1> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	              	Yang Terhormat <?=$paket_rekanan->getField("NAMA")?> saudara telah di undang untuk mengikuti Paket Pengadaan di <?= SYSTEM_NAME_PT ?>.  Detail Informasi paket pekerjaan :</a>
	              </p>   
	              ...
	              <p>
	                <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; " width="100%">
	                	...
	                	<tr>
		                      <td style="padding:4px 8px;  border:none; width:180px;">Nama Paket Pekerjaan</td>
		                      <td style="padding:4px 8px; border:none; width:10px;">:</td>
		                      <td style="padding:4px 8px;"><?=$paketInfo->nama?></td>
	                  	</tr>
	                	<tr>
		                      <td style="padding:4px 8px; border:none;">Kode PR</td>
		                      <td style="padding:4px 8px; border:none;">:</td>
		                      <td style="padding:4px 8px; border:none;"><?=$paketInfo->kode_pr?></td>
	                  	</tr>
	                  	<tr>
		                      <td style="padding:4px 8px; border:none;">Metode Pengadaan</td>
		                      <td style="padding:4px 8px; border:none;">:</td>
		                      <td style="padding:4px 8px; border:none;"><?=$paketInfo->metode_lelang_nama?> <?php //$paketInfo->metode_kualifikasi?></td>
	                  	</tr>
	                  	<tr>
		                      <td style="padding:4px 8px; border:none;">Lokasi Pekerjaan</td>
		                      <td style="padding:4px 8px; border:none;">:</td>
		                      <td style="padding:4px 8px; border:none;"><?=$paketInfo->lokasi?></td>
	                  	</tr> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	               Untuk mengetahui informasi lebih detail tentang paket pekerjaan yang dimaksud, silahkan login pada aplikasi e-Procurement - <?= SYSTEM_NAME_PT ?>. 
	               </p>
