...
<style type="text/css">
  ...
  .pagingPadd { background-color: #fff; padding: 10px 0 6px 10px }
    ...
    <div class="row"> 
      ...
      ?>
        <div class="col-xl-3 col-lg-6 col-12 <?= $pclass ?>" >
          <a href="<?= base_url('main/index/katalog?name='.$katalog_kategori->getField("url")) ?>">
            <div class="card">
      ...
      <?php 
        if ($totaldata == 15) {
          echo '<div class="col-xl-12 text-center">
                  <button type="submit" class="btn btn-primary" id="show"> Lihat Selengkapnya <i class="fa fa-chevron-down"></i></button>
                </div>';
        }
      $totaldata++;
      } ?>
      <div class="col-xl-12 text-center">
        <button type="submit" class="btn btn-danger" id="less"> Tutup Selengkapnya <i class="fa fa-chevron-up"></i></button>
      </div>
    </div>  
  </section> 
<?php 
            ...
            <div class="card-text">
              ...
              <div class="list-group">
                ...
                ?>
                  ...
                  <div class="dropdown">
                    <a href="#" class="dropdown list-group-item list-group-item-action flex-column align-items-start">
                      <div class="d-flex w-100 justify-content-between">
                        <h5><small><?= $key ?></small></h5>
                        <?php 
                        if ($totalSub > 0) {
                    ...
                    <?php 
                    if ($totalSub > 0) { 
                      echo '<div class="dropdown-menu show" style="display: block; position: absolute; width: 100%; margin-top: -40px; margin-left: 275px; float: none;">';
                    ...
                    ?>
                        <a href="<?= base_url('main/index/katalog?kategori='.$valSubKategori[1]) ?>" style="cursor: pointer">
                          <button class="dropdown-item" type="button" style="cursor: pointer"><?= $valSubKategori[0] ?></button>
                        </a>
                    <?php 
                      }
                      echo '</div>';
        ...
        <section id="basic-examples"> 
          <div class="row match-height">
            ...
            if ($subKaetgoriLabel != '-') {
              ...
              $urlShare = 'http://pdpal.eproc19.com/main/index/katalog?kategori='.$subKaetgoriLabel;
            } else {
