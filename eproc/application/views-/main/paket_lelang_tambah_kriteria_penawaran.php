...
function addRow(tableID)
{
  ...
  cell3.innerHTML = '<input name="reqEvaluasiAdministrasi['+ (rowCount) +']" type="text" id="reqEvaluasiAdministrasi'+ (rowCount) +'"  OnKeyUp="cekLenght(\'reqEvaluasiAdministrasi'+ (rowCount) +'\')" class="form-control span10"/><div id="reqEvaluasiAdministrasi'+ (rowCount) +'text"></div><div id="startButton'+ (rowCount) +'" onClick="return speachToText(\''+ (rowCount) +'\')"> <span style="cursor: pointer;"></span></div>';
  ...
  cell4.innerHTML = '<a title="#" onclick="addRow(\'dataTableAdmin\')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
...
function addRowTeknis(tableID)
{
  ...
  // element2.setAttribute("class", "form-control span10");
  // cell3.appendChild(element2);
  cell3.innerHTML = '<input name="reqEvaluasiTeknis['+ (rowCount) +']" type="text" id="reqEvaluasiTeknis'+ (rowCount) +'" OnKeyUp="cekLenght(\'reqEvaluasiTeknis'+ (rowCount) +'\')" class="form-control span10"/><div id="reqEvaluasiTeknis'+ (rowCount) +'text"></div><div id="startButton2'+ (rowCount) +'" onClick="return speachToText2(\''+ (rowCount) +'\')"> <span style="cursor: pointer;"></span></div>';
  ...
  var cell4 = row.insertCell(3);
  cell4.innerHTML = '<a title="#" onclick="addRowTeknis(\'dataTableTeknis\')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
...
function addRowHarga(tableID)
{
  ...
  // element2.setAttribute("class", "form-control span10");
  // cell3.appendChild(element2);
  cell3.innerHTML = '<input name="reqEvaluasiHarga['+ (rowCount) +']" type="text" id="reqEvaluasiHarga'+ (rowCount) +'" OnKeyUp="cekLenght(\'reqEvaluasiHarga'+ (rowCount) +'\')" class="form-control span10"/><div id="reqEvaluasiHarga'+ (rowCount) +'text"></div><div id="startButton3'+ (rowCount) +'" onClick="return speachToText3(\''+ (rowCount) +'\')"> <span style="cursor: pointer;"></span></div>';
  ...
  var cell4 = row.insertCell(3);
  cell4.innerHTML = '<a title="#" onclick="addRowHarga(\'dataTableHarga\')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
...
<style type="text/css">
.fa-microphone { position: relative; top: -30px; left: -15px;}
</style>
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="card">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr class="<?=$style?>">
                            <td><?=$i?></td>
                            <td>
                              <input name="reqEvaluasiAdministrasi[<?=$i?>]" type="text" id="reqEvaluasiAdministrasi<?=$i?>" value="<?=$paket_evaluasi_admin->getField("NAMA")?>" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiAdministrasi<?=$i?>')" <?= $tutupForm ?> />
                              <div id="reqEvaluasiAdministrasi<?=$i?>text"></div>
                              <input type="hidden" name="reqCheck[<?=$i?>]" id="reqCheck<?=$i?>" value="1">
                              <div id="startButton<?=$i?>" onClick="return speachToText('<?=$i?>')">
                          ...
                          <tr class="<?=$style?>">
                            <td><?=$i?></td>
                            <td>
                              <input name="reqEvaluasiAdministrasi[<?=$i?>]" type="text" id="reqEvaluasiAdministrasi<?=$i?>" value="" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiAdministrasi<?=$i?>')" />
                              <div id="reqEvaluasiAdministrasi<?=$i?>text"></div>
                              <input type="hidden" name="reqCheck[<?=$i?>]" id="reqCheck<?=$i?>" value="1">
                              <div id="startButton<?=$i?>" onClick="return speachToText('<?=$i?>')">
                                <span style="cursor: pointer;"></span>
                            ...
                            <!-- <td></td> -->
                            <td class="text-center">
                              <a title="#" onclick="addRow('dataTableAdmin')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                            </td>
                          </tr>
                          <?php
                          } ?>
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="dataTableTeknis">
                        ...
                        <tr class="<?=$style?>">
                            <td><?=$i?></td>
                            <td>
                            <input name="reqEvaluasiTeknis[<?=$i?>]" type="text" id="reqEvaluasiTeknis<?= $i ?>" value="<?=$paket_evaluasi_teknis->getField("NAMA")?>" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiTeknis<?=$i?>')" <?= $tutupForm ?>/>
                            <div id="reqEvaluasiTeknis<?=$i?>text"></div>
                              <div id="startButton2<?=$i?>" onClick="return speachToText2('<?=$i?>')">
                                <span style="cursor: pointer;"></span>
                              </div>
                            </td>
                            <td style="width: 10px; text-align: center;">
                            ...
                            <td class="text-center">
                              <?php
                              if ($tutupHapus == '0') {  ?>
                                <a title="#" onclick="$(this).parent().parent().remove();" class="btn-aksi"><i class="fa fa-trash-o" aria-hidden="true"></i></a></a>
                              <?php
                              } ?>
                            </td>
                          </tr>
                          ...
                          <tr class="<?=$style?>">
                            <td><?=$i?></td>
                            <td>
                              <input name="reqEvaluasiTeknis[<?=$i?>]" type="text" id="reqEvaluasiTeknis<?= $i ?>" value="" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiTeknis<?=$i?>')" />
                              <div id="reqEvaluasiTeknis<?=$i?>text"></div>
                              <div id="startButton2<?=$i?>" onClick="return speachToText2('<?=$i?>')">
                                <span style="cursor: pointer;"></span>
                              </div>
                            ...
                            <!-- <td></td> -->
                            <td class="text-center">
                              <a title="#" onclick="addRowTeknis('dataTableTeknis')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                            </td>
                          </tr>
                          <?php
                          } ?>
                    ...
                    <table class="table table-bordered table-hover" id="dataTableHarga">
                        <tbody>
                          ...
                          <?php
                            ...
                            <td><?=$i?></td>
                            <td>
                              <input name="reqEvaluasiHarga[<?=$i?>]" type="text" id="reqEvaluasiHarga<?=$i?>" value="<?=$paket_evaluasi_harga->getField("NAMA")?>" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiHarga<?=$i?>')" <?= $tutupForm ?>/>
                              <div id="reqEvaluasiHarga<?=$i?>text"></div>
                              <div id="startButton3<?=$i?>" onClick="return speachToText3('<?=$i?>')">
                                <span style="cursor: pointer;"></span>
                              </div>
                            </td>
                            <td style="width: 10px; text-align: center;">
                         ...
                         <tr class="<?=$style?>">
                            <td><?=$i?></td>
                            <td>
                              <input name="reqEvaluasiHarga[<?=$i?>]" type="text" id="reqEvaluasiHarga<?=$i?>" value="" class="form-control span10" OnKeyUp="cekLenght('reqEvaluasiHarga<?=$i?>')" />
                              <div id="reqEvaluasiHarga<?=$i?>text"></div>
                              <div id="startButton3<?=$i?>" onClick="return speachToText3('<?=$i?>')">
                                <span style="cursor: pointer;"></span>
                              </div>
                            ...
                            <!-- <td></td> -->
                            <td class="text-center">
                              <a title="#" onclick="addRowHarga('dataTableHarga')" class="btn-aksi"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                            </td>
                          </tr>
                          <?php
                          } ?>
      ...
      <script>
        function speachToText(number) {
          // Cek apakah browser mendukung Speech Recognition
          if("webkitSpeechRecognition"in window){let n=new webkitSpeechRecognition;n.lang="id-ID",n.continuous=!1,n.interimResults=!1;let e=document.getElementById("startButton"+number),a=document.getElementById("restartButton"),i=document.getElementById("reqEvaluasiAdministrasi"+number);n.onresult=function(n){let t=n.results[0][0].transcript;i.value=t,e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>',a.style.display="block"},n.onerror=function(n){alert("Terjadi kesalahan dalam mengenali suara: "+n.error),e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>'},e.onclick=function(){n.start(),e.disabled=!0,e.innerHTML="Mendengarkan..."},a.onclick=function(){i.value="",n.start(),a.style.display="none",e.disabled=!0,e.innerHTML="Mendengarkan..."}}else alert("Browser Anda tidak mendukung Speech Recognition");
        }
        function speachToText2(number) {
          // Cek apakah browser mendukung Speech Recognition
          if("webkitSpeechRecognition"in window){let n=new webkitSpeechRecognition;n.lang="id-ID",n.continuous=!1,n.interimResults=!1;let e=document.getElementById("startButton2"+number),a=document.getElementById("restartButton"),i=document.getElementById("reqEvaluasiTeknis"+number);n.onresult=function(n){let t=n.results[0][0].transcript;i.value=t,e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>',a.style.display="block"},n.onerror=function(n){alert("Terjadi kesalahan dalam mengenali suara: "+n.error),e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>'},e.onclick=function(){n.start(),e.disabled=!0,e.innerHTML="Mendengarkan..."},a.onclick=function(){i.value="",n.start(),a.style.display="none",e.disabled=!0,e.innerHTML="Mendengarkan..."}}else alert("Browser Anda tidak mendukung Speech Recognition");
        }
        function speachToText3(number) {
          // Cek apakah browser mendukung Speech Recognition
          if("webkitSpeechRecognition"in window){let n=new webkitSpeechRecognition;n.lang="id-ID",n.continuous=!1,n.interimResults=!1;let e=document.getElementById("startButton3"+number),a=document.getElementById("restartButton"),i=document.getElementById("reqEvaluasiHarga"+number);n.onresult=function(n){let t=n.results[0][0].transcript;i.value=t,e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>',a.style.display="block"},n.onerror=function(n){alert("Terjadi kesalahan dalam mengenali suara: "+n.error),e.disabled=!1,e.innerHTML='<span style="cursor: pointer;" class="fa fa-microphone"></span>'},e.onclick=function(){n.start(),e.disabled=!0,e.innerHTML="Mendengarkan..."},a.onclick=function(){i.value="",n.start(),a.style.display="none",e.disabled=!0,e.innerHTML="Mendengarkan..."}}else alert("Browser Anda tidak mendukung Speech Recognition");
        }
      </script>
