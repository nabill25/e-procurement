...
$bidang_usaha_id = explode(',',$idPecah[0]);
for ($i=0; $i < count($bidang_usaha_id) ; $i++) { 
    $bidang_usaha_id2[] = "'".$bidang_usaha_id[$i]."'";
}
        	...
        	<div class="col-md-12 col-treegrid">
            	<div class="area-konten-atas">
                	<div class="judul-halaman">
                    		Bidang Usaha <?= implode(', ',$bidang_usaha_id2) ?>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        if ($reqKualifikasiRekanan == '3') { // 1:Kecil 2:Non-kecil 3:kecil/non-kecil
                          $paket_bidang_usaha_check->selectCountByParamsBidangUsaha2view(array(),-1,-1,'AND A.bidang_usaha_id IN ('.implode(', ',$bidang_usaha_id2).')',count($bidang_usaha_id));
                        } else {
                          $paket_bidang_usaha_check->selectCountByParamsBidangUsaha2view(array('b.REKANAN_KUALIFIKASI_ID' => $reqKualifikasiRekanan),-1,-1,$bidang_usaha_id2,count($bidang_usaha_id));
                        }
                        $no=1;
