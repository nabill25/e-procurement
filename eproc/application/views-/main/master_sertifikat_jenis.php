...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,		
		"sAjaxSource": "sertifikat_json/json",	
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_sertifikat_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_sertifikat_add/?reqId="+anSelectedId);
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("sertifikat_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("sertifikat_json/json");	
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Jenis Sertifikat</h4>
        ...
        <div class="card-body area-datatable">
        	<div class="row" id="sticker">
		    	<div class="form-group col-md-12 mb-2">
	                <a id="btnAdd" title="Tambah" class="<?= CLASS_BTN_PRIMARY ?> mr-1"><?= BTN_TAMBAH ?></a>
	                <a id="btnEdit" title="Ubah" class="<?= CLASS_BTN_INFO ?> mr-1"><?= BTN_UBAH ?></a>
	                <a id="btnDelete" title="Hapus" class="<?= CLASS_BTN_DANGER ?> mr-1"><?= BTN_HAPUS ?></a>
		    	</div> 
		    </div>
