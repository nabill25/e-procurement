...
$reqStatus = $rekanan->getField("STATUS_PERUSAHAAN") ? $rekanan->getField("STATUS_PERUSAHAAN") : 0;
...
$(document).ready(function() {
	...
	$(function(){
		$('#ff').form({
			url:'rekanan_json/data_administrasi_umum_ubah_profile',
			onSubmit:function(){
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                  <div class="row">
                    <div class="form-group col-md-2 mb-2">
                      ...
                      <input type="text" name="reqRekananTipe" class="form-control easyui-combobox span1" data-options="valueField:'id',textField:'text',url:'rekanan_tipe_json/combo'" style="width: 200% !important" value="<?=$reqRekananTipe?>" readonly="" />
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-7 mb-2">
                      ...
                      <input type="text" name="reqKota" id="reqKota" value="<?=$reqKota?>" title="Kota harus diisi" class="form-control easyui-validatebox span4" required  />
                    </div>
                  ...
                  <div class="row">
                    ...
                    <!-- <div class="form-group col-md-2 mb-2"> -->
                      ...
                      <input type="hidden" <?php // if($reqStatus == '0') echo 'checked';?>  name="reqStatus" value="0" /> 
                      <!-- Pusat &nbsp;&nbsp;&nbsp; <br> -->
                    ...
                    <div class="form-group col-md-3 mb-2">
                      <label>NPWP</label> <br>
                      <input type="file" name="reqNPWPFile" id="reqLinkFilePDFNPWP" size="30"  <?php if ($reqNPWPFileTemp) { } else { echo 'required'; }?>  class="easyui-validatebox"  validType="fileType['pdf']" /> <br>
                      <?php if ($reqNPWPFileTemp) { ?>
                  ...
                  <div class="row" id="IdFilePKP">
                    <div class="form-group col-md-3 mb-2">
                      <label style="width: 100%">Nomor. PKP</label>
                    ...
                    <div class="form-group col-md-3 mb-2">
                      ...
                      <input type="text" class="form-control easyui-validatebox span4" value="<?=$reqSKTPKP?>" name="reqSKTPKP" id="reqSKTPKP" onkeydown="return format_PKP(event);" maxlength="50" >
                    </div>
                    <div class="form-group col-md-2 mb-2">
                      ...
                      <a target="_blank" href="<?= base_url('uploads/rekanan/').$reqSKTPKPFileTemp ?>" class="badge badge-primary">Download file PKP</a>
                      <?php } ?>
                      <small>(File .pdf & Mak. ukuran file 3MB)</small>
                      <input type="hidden" name="reqSKTPKPFileTemp" value="<?=isset($reqSKTPKPFileTemp)?$reqSKTPKPFileTemp:''?>">
                      <input type="hidden" name="reqNamaFileSKTPKP" value="<?=isset($reqNamaFileSKTPKP)?$reqNamaFileSKTPKP:''?>">
                    </div>
                  </div>

                  <div class="row">
                    <div class="form-group col-md-1 mb-2">
                      <label style="width: 100%">Kode Area</label>
                    	<input type="text" name="reqTeleponKode" id="reqTeleponKode" class="form-control easyui-validatebox span1" maxlength="4" value="<?=$reqTeleponKode?>"  onkeypress="return isNumberKey(event)">
                    </div>
                    <div class="form-group col-md-5 mb-2">
                      <label>No. Telepon<small> (kode area tidak perlu diisi jika nomor telepon yang dicantumkan adalah nomor ponsel) </small></label>
                    	<input type="text" name="reqTeleponNo" id="reqTeleponNo" class="form-control easyui-validatebox span3" value="<?=$reqTeleponNo?>" maxlength="20" required>
                    </div>
                    <div class="form-group col-md-1 mb-2">
                      <label style="width: 100%">Fax</label>
                    	<input type="text" name="reqFaxKode" id="reqFaxKode" class="form-control easyui-validatebox span1" value="<?=$reqFaxKode?>" maxlength="4" onkeypress="return isNumberKey(event)">
                    </div>
                    <div class="form-group col-md-5 mb-2">
                      <label>&nbsp;</label>
                    	<input type="text" name="reqFaxNo" id="reqFaxNo" class="form-control easyui-validatebox span3" value="<?=$reqFaxNo?>" maxlength="20">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-2">
                      <label>No. HP</label>
                    	<input type="text" name="reqKontakPersonHp" id="reqKontakPersonHp" class="form-control easyui-validatebox span3" value="<?=$reqKontakPersonHp?>" maxlength="20">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-md-12 mb-2">
                      <label style="width: 100%">Kualifikasi <sup>wajib diisi</sup></label>
                      <input type="radio" <?php if($reqKualifikasi == '1') echo 'checked';?>  name="reqKualifikasi" value="1" required /> Kecil &nbsp;&nbsp;&nbsp;
                      <input type="radio" <?php if($reqKualifikasi == '2') echo 'checked';?> name="reqKualifikasi" value="2" /> Non Kecil
                    </div>
                  </div>


                  <div class="card mb-1 border-blue border-darken-1" id="kantor-pusat" style="<?php if($reqStatus == '1') { echo "display: none"; }?>">
                    <div class="card-content">
                      <div class="p-1">
                        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Informasi Perusahaan 
                            <!-- <small>(<b>Diisi jika Status Kantor Perusahaan adalah Pusat</b>)</small> -->
                          </strong>
                        </div>
                        ...
                        <div class="row">
                          <div class="form-group col-md-1 mb-2">
                            <label style="width: 100%">Kode Area</label>
                            <input type="text" class="form-control easyui-validatebox span1" name="reqTeleponKodePusat" id="reqTeleponKodePusat" value="<?=$reqTeleponKodePusat?>" maxlength="4"  onkeypress="return isNumberKey(event)">
                          </div>
                          <div class="form-group col-md-5 mb-2">
                            <label>No. Telepon <small>(kode area tidak perlu diisi jika nomor telepon yang dicantumkan adalah nomor ponsel) </small></label>
                          ...
                          <div class="form-group col-md-1 mb-2">
                            <label style="width: 100%">Fax</label>
                            <input type="text" class="form-control easyui-validatebox span1" name="reqFaxKodePusat" id="reqFaxKodePusat" value="<?=$reqFaxKodePusat?>" maxlength="4" onkeypress="return isNumberKey(event)">
                          </div>
                          <div class="form-group col-md-5 mb-2">
                            <label>&nbsp;</label>
                      ...
                      <div class="p-1">
                        ...
                        <div class="row">
                          <!-- <div class="form-group col-md-2 mb-2">
                            ...
                            <input required type="text" name="reqMataUang" class="easyui-combobox span4" data-options="valueField:'id',textField:'text',url:'mata_uang_json/comboMataUang'" value="<?=$reqMataUang?>" />
                          </div>  -->
                          <div class="form-group col-md-12 mb-2">
                        ...
                        <div class="row">
                          ...
                          <!-- <div class="form-group col-md-4 mb-2">
                            ...
                            <input type="text" name="reqPaymentMethodId" class="easyui-combobox span4" data-options="valueField:'id',textField:'text',url:'payment_method_json/combo'" value="<?=$reqPaymentMethodId?>" style="width: 415% !important" required/>
                          </div> -->
                        </div>
