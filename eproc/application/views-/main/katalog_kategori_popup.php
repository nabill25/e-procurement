            ...
            <div class="col-md-12 col-treegrid">
                <div class="area-konten-atas">
                    <div class="judul-halaman">
                            Pilih Sub Kategori
                        <div class="info">
                            <i class="fa fa-warning" aria-hidden="true"></i> Double-click untuk memilih Sub kategori.  
                        </div>
                    </div>
                </div> 
                <div id="idpencarian" class="area-pencarian" style="padding:10px">
                    <input class="" placeholder="  Pencarian" name="reqPencarian" id="reqPencarian" aria-controls="example" type="search" style="width:100%; border-radius:20px; height: 30px; padding-left: 20px;">
                </div>
                ...
                <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                    <table class="table" id="treeSatker" class="easyui-treegrid" style="height: 350px" 
                        ...
                        <thead>
                            <tr>
                                <th data-options="field:'text'">Kategori</th>
                            </tr>
                        </thead>
                    </table> 
                </div>
        ...
        $(document).ready( function () {
            $('#treeSatker').treegrid({
                  onDblClickRow: function(param){
    				 parent.tambahKatalogKategori(param.id, param.text);
                  }
            });
