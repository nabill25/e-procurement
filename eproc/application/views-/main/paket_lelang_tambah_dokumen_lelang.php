...
$(document).ready(function() {
  ...
  $(function(){
    $('#ff').form({
      url:'paket_dokumen_json/dokumen_lelang',
      onSubmit:function(){
      ...
      success:function(data){
        ...
        document.location.href = 'main/index/paket_lelang_tambah_dokumen_lelang/?reqId=<?=$reqId?>';
        alertSuccess();
        hideLoad();
      }
    });
            ...
            <table class="table table-bordered mb-0">
              <tbody>
                ...
                <tr >
                    ...
                    <td rowspan="2" width="9%" class="text-center">
              ...
              <div class="p-1">
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12 mb-2">
                      <label>File</label>
                      <input type="file" name="reqLinkFile" id="reqLinkFilePDF" class="easyui-validatebox" required validType="fileType['xlsx','docx','pdf']" />
                      <small> <br>Format file .xlsx .docx .pdf & Maksimal ukuran file 10MB </small>
                    </div>
                  </div>
