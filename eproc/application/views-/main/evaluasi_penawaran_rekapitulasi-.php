            ...
            <div class="col-md-12"> 
              <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
                ...
                <li role="presentation"><a href="main/index/evaluasi_penawaran_harga/?reqId=<?=$reqId?>"><i class="fa fa-money" aria-hidden="true"></i>
                  <p>Koreksi Aritmatik & Evaluasi Harga</p>
                  </a></li>
          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" data-options="novalidate:true" enctype="multipart/form-data">
            ...
            <div class="table-responsive">  
              ...
              <div class="form-actions">
                ...
                <button type="submit" name="reqSimpan" id="reqSimpan" class="btn btn-primary" style="display:none"><i class="fa fa-check-square-o"></i> Simpan</button>
                <a class="btn btn-info" href="main/loadUrl/report/evaluasi_penawaran_rekapitulasi_excel/?reqId=<?=$reqId?>" target="_blank" ><i class="fa fa-print"></i> Cetak Rekapitulasi</a>
                <?php 
                ...
                if ($reqMetodePengadaan == '1' || $reqMetodePengadaan == '2' || $reqMetodePengadaan == '8') { 
                  ...
                  {
                 ?>
                  <a onClick="publishEvaluasi();" id="btnPublish" class="btn btn-success text-white"><i class="fa fa-send"></i> Publish Hasil Evaluasi</a>
...
{
  $.messager.confirm("Konfirmasi","Publish evaluasi penawaran?",function(r){
    if (r){
      $.get( "paket_json/set_publish_evaluasi/?reqId=<?=$reqId?>", function( data ) {
          if(data == "1")
          {
            $("#btnPublish").css("display", "none");
            alertSuccess2('Publish evaluasi penawaran berhasil.'); 
          }
          else
            $.messager.alert('Info', data, 'info');
      });
