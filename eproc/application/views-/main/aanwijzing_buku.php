...
<html lang="en" class="no-js">
	<head>
        ...
        <?php /*?><script src="lib/bootstrap/libs/jquery/1.12.4/jquery.min.js"></script>
        ...
        <!-- FONT AWESOME -->
        <?php /*?><link rel="stylesheet" href="lib/font-awesome-4.7.0/css/font-awesome.css" type="text/css"><?php */?>
				...
				?>
					<div class="bb-item" id="item<?=$i?>">
						...
						<div id="separuh-kiri" style="background-size:100% 100%;">
                        	<!-- <img src="<?php // base_url() ?>uploads/aanwijzing/<?php //substr($prefix_halaman,0, strlen($prefix_halaman)-4)?>_<?=$i?>.Jpeg"> -->
                        	<img src="<?= base_url() ?>uploads/aanwijzing/<?=substr($prefix_halaman,0, strlen($prefix_halaman)-4)?>_<?=$i?>.jpg">
                        </div>
