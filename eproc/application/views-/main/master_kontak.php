		...
		/* Click event handler */
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/sk_panitia_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  if(anSelectedData == "")
				  return false;
			  openAdd("main/loadUrl/main/sk_panitia_add/?reqId="+anSelectedId);
		  ...
		  $('#btnLihat').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_kontak_add/?reqId="+anSelectedId);
...
{
	oTable.fnReloadAjax("kontak_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Kritik dan Saran</h4>
        ...
        <div class="card-body area-datatable">
          <div class="row" id="sticker">
		    <div class="form-group col-md-12 mb-2">
            	<a id="btnLihat" title="Tambah" class="btn round btn-min-width box-shadow-1 btn-primary text-white" ><span class="fa fa-eye"></span> Lihat</a>
		    </div>
		  </div>
