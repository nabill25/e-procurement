...
$sertifikat->selectByParams(array("REKANAN_SERTIFIKAT_JENIS_ID" => $reqId));
$sertifikat->firstRow();

$reqNama = $sertifikat->getField("NAMA");
$reqAlias = $sertifikat->getField("ALIAS");
      ...
      <div class="card-content">
        <div class="p-1">
          <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
            <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Jenis Sertifikat</strong>
          </div>
          <div class="p-1">
            <form id="ff" class="form-horizontal" role="form" method="post" novalidate style="padding:0 50px">
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-2">
                  <label>Alias</label>
                  <input type="text" name="reqAlias" value="<?=$reqAlias?>" title="" class="form-control easyui-validatebox span9" required >
                </div>
              </div>
