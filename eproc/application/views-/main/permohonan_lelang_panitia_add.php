...
/* VARIABLE */
$reqId  = $this->input->get("reqId"); // PermohonanId
...
$sirupId = $permohonan_paket->getField("SIRUP_ID"); 
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="card-content">
      <div class="p-1">
        ...
        <div class="p-1"> 
            ...
            echo $libplanning->sirup($reqPermohonanPaketAnalisaId,$sirupId);
            ?>

            <?php
            $this->load->library("libplanning");
            echo $libplanning->headerPRAttachment($reqPermohonanPaketAnalisaId,$sirupId);
            ?>

            <?php 
            $this->load->library("libplanning");
            // echo $libplanning->headerPermohonanDokumen($reqPermohonanPaketAnalisaId);
            if ($this->USER_TYPE_ID == '27') { // Hanya Perencana
              echo $libplanning->headerPermohonanDokumen($reqPermohonanPaketAnalisaId);
            } else { // Khusus file yang di share
              echo $libplanning->headerPermohonanDokumenUnit($reqPermohonanPaketAnalisaId);
            }
            ?>
