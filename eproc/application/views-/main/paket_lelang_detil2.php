                                ...
                                <div class="col-md-3 area-submenu-paket-lelang">
                                	...
                                	<div class="inner">
                                        ...
                                        <div id="accordion">
                                            ...
                                            {
                                            ?>                                        
                                                <h3><a href="main/index/paket_lelang_tambah/?reqId=<?=$reqId?>"><span>Edit Paket Lelang</span></a></h3>
                                                <div>Edit paket lelang yang telah ada.</div>
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_dokumen_lelang/?reqId=<?=$reqId?>"><span>Dokumen Lelang</span></a></h3>
                                                <div>Dokumen lelang yang telah diupload.</div>

                                                <?
                                                if($pra_kualifikasi_cek == 1)
                                                {
                                                ?>
                                                <h3><a href="main/index/paket_lelang_tambah_kriteria_kualifikasi/?reqId=<?=$reqId?>"><span>Kriteria Kualifikasi</span></a></h3>
                                                <div>Kriteria Kualifikasi.</div>

                                                <?
												}
												?>
                                                <h3><a href="main/index/paket_lelang_tambah_kriteria_penawaran/?reqId=<?=$reqId?>"><span>Kriteria Penawaran</span></a></h3>
                                                <div>Kriteria Penawaran.</div>

                                                <h3><a href="main/index/paket_lelang_tambah_dokumen_aritmatika/?reqId=<?=$reqId?>"><span>OE (Owner Estimate)</span></a></h3>
                                                <div>Standard estimasi.</div>

                                                <h3><a href="main/index/paket_lelang_tambah_daftar_panitia/?reqId=<?=$reqId?>"><span>Daftar panitia</span></a></h3>
                                                <div>Daftar panitia lelang.</div>
                                            ...
                                            ?>                                                
                                                ...
                                                <h3><a href="main/index/paket_lelang_tambah_pakta_integritas/?reqId=<?=$reqId?>"><span>Pakta Integritas</span></a></h3>
                                                <div>Validasi pakta integritas paket lelang.</div>
                                                
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_daftar_peserta/?reqId=<?=$reqId?>"><span>Daftar Peserta</span></a></h3>
                                                <div>Daftar peserta lelang.</div>
                                                
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_daftar_pihak_lain/?reqId=<?=$reqId?>"><span>Unit Fungsional &amp; Konsultan</span></a></h3>
                                                <div>Daftar Unit Fungsional &amp; Konsultan.</div>
                                                
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_aanwijzing_pra/?reqId=<?=$reqId?>"><span>Materi Aanwijzing</span></a></h3>
                                                <div>Materi untuk Aanwijzing.</div>
											   ...
											   <?
                                                ...
                                                ?>
                                                    ...
                                                    ?>                                                   
                                                        ...
                                                        <h3><a href="main/index/evaluasi_kualifikasi_administrasi/?reqId=<?=$reqId?>"><span>Evaluasi Kualifikasi</span></a></h3>
                                                        <div>Evaluasi kualifikasi.</div>
												...
												if($pra_kualifikasi_cek == 1)
												{
													...
													{
													?>
                                                        <h3><a href="main/index/paket_lelang_tambah_pengumuman_prakualifikasi/?reqId=<?=$reqId?>"><span>Pengumuman Pra-Kualifikasi</span></a></h3>
                                                        <div>Pengumuman Pra-Kualifikasi.</div>
												...
												{
												?>
                                                <h3><a href="main/index/aanwijzing/?reqId=<?=$reqId?>"><span>Aanwijzing</span></a></h3>
                                                <div>Pertemuan Aanwijzing.</div>
												<?
												}							 
												if($paket_tahap->getCountByParams(array("URUT" => $arrDokumenPenawaran[$jenis_tahap], "PAKET_ID" => $reqId, "TAMPILKAN" => 1)) > 0 || $paket_tahap->getCountByParams(array("URUT" => $arrDokumenPenawaran1[$jenis_tahap], "PAKET_ID" => $reqId, "TAMPILKAN" => 1)) > 0)
												{
													...
													{
													?>
                                                    <h3><a href="main/index/paket_lelang_tambah_auction/?reqId=<?=$reqId?>"><span>e-Bidding</span></a></h3>
                                                    <div>e-Bidding</div>
													...
													{
												?>
                                                <h3><a href="main/index/paket_lelang_tambah_dokumen_penawaran/?reqId=<?=$reqId?>"><span>Dokumen Penawaran</span></a></h3>
                                                <div>Dokumen penawaran yang telah diajukan.</div>
												<?
													}
                                                }
                                                ?>           
												...
												{
                                                ?>                                                                                     
                                                <h3><a href="main/index/<?=$link_auction?>/?reqId=<?=$reqId?>"><span>Pembukaan Penawaran<?=$sampul1?></span></a></h3>
                                                <div>Pembukaan dokumen penawaran.</div>
												<?
												}
                                                if($sistem_sampul == "2")
                                                {
                                                ?>
                                                   <h3><a href="main/index/evaluasi_penawaran_administrasi_sampul1/?reqId=<?=$reqId?>"><span>Evaluasi Penawaran Sampul 1</span></a></h3>
                                                   <div>Evaluasi penawaran Sampul 1 yang telah diajukan</div>
                                                   
                                                   <h3><a href="main/index/paket_lelang_tambah_pembukaan_auction_sampul2/?reqId=<?=$reqId?>"><span>Pembukaan Penawaran Sampul 2</span></a></h3>
                                                   <div>Pembukaan dokumen penawaran Sampul 2</div>
                                                   <h3><a href="main/index/evaluasi_penawaran_harga_sampul2/?reqId=<?=$reqId?>"><span>Evaluasi Penawaran Sampul 2</span></a></h3>
                                                   <div>Evaluasi penawaran Sampul 2 yang telah diajukan</div>        
                                                <?
                                                }
                                                else
                                                {
                                                ?>
                                                   <h3><a href="main/index/evaluasi_penawaran_administrasi/?reqId=<?=$reqId?>"><span>Evaluasi Penawaran</span></a></h3>
                                                   <div>Evaluasi penawaran yang telah diajukan</div>
                                                <?
                                                }					
                                                ?>
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_negosiasi_setup/?reqId=<?=$reqId?>"><span>Setup Negosiasi</span></a></h3>
                                                <div>Setting nilai awal negosiasi.</div>
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_negosiasi/?reqId=<?=$reqId?>"><span>Negosiasi</span></a></h3>
                                                <div>Negosiasi.</div>
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_penentuan_pemenang/?reqId=<?=$reqId?>"><span>Penentuan Pemenang</span></a></h3>
                                                <div>Hasil penentuan pemenang.</div>

                                                <h3><a href="main/index/paket_lelang_tambah_pengumuman_pemenang/?reqId=<?=$reqId?>"><span>Pengumuman Pemenang</span></a></h3>
                                                <div>Daftar pemenang lelang</div>
                                                
                                                <h3><a href="main/index/paket_lelang_tambah_sppjb/?reqId=<?=$reqId?>"><span>Penetapan Penyedia</span></a></h3>
                                                <div>Surat penunjukan penyedia barang/jasa</div>
                                	...
                                	<div class="inner">
                                    	...
                                    	<div class="judul-grup">Sub Menu</div>
                                    	<ul id="accordion">                                    
                                            <h3><a href="main/index/dokumen_lelang_fungsional/?reqId=<?=$reqId?>"><span>Dokumen Lelang</span></a></h3>
                                            <div>Dokumen lelang yang telah diupload.</div>
                                	...
                                	<div class="inner">
                                    	<div class="judul-grup">Sub Menu</div>
                                    	<ul id="accordion">              
                                            <h3><a href="main/index/dokumen_lelang_rekanan/?reqId=<?=$reqId?>"><span>Dokumen Lelang</span></a></h3>
                                            <div>Dokumen lelang yang telah diupload.</div>
                                            
                                            <h3><a href="main/loadUrl/report/aanwijzing_cetak_pdf/?reqId=<?=$reqId?>" target="_blank"><span>BA Aanwijzing</span></a></h3>
                                            <div>Berita Acara Aanwijzing.</div>
                                            
                                            <h3><a href="main/loadUrl/report/dokumen_penawaran_ba_pdf/?reqId=<?=$reqId?>" target="_blank"><span>BA Pemasukan Penawaran</span></a></h3>
                                            <div>Berita Acara Pemasukan Penawaran.</div>
                                            
                                            <h3><a href="main/loadUrl/report/dokumen_pembukaan_penawaran_ba_pdf/?reqId=<?=$reqId?>" target="_blank"><span>BA Pembukaan Penawaran</span></a></h3>
                                            <div>Berita Acara Pembukaan Penawaran.</div>
                                            
                                            <h3><a href="main/loadUrl/report/negosiasi_cetak_pdf/?reqId=<?=$reqId?>" target="_blank"><span>BA Negosiasi</span></a></h3>
                                            <div>Berita Acara Negosiasi.</div>
                                            
                                            <h3><a href="main/loadUrl/report/sppjb_pdf/?reqId=<?=$reqId?>" target="_blank"><span>Pemenang Lelang</span></a></h3>
                                            <div>Rekanan pemenang lelang.</div>
											...
											?>
												...
												{
												?>
                                                <h3><a href="<?=$FILE_DIR.str_replace("'", "''", $paket_dokumen->getField("PATH_FILE"))?>" target="_blank"><span>Pengumuman Pemenang</span>    </a></h3>
                                                <div>Pengumuman Pemenang</div>                                
                                                <?
												}
												?>
                                        </ul>                                
                                    ...
                                    if($reqPaketRekananId != "")
                                    {
										...
										?>                                
											...
											<ul id="accordion">
												...
												{
												?>                                        
													<h3><a href="main/index/dokumen_lelang_rekanan/?reqId=<?=$reqId?>"><span><?=translate("Dokumen Lelang", "RFP Documents")?></span></a></h3>
                                                    <div><?=translate("Dokumen lelang yang telah diupload", "Tender Documents")?></div>
													...
													if($pra_kualifikasi_cek > 0) 
													{
														...
														{
														?>
															<h3><a href="main/index/data_kualifikasi/?reqId=<?=$reqId?>"><span><?=translate("Data Kualifikasi", "Submit Qualification")?></span></a></h3>
                                                            <div><?=translate("Pengisian data kualifikasi perusahaan peserta", "Submit Qualification")?></div>
														 <?
														}
													}  
													...
													{
													?>
														<h3><a href="main/index/pengumuman_prakualifikasi/?reqId=<?=$reqId?>"><span>Pengumuman Pra-Kualifikasi</span></a></h3>
                                                        <div>Pengumuman Pra-Kualifikasi</div>
													 <?
													}	
													...
													?>
														<h3><a href="main/index/aanwijzing/?reqId=<?=$reqId?>"><span>Aanwijzing</span></a></h3>
                                                        <div><?=translate("Pemberian penjelasan dokumen lelang secara online", "Aanwijzing")?></div>
													 <?
													}
													...
													if($aktif_dok_penawaran1 > 0 || $aktif_dok_penawaran2 > 0)
													{
														...
														{
														?>
                                                            <h3><a href="main/index/auction_rekanan/?reqId=<?=$reqId?>"><span>e-Bidding</span></a></h3>
                                                            <div>e-Bidding</div>                                                   
                                                        <?
														}
														else
														{
													?>
                                                            <h3><a href="main/index/dokumen_penawaran_rekanan/?reqId=<?=$reqId?>"><span><?=translate("Dokumen Penawaran", "Submit Proposal")?></span></a></h3>
                                                            <div><?=translate("Dokumen penawaran yang telah diajukan", "Submit Proposal")?></div>
													<?
														}
													...
													if($aktif_dok_penawaran2 > 0) {
														...
														{
													?>
															<h3><a href="main/loadUrl/report/dokumen_penawaran_ba_pdf?reqId=<?=$reqId?>" target="_blank"><span><?=translate("BA Pemasukan Penawaran", "Minutes of Submission of Bids")?></span></a></h3>
                                                            <div><?=translate("Cetak berita acara pemasukan penawaran.", "Minutes of Submission of Bids")?>.</div>
													<?					
														}
													}
													...
													if($publish_ba_penawaran == "1" || $publish_ba_penawaran == "2"){
														...
														{		
															...
															{
															?>
																<h3><a href="main/index/pembukaan_auction_rekanan_sampul1/?reqId=<?=$reqId?>"><span><?=translate("Pembukaan Penawaran Sampul 1", "Bids Opening Cover 1")?></span></a></h3>
                                                                <div><?=translate("Pembukaan penawaran Sampul 1 oleh panitia.", "Bids Opening Cover 1")?>.</div>
															<?	
															}
															else
															{
													?>
																<h3><a href="main/index/pembukaan_auction_rekanan/?reqId=<?=$reqId?>"><span><?=translate("Pembukaan Penawaran", "Bids Opening")?></span></a></h3>
                                                                <div><?=translate("Pembukaan penawaran oleh panitia.", "Bids Opening")?>.</div>
													<?
															}
														}
													}			
													...
													{		
														...
														*/	
														...
														{
														?>
															<h3><a href="main/index/pembukaan_auction_rekanan_sampul2/?reqId=<?=$reqId?>"><span>Pembukaan Penawaran Sampul 2</span></a></h3>
                                                            <div>Pembukaan penawaran Sampul 2 oleh panitia.</div>
														<?	
														}
													...
													{
													?>
														<h3><a href="main/index/negosiasi_rekanan/?reqId=<?=$reqId?>"><span><?=translate("Negosiasi", "Negotiation")?></span></a></h3>
                                                        <div><?=translate("Negosiasi dan klarifikasi", "Negotiation")?></div>
													<?
													}										
													if($aktif_pengumuman > 0)
													{							
													?>		
														<h3><a href="main/index/pengumuman_pemenang/?reqId=<?=$reqId?>"><span>Pengumuman Pemenang</span></a></h3>
                                                        <div>Daftar Pemenang Lelang</div>
													<?
													}
												}
