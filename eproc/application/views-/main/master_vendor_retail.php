...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "vendor_retail_json/json",
    ...
    oTable.fnSort( [ [0,'desc'] ] );
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_vendor_retail_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_vendor_retail_add/?reqId="+anSelectedId);
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("vendor_retail_json/delete/", anSelectedId);
		  });
      ...
      $('#btnLihat').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_vendor_retail_view/?reqId="+anSelectedId);
...
{
	oTable.fnReloadAjax("vendor_retail_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Vedor Retail </h4>
