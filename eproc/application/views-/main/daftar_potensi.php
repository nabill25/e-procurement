      ...
      <section id="basic-examples">
        <div class="row match-height">
          ...
          <div class="col-xl-12 col-md-12 col-sm-12 mb-2" id="searchCol">
            ...
            <input type="hidden" id="reqPencarian2" class="form-control" value="2||<?=$this->USER_TYPE_ID ?>">
          ...
          <div class="col-md-12">
          	<span class="icon-docs cursor labelActive" onClick=" setValueSearch('2||<?=$this->USER_TYPE_ID ?>')"  id="search2"> Data Teknis</span>
