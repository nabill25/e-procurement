        ...
        <div class="card-content collapse show border-info border-darken-2">
          <div class="card-body">
              ...
              <div class="form-actions">
                  ...
                  <a id="btnSertifikat" href="main/loadUrl/report/vms_pdf/?reqId=<?=$reqId?>&kode=<?=$reqKode[0]?>&rekanantipeid=7" onclick="if(confirm('Cetak Surat Keterangan Terdaftar (SKT) ?')) { return true; } else { return false; }" class="btn btn-info mr-1 text-white"><i class="fa fa-print"></i> Cetak Surat Keterangan Terdaftar (SKT)</a>
                  <?php 
                  }
                  else
                  {
                  ?>
                  <button type="submit" class="btn btn-primary mr-1 text-white" id="btnValidasi"><i class="fa fa-check-square-o"></i> VALIDASI & KIRIM KE APPROVAL</button>
                  <!-- <a title="#" id="btnRevisi"  onclick="revisiPendaftaran()" class="btn btn-info mr-1 text-white"><i class="fa fa-repeat"></i> Dikembalikan</a> -->
                  <a id="btnSertifikat" href="main/loadUrl/report/vms_pdf/?reqId=<?=$reqId?>&kode=<?=$reqKode[0]?>&rekanantipeid=7" style="display: none" onclick="if(confirm('Cetak Surat Keterangan Terdaftar (SKT) ?')) { return true; } else { return false; }" class="btn btn-info mr-1 text-white"><i class="fa fa-print"></i> Cetak Surat Keterangan Terdaftar (SKT)</a>
                  <?php
                  }
                  ?>
              </div> 
          ...
          <div class="card-body">
              ...
              <div class="form-actions">
                  ...
                  { 
                    ...
                    { echo '<a class="btn btn-info mr-1 text-white" ><i class="fa fa-check-square-o"></i> MENUNGGU APPROVAL</button>';
                    } else {
                      ?>
                    <button type="submit" style="display: none" class="btn btn-primary mr-1 text-white" id="btnValidasi"><i class="fa fa-check-square-o"></i> VALIDASI & KIRIM KE APPROVAL.</button>
                    <?php 
                    } ?>
                  <!-- <a title="#" id="btnRevisi"  onclick="revisiPendaftaran()" class="btn btn-info mr-1 text-white"><i class="fa fa-repeat"></i> Dikembalikan</a> -->
                  <a id="btnSertifikat" href="main/loadUrl/report/vms_pdf/?reqId=<?=$reqId?>&kode=<?=$reqKode[0]?>" onclick="if(confirm('Cetak Surat Keterangan Terdaftar (SKT) ?')) { return true; } else { return false; }" class="btn btn-info mr-1 text-white"><i class="fa fa-print"></i> Cetak Surat Keterangan Terdaftar (SKT)</a>
                  <?php 
                  }
                  else
                  {
                  ...
                  <!-- <a title="#" id="btnRevisi"  onclick="revisiPendaftaran()" class="btn btn-info mr-1 text-white"><i class="fa fa-repeat"></i> Dikembalikan</a> -->
                  <a id="btnSertifikat" href="main/loadUrl/report/vms_pdf/?reqId=<?=$reqId?>&kode=<?=$reqKode[0]?>" style="display: none" onclick="if(confirm('Cetak Surat Keterangan Terdaftar (SKT) ?')) { return true; } else { return false; }" class="btn btn-info mr-1 text-white"><i class="fa fa-print"></i> Cetak Surat Keterangan Terdaftar (SKT)</a>
                  <?php
                  }
                  ?>
              </div> 
