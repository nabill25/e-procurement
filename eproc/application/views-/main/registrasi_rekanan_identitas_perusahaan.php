...
if ($this->REKANAN_TIPE_ID == '7')
    redirect(base_url('main/index/registrasi_rekanan_identitas_perorangan'));
      ...
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body">
          <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
            ...
            <strong><?=translate("Pendaftaran Daftar Rekanan Perusahaan (DRP)", "Registration")?></strong>  
        ...
        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <tr>
                        <td width="23%"><?=translate("Nama Perusahaan", "Company Name")?>:</td>
                        <td>
                            <?=$reqNamaPerusahaan?>
                        </td>
                    </tr>
            ...
            <div class="form-actions" style="margin-bottom: 2%">
                ...
                <a href="main/index/registrasi_rekanan_landasan_hukum"  class="btn btn-primary pull-right"><?=translate("Lanjut", "Next")?> <i class="fa fa-arrow-right"></i></a>
            </div> 
