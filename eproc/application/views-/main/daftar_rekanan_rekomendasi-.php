                      ...
                      ************************************************
                          ...
                          ?>
                              <tr>
                                ...
                                <td style="width: 83%">
                                  ...
                                  <?php
                                    if ($dokumen_rekanan->countRow() > 0) {
                                      ...
                                      echo '<br><a style="color:#fff" href="uploads/pakta_integritas/'.$dokumen_rekanan->getField('PATH_FILE').'" target="_blank" class="badge badge-success"><span class="fa fa-book"></span> lihat dokumen</a>';
                                    } else { }
                                  ?>
                                </td>
                                <td style="width: 5%" class="text-center">
                                ...
                                if($this->USER_TYPE_ID == '2')
                                {
                                  ...
                                  $cekData->selectByParamsRekananChecklist(array("REKANANID"=>$reqId),-1,-1);
                                  $cekData->firstRow();
                                  $field = strtoupper($rekanan_pakta_integritas->getField("FIELDNYA"));
                                  if ($cekData->getField("$field") == '1') {
                                    $checked = 'checked';
                                  }
                                  // if ($rekanan_pakta_integritas->getField("SIMBOL") == 'centang' && $rekanan_pakta_integritas->getField("WAJIB") == '*') {
                                     echo '<input type="checkbox" name="check'.$rekanan_pakta_integritas->getField("FIELDNYA").'" id="check'.$rekanan_pakta_integritas->getField("FIELDNYA").'" onclick="return updateChecklist(\''.$reqId.'\',\''.$rekanan_pakta_integritas->getField("FIELDNYA").'\')" style="cursor:pointer" '.$checked.'>';
                                  // }
                                }?>
                              </td>
                              </tr>
                      ...
                      <form id="ff" class="easyui-form form-horizontal" method="post" data-options="novalidate:true" enctype="multipart/form-data">
                        <div class="form-actions">
                          ...
                          { ?>
                          <a id="btnSertifikat" target="_blank" href="main/loadUrl/report/vms_pdf/?reqId=<?=$reqId?>&kode=<?=$reqKode?>" onclick="if(confirm('Cetak Surat Keterangan Terdaftar (SKT) ?')) { return true; } else { return false; }" class="btn btn-info mr-1 text-white"><i class="fa fa-print"></i> Cetak Surat Keterangan Terdaftar (SKT)</a>
