...
<body>
        ...
        <div class="container container-aps">
            <div class="row">
                <div class="col-md-12">
                    <div><!-- class="area-main" -->
                        <!--<div class="judul-halaman">Aanwijzing BUKU</div>-->
                        <div><!-- class="inner" -->
                            <div><!-- class="area-konten" -->
                                <div style="border:5px solid cyan;"><!-- class="area-konten-inner" -->
                                    ...
                                    <div class="bb-custom-wrapper">
                                        ...
                                        ?>
                                            <div class="bb-item" id="item<?=$i?>">
                                                ...
                                                <div id="separuh-kiri" style="background-size:100% 100%; border:1px solid red;">
                                                    <img src="uploads/lelang/<?=substr($prefix_halaman,0, strlen($prefix_halaman)-4)?>_<?=$i?>.Jpeg">
                                                </div>
                                                <div id="separuh-kanan" style="border:2px solid cyan;">
