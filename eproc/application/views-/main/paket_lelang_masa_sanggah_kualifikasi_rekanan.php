...
$paket_dokumen->selectByParams(array("PAKET_ID" => $reqId, "JENIS_DOKUMEN" => "SANGGAH_KUALIFIKASI", "PARENT_ID" => 0, "REKANAN_USER_ID" => $this->ID));
...
$(document).ready(function() {
	...
	$(function(){
		$('#ff').form({
			url:'paket_sanggah_json/dokumen_sanggah_kualifikasi_rekanan',
			onSubmit:function(){
...
<style type="text/css">
  table th { background-color: #967adc; color: #fff; }
</style>
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Sanggah Kualifikasi
        </h4>
                  ...
                  while($paket_dokumen->nextRow())
                  {
                    ...
                    $parentDate = explode(" ", $paket_dokumen->getField("TGL_JAM_UPLOAD"));
                      ...
                      <tr >
                          ...
                          <?php if ($paket_dokumen->getField("PATH_FILE"))?>
                            <a href="uploads/lelang/<?=$paket_dokumen->getField("PATH_FILE")?>" target="_blank" class="btn-aksi">
                                <?= ICON_DOWNLOAD ?>
                            </a>
                          <?php // echo '<a onClick="deleteData(\'paket_sanggah_json/delete/\', \'$paket_dokumen->getField("PAKET_DOKUMEN_ID")\')" class="btn-aksi"><i class="fa fa-trash" aria-hidden="true"></i></a>'; ?>
                          </td>
                      </tr>
          ...
          <div class="card mb-1 border-blue border-darken-1" style="padding:10px">
              <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                  <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Sanggah Kualifikasi</strong>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-2">
                    <label style="width: 100%">Lampiran</label>
                  ...
                  <div class="form-actions">
                    <a href="main/index/paket_lelang_masa_sanggah_kualifikasi_rekanan/?reqId=<?=$reqId?>" class="<?= CLASS_BTN_INFO ?>"><i class="fa fa-refresh"></i> Refresh</a>
                    <button type="submit" class="<?= CLASS_BTN_PRIMARY ?>"><i class="fa fa-check-square-o"></i> Kirim</button>
                  </div>
                  <p><b>* Pastikan mengirim sanggahan sebelum tanggal dan jam berakhir.</b></p>
              </form>
          </div>
          <?php
          } ?>
