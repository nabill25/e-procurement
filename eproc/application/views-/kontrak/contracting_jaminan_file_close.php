  ...
  <head>
    ...
    $(function(){
      $('#ffAddFileKontrak').form({
        url:'contracting_json/addfilejaminanAllUpdate',
        onSubmit:function(){ 
        ...
        <div class="p-1">
          ...
          <div class="p-1" >
            ...
            <table class="table table-bordered">
              <tr>
                <td style="width:30%">Nomor Jaminan</td>
                <td><?= $datajaminan->getField("NOMOR") ?></td>
              </tr>
              <tr>
                <td style="width:30%">Tanggal Terbit</td>
                <td><?= dateToPageCheck($datajaminan->getField('TANGGAL_JAMINAN'))?></td>
              </tr>
              <tr>
                <td style="width:30%"> File Jaminan </td>
                <td> <a href="uploads/kontrak/<?= $datajaminan->getField("FILE_JAMINAN") ?>" target="_blank" class="badge badge-primary"><span class="fa fa-download"> Download</span></a> </td>
              </tr>
              <tr>
                <td style="width:30%"> Tanggal <br> Konfirmasi ke Bank </td>
                <td> <?= dateToPageCheck($datajaminan->getField('TANGGAL_KONFIRMASI_KEBANK'))?> </td>
              </tr>
              <tr>
                <td style="width:30%"> Tanggal <br> Konfirmasi oleh Bank </td>
                <td> <?= dateToPageCheck($datajaminan->getField('TANGGAL_KONFIRMASI_OLEH_BANK'))?> </td>
              </tr>
              <tr>
                <td style="width:30%"> Bukti <br>Konfirmasi Keabsahan </td>
                <td> <a href="uploads/kontrak/<?= $datajaminan->getField("FILE_KONFIRMASI") ?>" target="_blank" class="badge badge-primary"><span class="fa fa-download"> Download</span></a> </td>
              </tr>
              <tr>
                ...
                <td>
                  <select class="form-control" name="konfirmasi" style="width:60%">
                     ...
                     <option <?php if ($datajaminan->getField('KONFIRMASI') == '2') { echo "selected"; } ?> value="2">Cair</option>
                    </select>
                </td>
              </tr> 
            </table>
