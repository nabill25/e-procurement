  ...
  <head>
    ...
    $(function(){
      $('#ffAddDeliverable').form({
        url:'contracting_json/editPayment2',
        onSubmit:function(){
                  ...
                  <tbody id="tbodyDeliverable">  
                    ...
                    if($datapayment->countRow() > 0) { 
                      ...
                      <tr>
                        ...
                        <td> 
                          <input type="text" class="form-control easyui-validatebox" required name="payteminke" id="reqNo" value="<?= $datapayment->getField('PAY_TERMIN_KE') ?>">
                        </td> 
                        <?php 
                        } else { ?>
                        <td width="20%"> Termin </td>
                      ...
                      <tr>
                        <td> Keterangan </td>
                        <td> 
                          <input type="text" class="form-control easyui-validatebox" required name="payketerangan" id="reqKet" value="<?= $datapayment->getField('PAY_KETERANGAN') ?>">    
                        </td> 
                      </tr>
                      <tr>
                        <td> Nilai Pembayaran</td> 
                        <td> 
                          <input type="text" class="form-control easyui-validatebox" required name="paynilai" id="reqNilai<?=$no?>" value="<?= $datapayment->getField('PAY_NILAI') ?>" id="reqNilai<?=$no?>" value="" OnFocus="FormatAngka('reqNilai<?=$no?>')" OnKeyUp="FormatUang('reqNilai<?=$no?>')" OnBlur="FormatUang('reqNilai<?=$no?>')">
                        </td> 
                      </tr> 
                      <tr>
                        <td> Progres %</td>
                        <td>
                        <input type="text" class="form-control easyui-validatebox" required name="payprogres" id="reqpayprogres" OnFocus="FormatAngka('reqpayprogres')" OnFocus="FormatAngka('reqpayprogres')" OnKeyUp="FormatUang('reqpayprogres')" OnBlur="FormatUang('reqpayprogres')" maxlength="3" value="<?= $datapayment->getField('PAY_PROGRES') ?> ">
                        </td> 
                      </tr>   
                      <?php 
                      $no++;
