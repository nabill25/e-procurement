...
$reqNilaiHPS = $contracting->getField("NILAI");
...
$reqJangkaMaksimal = dateToPageCheck($sppbj->getField('CR_SPPBJ_JAMINAN_MAKSIMAL_PENYERAHAN')) ?: date('d-m-Y');
...
$reqRekananId = $contracting->getField('REKANAN_ID') ?: '-';
  ...
  $(function(){
    $('#ff').form({
      ...
      success:function(data){
        ...
        alertSuccess2(data);
        // document.location.href = 'kontrak/index/contracting_persiapan_sppbj_edit?reqId=<?= $reqId ?>';
      }
    });
  });
      ...
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-4 mb-2">
                <label>Nilai Kontrak (hasil pemilihan)</label>
              ...
              <?php 
              $hitungPersentase = ($reqNilai / $reqNilaiHPS) * 100;
              $hitungPersentase = round($hitungPersentase, 2) . '%'; 
              ?>
              <div class="form-group col-md-2 mb-2">
                <label>Harga Perkiraan </label>
                <input title="Nilai Kontrak harus diisi" class="form-control easyui-validatebox span3"  name="reqHPS" type="text" value="<?=numberToIna($reqNilaiHPS)?>" readonly/>
              </div>
            ...
            <div class="form-actions">
              ...
              <a href="kontrak/index/contracting_persiapan_sppbj?reqId=<?=$reqId?>" class="<?= CLASS_BTN_DANGER ?> mr-1"> <?= BTN_KEMBALI ?> </a>
