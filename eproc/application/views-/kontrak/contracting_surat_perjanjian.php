...
$(document).ready(function() {
  ...
  $(function(){
    $('#ff').form({
      ...
      success:function(data){
        ...
        arrData = data.split("-");
        if (arrData[0] == 'Data gagal simpan.') {
          alertError2(arrData[0]);
        } else {
          alertSuccess2(arrData[0]);
        }
        setTimeout(function() {
          if (arrData[0] == 'Data gagal simpan.') {
            hideLoad();
          } else {
            // document.location.href = 'kontrak/index/contracting_persiapan?tahun=<?php // echo $tahun?>';
            document.location.href = 'kontrak/index/contracting_persiapan_sppbj?reqId='+arrData[1];
          }
        }, 1000);
      }
    });
  ...
  $('#reqTanggal, #reqPelaksanaanDari, #reqPelaksanaanSampai, #reqJangkaDari, #reqJangkaSampai, #reqJangkaMaksimal').datebox({
    editable: false
  });
});
...
function calculate(a)
{
    ...
    $('#reqNilaiJaminan').val(FormatNumberya(Math.round(total)));
}
            ...
            <div id="formSPPBJ" style="display: none">
              ...
              <div class="row" style="display:none">
                <div class="form-group col-md-5 mb-2">
                  ...
                  <input type="text" name="reqPejabatBerwenang" id="reqPejabatBerwenang" value="<?php // echo $reqPenggunaStr?>" class="form-control easyui-validatebox"/>
                </div>
                <div class="form-group col-md-3 mb-2">
                  <label>NUP/NIP</label>
                  <input type="text" name="reqNIP" id="reqNIP" value="<?php // echo $reqNIP?>" class="form-control easyui-validatebox"/>
                </div>
                <div class="form-group col-md-4 mb-2">
                  <label>Jabatan</label>
                  <input type="text" name="reqJabatan" id="reqJabatan" value="<?php // echo $reqJabatan?>" class="form-control easyui-validatebox"/>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-5 mb-2">
              ...
              $hitungPersentase = ($totalAkhirNego / $reqNilai) * 100;
              $hitungPersentase = round($hitungPersentase, 2) . '%';
              ?>
              <div class="row">
                <div class="form-group col-md-3 mb-2">
                ...
                <div class="form-group col-md-2 mb-2">
                  ...
                  <input title="Nilai Kontrak harus diisi" class="form-control easyui-validatebox span3"  name="reqHPS" type="text" value="<?=numberToIna($reqNilai)?>" readonly/>
                </div>
                <div class="form-group col-md-1 mb-2">
                  <label>Presentase </label>
                  <input title="Nilai Kontrak harus diisi" class="form-control easyui-validatebox span3"  name="reqPresentase" type="text" value="<?= $hitungPersentase ?>" readonly/>
                </div>
                <div class="form-group col-md-2 mb-2">
                  <label style="width: 100%">Jenis Kontrak</label>
                  <input type="text" name="reqJnsKontrak" class="easyui-combobox span4" id="reqJnsKontrak" data-options="valueField:'id',textField:'text',url:'contracting_json/comboJenisContrack'"  value="<?=$jnskontrak?>" style="width: 200% !important" required/>
                </div>
                <!-- <div class="form-group col-md-4 mb-2">
                  <label style="width: 100%">Masa Pelaksanaan Pekerjaan</label>
                  <input type="text" name="reqPelaksanaanDari" id="reqPelaksanaanDari" class="form-control easyui-datebox" value="<?php // $reqPelaksanaanDari?>" required style="width: 180%"/> <span style="margin:0 2%">s/d</span>
                  <input type="text" name="reqPelaksanaanSampai" id="reqPelaksanaanSampai" class="form-control easyui-datebox" value="<?php // $reqPelaksanaanSampai?>" required style="width: 180%"/>
                </div> -->
                <div class="form-group col-md-1 mb-2">
                  <br><br>
              ...
              <div class="row" id="form-jaminan-pelaksanaan" style="display:none">
                ...
                <div class="form-group col-md-2 mb-2">
                  <label style="width: 100%">Mak. Penyerahan JamPel</label>
                  <input type="text" name="reqJangkaMaksimal" id="reqJangkaMaksimal" class="form-control easyui-datebox" value="<?=$reqJangkaMaksimal?>" style="width: 200%"/>
                </div>
                <div class="form-group col-md-5 mb-2">
              ...
              <div class="form-actions">
                ...
                <a href="kontrak/index/contracting_paket?tahun=<?=$tahun?>" class="<?= CLASS_BTN_DANGER ?> mr-1"> <?= BTN_KEMBALI ?> </a>
