...
<html lang="en">
  <head>
    ...
    $(function(){
      $('#ffAddMaterial').form({
        url:'contracting_json/addMaterialPerubahan',
        onSubmit:function(){
              ...
              <div class="table-responsive">
                <table class="table table-bordered table mb-0">
                  ...
                  <tbody id="tbodyDeliverable">   
                    <tr>
                      <td>
                        <input type="text" class="form-control easyui-validatebox" required name="material[]" id="<?=$no?>" value="">
                       </td> 
                       <td>
                        <input type="text" class="form-control easyui-validatebox" required name="keterangan[]" id="<?=$no?>" value="">
                       </td> 
                       <td>
