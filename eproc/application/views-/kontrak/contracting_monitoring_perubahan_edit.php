  ...
  <div class="card-content">
    <div class="p-1">
      <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
        <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Perubahan Kontrak </strong>
      </div> 
      <div class="p-1">
        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
          <div class="row">
            <div class="form-group col-md-12 mb-2">
              <label>Alasan Perubahan <sup>Tuliskan dengan detail disini</sup></label>
              <input type="text" name="reqPerubahanAlasan" id="reqPerubahanAlasan" class="form-control easyui-validatebox" value="<?=$reqPerubahanAlasan?>" required/>
              <small><i>Dengan menulis alasan perubahan maka kontrak dapat diubah</i></small>
            </div> 
            <!-- <div class="form-group col-md-12 mb-2">
              <label>File</label>
              <input type="file" name="reqLinkFile" id="reqLinkFilePDF" class="easyui-validatebox" required validType="fileType['pdf','zip','docx']" />
