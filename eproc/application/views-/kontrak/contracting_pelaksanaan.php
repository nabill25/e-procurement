...
$(document).ready(function() {
  ...
  "bProcessing": true,
  "bServerSide": true,    
  "sAjaxSource": "contracting_rekanan_json/json/2?tahun=<?= $getTahun ?>",  
    ...
    <div class="col-md-12 col-sm-12">
      <div class="card border-bottom-primary" style="zoom: 1;"> 
        <div class="card-header">
          <h4 class="card-title">INISIASI <small> KONTRAK</small></h4>
          <div class="heading-elements" id="tombol"> 
            <a href="kontrak/index/contracting_dashboard?tahun=<?= $getTahun ?>" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a> 
          </div>
        </div>
