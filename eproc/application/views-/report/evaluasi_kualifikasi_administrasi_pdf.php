...
$html = file_get_contents(base_url()."cetak/loadUrl/report/evaluasi_kualifikasi_administrasi_excel/?reqId=".$reqId, false, stream_context_create($arrContextOptions));
