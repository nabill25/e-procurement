...
if($this->USER_TYPE_ID == 11 || $this->USER_TYPE_ID == 12) // PEJABAT PENGADAAN || KONTRAK
{ 
...
$link_report = "katalog_cetak_chat";
...
$html .= file_get_contents(SYSTEM_URL_EMAIL."/main/loadUrl/report/".$link_report."?reqId=".$reqId, false, stream_context_create($arrContextOptions));//".$link_report."?reqId=".$reqId);						
