...
/* LOGIN CHECK */
if($this->USER_LOGIN_ID == "" || $this->USER_TYPE_ID != '3' && $this->USER_TYPE_ID != '10' && $this->USER_TYPE_ID != '11') { //3:Panitia, 10:Audit
...
// LOAD a stylesheet
// $stylesheet = file_get_contents('css/dokumen-pembukaan-penawaran.css');
...
$html .= file_get_contents(base_url()."main/loadUrl/report/jadwal?reqId=".$reqId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));						
...
// $encrypt_text = md5($paketInfo->pr_group_number."|".$validatorNIP."|".$validatorNumber);
...
ob_end_clean();
$mpdf->Output('Jadwal-'.SYSTEM_NAME.'-'.$unitkerja.'.pdf','I');
exit;
//==============================================================
//==============================================================
//==============================================================
