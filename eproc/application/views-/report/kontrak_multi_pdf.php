...
$html .= file_get_contents(base_url()."main/loadUrl/report/kontrak_multi?reqId=".$reqId."&reqPaketId=".$reqPaketId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));	
