...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "unit_kerja_json/json",
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_unit_kerja_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_unit_kerja_add/?reqId="+anSelectedId);
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("unit_kerja_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("unit_kerja_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Perusahaan </h4>
