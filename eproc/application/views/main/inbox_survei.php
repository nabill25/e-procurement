...
$dataInbox = new Inbox;
$dataInbox->selectByParams(array("A.PARENT" => 0, "A.INBOXCATEGORYID" => '2')); // 1:RFI 2:Survey 3:Complain
      ...
      <div class="card border-bottom-primary"> 
        ...
        <div class="row" id="header-inbox">
		    <div class="form-group col-md-12" style="padding: 0 2.4%" id="sticker2">
		        ...
		        <a id="btnBuat" href="main/index/inbox_survei_add" class="btn btn-primary text-white" style="width: 100%"><i class="fa fa-plus-circle"></i> Buat Survey</a>
		    </div>
		            ...
		            <section id="lists">
		                <div id="basic-list">
		                    ...
		                    <ul class="list-group list" style="height: 700px; overflow-y: scroll;"> 
		                    	...
		                    	$dateEx2 = $dateEx[1];
		                    	?>
		                    	<a onClick="openAdd('main/loadUrl/main/inbox_survei_detail?id=<?=$dataInbox->getField("INBOXID")?>');" style="margin: 7px 5px"> 
