...
else
{
  ...
  if ($reqPermohonanId) {
    ...
    $reqPermohonanTglDisposisi = $permohonan_paket->getField("TANGGAL");
    if ($reqPL == '1') { // Pengadaan langsung <= 300jt
     // $reqJenisPekerjaan = '3';  // 1 Pekerjaan Konstruksi, 2 Jasa Konsultansi, 3 Barang, 4 Jasa Lainnya
     $reqMetodePengadaan = '2';
    } else if ($reqPL == '2') { // ePurchasing Pejabat Pengadaan
     // $reqJenisPekerjaan = '5';  // 1 Pekerjaan Konstruksi, 2 Jasa Konsultansi, 3 Barang, 4 Jasa Lainnya, 5 Katalog
     $reqMetodePengadaan = '6';
          ...
          if(v) {
            ...
            // $(function () {  
                ...
                if (ary.length > 0) {
                  ...
                  alert('Silahkan Isi Bidang Usaha');
                  hideLoad();
                  return false;
                }
            // });
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Tambah Pengadaan</h4>
          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                ...
                <p>
                  <?=$reqPermohonanNoDisposisi.' - '.getFormattedDate($reqPermohonanTglDisposisi); ?><br> 
                  <?=$reqPermohonan?>
                </p>
                <!-- <label><b>Keterangan</b></label> <br> -->
                <?php //$reqPermohonanKeterangan?>
                <input type="hidden" name="reqNamaPaket" class="form-control easyui-validatebox span9"  value="<?=$reqPermohonanNotaDinas?> - <?=$reqPermohonan?>" readonly />
            ...
            <div class="row">
              <?php 
                if ($reqPL == '1') { // Pengadaan langsung <= 300jt kunci onchange
               ?>
                  ...
                  <input type="text" name="reqJenisPekerjaan" class="easyui-combobox span3" id="reqIjinUsaha"
                          data-options="valueField:'id',textField:'text',url:'paket_jenis_json/combo',
                                          onSelect: function(rec){
                                              $('#reqMetodePengadaan').combobox('reload', 'paket_metode_lelang_json/combopl/?reqJenisPekerjaan='+rec.id);
                                          }"  value="<?=isset($reqJenisPekerjaan) ? $reqJenisPekerjaan : ''?>" required style="width: 300%"/>
                </div> 
              <?php 
                } else if ($reqPL == '2') { // Pembelian Langsung / Purchasing
               ?>
                <div class="form-group col-md-3 mb-2" style="display: none">
                  <label style="width: 100%">Jenis Pengadaan</label>
                  <input type="text" name="reqJenisPekerjaan" class="span3" id="reqIjinUsaha" value="<?=isset($reqJenisPekerjaan) ? $reqJenisPekerjaan : '5'?>" required/>
                </div> 
              <?php 
              } else {
              ?>
               ...
               ?>
                <div class="form-group col-md-3 mb-2">
                  ...
                  <input type="text" name="reqMetodePengadaan" class="easyui-combobox span3"  id="reqMetodePengadaan"
                          data-options="valueField:'id',textField:'text',url:'paket_metode_lelang_json/combopl/?reqJenisPekerjaan=<?=$reqJenisPekerjaan?>',
                                          onSelect: function(rec){
              ...
              <?php 
               ...
               ?>
                <div class="form-group col-md-6 mb-2" style="display: none">
                  <label style="width: 100%">Metode Pengadaan</label>
                  <input type="text" name="reqMetodePengadaan" class="span3"  id="reqMetodePengadaan" value="<?=$reqMetodePengadaan?>" required/>
                  <label style="width: 100%">Metode Penyampaian Penawaran</label>
                  <input type="text" name="reqMetodePenyampulan" class="span4"  id="reqMetodePenyampulan" value="<?= isset($reqMetodePenyampulan) ? $reqMetodePenyampulan : '1'?>" required />
                  <label style="width: 100%">Metode Evaluasi</label>
                  <input type="text" name="reqMetodeEvaluasi" class="span4"  id="reqMetodeEvaluasi" value="<?=isset($reqMetodeEvaluasi) ? $reqMetodeEvaluasi : '2'?>" required/>
                  <label style="width: 100%">Sistem Negosiasi</label>
                  <select name="reqBidding">
                    <option value="0" <?php if($reqBidding == "0") { ?> selected <?php } ?>>Chatting</option>
                  </select>
            ...
            <div class="card mb-1 border-blue border-darken-1">
              <div class="card-content">
                ...
                <?php 
                if ($reqMetodePengadaan == '1' || $reqMetodePengadaan == '3' || $reqMetodePengadaan == '7') { // 1:Tender Umum, 3-Tender Terbatas, 7:Tender Cepat   
                ...
                <div class="p-1">
                  ...
                  <input title="Nilai pekerjaan harus diisi" class="form-control easyui-validatebox span3"  name="reqNilaiPekerjaanx" type="text" id="reqNilaiPekerjaanx" value="<?=numberToIna($nilaiHPS3)?>"  OnFocus="FormatAngka('reqNilaiPekerjaanx')" OnKeyUp="FormatUang('reqNilaiPekerjaanx')" OnBlur="FormatUang('reqNilaiPekerjaanx')" required readonly/>
                  <br>
                        ...
                        <tr>
                          ...
                          <?php 
                            ...
                            if ($reqKualifikasiRekanan == '3') { // 1:Kecil 2:Non-kecil 3:kecil/non-kecil
                              ...
                              $paket_bidang_usaha_check->selectCountByParamsBidangUsahaSortlist(array("a.BIDANG_USAHA_ID" => $paket_bidang_usaha->getField("BIDANG_USAHA_ID"), 'b.REKANAN_KUALIFIKASI_ID' => $reqKualifikasiRekanan, "a.NILAI|| >= " => $nilaiHPS3));
                            }
           ...
           ?>
            ...
            <!-- <div class="card mb-1 border-blue border-darken-1">
              <div class="card-content"> 
                <div class="p-1">
                  <div class="row">
                    <div class="form-group col-md-12 mb-2" style="display: none">
                      <input type="hidden" name="reqUnitKerja" class="easyui-combobox"  id="reqUnitKerja"
                              data-options="valueField:'id',textField:'text',url:'unit_kerja_json/combo'"  value="<?=$this->UNIT_KERJA_ID?>" required required style="width: 300%"/>
                    </div> 
                  </div> 
                  <div class="row">
                    <div class="form-group col-md-12 mb-2">
                      <label>Alamat Panitia</label>
                      <textarea name="reqAlamatPanitia" class="easyui-validatebox span9 textarea-tinymce" style="width:100%; height:100%" rows="5" required><?=$reqAlamatPanitia?></textarea>
                    </div> 
                  </div>  
                  <div class="row">
                    <div class="form-group col-md-1 mb-2">
                      <label>Telp. Panitia</label>
                      <input name="reqTelpPanitiaKode" class="form-control easyui-validatebox span1" type="text" id="reqTelpPanitiaKode" value="<?=$reqTelpPanitiaKode?>" required />
                    </div> 
                    <div class="form-group col-md-11 mb-2">
                      <label>&nbsp;</label>
                      <input name="reqTelpPanitia" class="form-control easyui-validatebox span3" type="text" id="reqTelpPanitia" value="<?=$reqTelpPanitia?>" required />
                    </div> 
                  </div>  
                  <div class="row">
                    <div class="form-group col-md-12 mb-2">
                      <label>Email Panitia</label>
                      <input name="reqEmailPanitia" type="text" id="reqEmailPanitia" class="form-control easyui-validatebox span3" value="<?=$reqEmailPanitia?>" required />
                    </div> 
                  </div>  
                </div>
              </div>
            ...
            <div class="card mb-1 border-blue border-darken-1">
              <div class="card-content">
                <div class="p-1">
                  <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                    <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Dokumen Upload</strong>  
                    <!-- <a onclick="createRowNotaDinas()"> <span class="fa fa-plus text-white font-medium-2 icon-line-height" data-toggle="tooltip" data-placement="top" title="Tambah Lampiran"></span> </a>  -->
                  </div> 
                  <?php
                    $permohonan_paket_file = new PermohonanPaketFile();
                  if($reqPermohonanId == "")
                  {
                    $permohonan_paket_file->selectByParams(array("PAKET_ID" => coalesce($reqId, 0)));
                  }else
                  { 
                    $permohonan_paket_file->selectByParams(array("PERMOHONAN_PAKET_ID" => coalesce($reqPermohonanId, 0)));
                  } 
                  ?>
                  <div class="table-responsive">
                    <table class="border-double table mb-0">
                      ...
                      <tbody id="tbodyPermohonanPaketFile">
                           ...
                           <tr id="tr1<?=$no?>">
                             ...
                             <!-- <td> -->
                                ...
                                if ($permohonan_paket_file->getField("PATH_FILE")) {
                                   //echo "file: ".$permohonan_paket_file->getField("PATH_FILE");
                                 } ?>
                             <!-- </td> -->
                             <td style="text-align: center;">
                                 ...
                                 { 
                                  ...
                                  <!-- <a onClick="deleteDataTable('permohonan_paket_json/delete/', '<?=$permohonan_paket_file->getField("PERMOHONAN_PAKET_FILE_ID")?>', 'tr1<?=$no?>')" class="btn-aksi"><i class="fa fa-trash" aria-hidden="true" ></i></a> -->
                                 <?php
                                  }
                                 }
                                 else
                          ...
                          if($no == 1)
                          {
                              // $arrDokumenWajib = array("KAK", "Constructure", "Survei Harga", "Spesifikasi Teknis dan Brosur","PR");
                          ...
                          ?>
                              <tr id="tr1<?=$no?>">
                               ...
                               <!-- <td> -->
                                  ...
                                  temp : <?=$permohonan_paket_file->getField("PATH_FILE")?>
                               <!-- </td> -->
                               <td>
                               </td>
                              </tr>
            ...
            <div class="form-actions">
              ...
              <a href="<?php if($reqId == "") { ?>main/index/paket_lelang<? } else { ?>main/index/paket_detil/?reqId=<?=$reqId?><?php } ?>" class="btn btn-danger mr-1 text-white"> <?= BTN_KEMBALI ?> </a> 
              <button type="submit" class="btn btn-primary mr-1"><?= BTN_SIMPAN ?></button>
              <?php 
              if ($reqPL != '2') { ?>
              <a href="main/index/paket_lelang_tambah_rincian_pekerjaan/?reqId=<?=$reqId?>" class="btn btn-primary pull-right mr-1"><?= BTN_LANJUT ?></a>
              <?php 
              } ?>
            </div> 
