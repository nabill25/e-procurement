...
$user_type->selectByParams(array("USER_TYPE_ID" => $reqId));
$user_type->firstRow();

$reqUserTypeId = $user_type->getField("USER_TYPE_ID");
$reqNama = $user_type->getField("NAMA");
$reqAktif = $user_type->getField("AKTIF");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Tambah Group</strong>
        </div>
        <div class="p-1">
              ...
              <div class="form-group col-md-12 mb-2">
                ...
                <fieldset class="ccheckboxsas">
                  <div class="d-inline-block">
                    ...
                    if ($reqAktif == '1') { ?>
                      <label>
                        <input type="radio" name="reqAktif" value="1" checked="">
                        <span style="margin-right:10px"> Aktif </span>
                      </label>
                      <label>
                        <input type="radio" name="reqAktif" value="0">
                        <span style="margin-right:10px"> Non Aktif </span>
                      </label>
                    <?php
                    } elseif ($reqAktif == '0') { ?>
                      <label>
                        <input type="radio" name="reqAktif" value="1">
                        <span style="margin-right:10px"> Aktif </span>
                      </label>
                      <label>
                        <input type="radio" name="reqAktif" value="0" checked="">
                        <span style="margin-right:10px"> Non Aktif </span>
                      </label>
                    <?php
                    } else { ?>
