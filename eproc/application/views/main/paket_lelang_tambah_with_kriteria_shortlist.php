          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
              ...
              <?php
                ...
                <div class="form-group col-md-12 mb-2">
                  ...
                  <input type="text" name="reqMetodePengadaan" class="easyui-combobox span3"
                          data-options="valueField:'id',textField:'text',url:'paket_metode_lelang_json/combokatalog'"  value="<?= $reqMetodePengadaan?>" required style="width: 300%"/>
                </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-2 mb-2" id="reqMultiPemenang" <?php if ($reqMetodePengadaan == '1') {} else { ?> style="display:none" <?php } ?>>
                <label style="width: 100%">Pemanang lebih dari satu ?</label>
                          ...
                          ?>
                           <tr id="tr1<?=$no?>">
                             <td>
                                ...
                                <?=$permohonan_paket_file->getField("JUDUL")?>
                                <!-- <input class="form-control easyui-validatebox span4" type="text" required name="reqJudul[]" id="reqJudul<?php //$no?>" value="<?php //$permohonan_paket_file->getField("JUDUL")?>" <?php //if ($no <= 4) {?> readonly <?php //} ?>/> -->
                             </td>
                             <!-- <td> -->
                             ...
                             <td style="text-align: center;">
                                 ...
                                 // {
                                 ?>
                                    <!-- <a onClick="deleteDataTable('permohonan_paket_json/delete/', '<?php //$permohonan_paket_file->getField("PERMOHONAN_PAKET_FILE_ID")?>', 'tr1<?php //$no?>')" class="btn-aksi"><i class="fa fa-trash" aria-hidden="true" ></i></a> -->
                                 <?php
                                 // }
                                 ?>
                             </td>
