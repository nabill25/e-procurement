...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		columnDefs: [{ className: 'never', targets: [ 0, 1 ] },{ className: 'text-center', targets: [ 5 ] }]
    ...
    oTable.fnSort( [ [0,'desc'] ] );
        ...
        location.href = "main/index/master_sk_panitia_lampiran/?reqId="+anSelectedIdDelete;
        $('div.flexmenumobile').hide()
        $('div.flexoverlay').css('display', 'none')
      });
		  ...
		  $('#btnReset').on('click', function () {
			...
			$.messager.confirm('Konfirmasi',"Reset password data terpilih?",function(r){
				if (r){
					$.getJSON("perusahaan_json_sk_panitia/reset_password_anak_perusahaan/?reqId="+anSelectedId,
					  function(data){
							  $.messager.alert('Info', data.PESAN, 'info');
							  oTable.fnReloadAjax("perusahaan_json_sk_panitia/json_sk_panitia_anak_perusahaan");
					});
				}
			});
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">SK Panitia</h4>
      ...
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body area-datatable">
            ...
            <a id="btnAdd" class="btn round btn-min-width box-shadow-1 btn-primary text-white" title="Tambah"><span class="fa fa-plus"></span> Tambah</a>
            <a id="btnTambahLampiran" class="<?= CLASS_BTN_PRIMARY ?>" title="Lampiran"><span class="fa fa-file-pdf-o"></span> Tambah Lampiran</a>
            <a id="btnEdit" class="btn round btn-min-width box-shadow-1 btn-info text-white" title="Ubah"><span class="fa fa-pencil"></span> Edit</a>
