      ...
      <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
        ...
        <?php
         ...
         <!--  <li class="nav-item">
          ...
          ?>
            <li class="nav-item">
              <a href="main/index/executive_report" class="nav-link <?php if ($pg == "executive_report") { echo 'active'; } ?>">
                Executive Report
              </a>
            </li>
            <li class="nav-item">
         ...
         $arrayPemilihan = array('tendernon','tender');
          ...
          ?>
              ...
              <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                <a class="dropdown-toggle nav-link <?php if (in_array($pg, $arrayPemilihan)) { echo ' active'; } ?>" href="#" data-toggle="dropdown">Pemilihan</a>
                  <ul class="dropdown-menu">
                      <li class="nav-item">
                        <a class="dropdown-item" href="main/index/tendernon" class="nav-link <?php if ($pg == 'tendernon') { echo ' active'; } ?>">Non Tender</a></li>
                      <li class="nav-item">
                        <a class="dropdown-item" href="main/index/tender" class="nav-link <?php if ($pg == 'tender') { echo ' active'; } ?>">Tender</a></li>
                  </ul>
              </li>
              <?php } ?>
              <?php 
              if ($this->PENUNJUK_PIC == '1' && $this->LEVEL_KONTRAK == '1') { // ini khusus untuk level staff (peng. kontrak) 
                $arrayPenunjukanPIC = array('contracting_penunjukan_pic','contracting_bypass')?> 
              <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                <a class="dropdown-toggle nav-link <?php if (in_array($pg, $arrayPenunjukanPIC)) { echo ' active'; } ?>" href="#" data-toggle="dropdown">Penunjuka PIC</a>
                  <ul class="dropdown-menu">
                      <li class="nav-item">
                        <a class="dropdown-item" href="kontrak/index/contracting_penunjukan_pic" class="nav-link <?php if ($pg == 'contracting_penunjukan_pic') { echo ' active'; } ?>">PIC Kontrak</a></li>
                      <li class="nav-item">
                        <a class="dropdown-item" href="kontrak/index/contracting_bypass" class="nav-link <?php if ($pg == 'contracting_bypass') { echo ' active'; } ?>">PIC Kontrak Bypass</a></li>
                  </ul>
              </li>
            <?php 
            } ?>
          ...
          { ?>
          <li class="dropdown nav-item" data-menu="dropdown">
              <a href="#" class="dropdown-toggle nav-link <?php if (in_array($pg, array('dokumen_template'))) { echo ' active'; } ?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical" style="font-size:1rem !important"></i></a>
              <ul class="dropdown-menu"> 
                <li class="<?php if ($pg == 'dokumen_template') { echo 'active'; } ?>">
                  <a href="main/index/dokumen_template" class="dropdown-item <?php if ($pg == 'dokumen_template') { echo ' active'; } ?>">
                   Template Dokumen</a>
                </li>  
              </ul>
            </li>  
          ...
          if($this->USER_TYPE_ID == 11 || $this->USER_TYPE_ID == 3) // PEJABAT PEMBELI dan POKJA
          {
            $arrayePlanning = array('permohonan_penunjukan_pic');
            ?>
            <li class="nav-item">
          ...
          { ?>
            ...
            <li class="dropdown nav-item" data-menu="dropdown">
              <a href="#" class="dropdown-toggle nav-link <?php if (in_array($pg, array('dokumen_template_rekanan'))) { echo ' active'; } ?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical" style="font-size:1rem !important"></i></a>
              <ul class="dropdown-menu">
                <?php 
