...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "permohonan_paket_usulan_json/permohonan_usulan_monitoring_validator2_json",
		...
		/* Click event handler */
		  ...
		  $('#btnRJ').on('click', function () {
		   ...
		   $('#btnLihat').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/permohonan_paket_usulan_periksa_validator_keu/?usulanId="+anSelectedId);
		...
		$('#reqStatus').combobox({
			onSelect: function(param){
				oTable.fnReloadAjax("permohonan_paket_usulan_json/permohonan_usulan_monitoring_validator2_json/?reqStatus="+param.value);
			}
		});
} );
...
{
	oTable.fnReloadAjax("permohonan_paket_usulan_json/permohonan_usulan_monitoring_validator2_json");
}
