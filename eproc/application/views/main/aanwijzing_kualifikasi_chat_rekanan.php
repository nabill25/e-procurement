...
$(document).ready(function() {
  ...
  $(function(){
    $('#ff').form({
      url:'aanwijzing_chat_json/dokumen_aanwijzing_kualifikasi_rekanan',
      onSubmit:function(){
      ...
      success:function(data){
        ...
        alertSuccess2(data);
        setTimeout(function () {
          document.location.href = 'main/index/aanwijzing_kualifikasi_chat_rekanan/?reqId=<?=$reqId?>';
        }, 1000);
      }
    });
        ...
        <div class="card-body area-datatable">
                ...
                <tbody>
                  ...
                  if ($totalAan=='') {
                    ...
                    while($paket_aanwijzing->nextRow())
                    {
                      ...
                      $paket_aanwijzing_parent_first->selectByParamsKualifikasi(array("PAKET_ID" => $reqId, "PARENT_ID" => $paket_aanwijzing->getField("PAKET_AANWIJZING_KUALIFIKASI_ID") ));
                  ...
                  ">
                      ...
                      <td style="width: 10%; text-align: center"> 
                        ...
                        $cekJawab = $paket_aanwijzing_parent_count->getCountByParams(array("PAKET_ID" => $reqId, "PARENT_ID" => $paket_aanwijzing->getField("PAKET_AANWIJZING_KUALIFIKASI_ID") )); 
                        if ($paket_aanwijzing->getField("REKANAN_USER_ID") == $this->REKANAN_ID && $cekAktif == '1' && $cekJawab == '0') { 
                          ?>
                        <a onClick="deleteData('aanwijzing_chat_json/deletekualifikasi/', '<?= $paket_aanwijzing->getField("PAKET_AANWIJZING_KUALIFIKASI_ID")?>')" class="btn-aksi">
                          <?= ICON_DELETE ?>
                        </a>
                        <?php 
                        } ?>
                  ...
                  <?php
                    ...
                    // if ($paket_aanwijzing_parent->countRow() >=1) {
          ...
          if ($cekAktif == '1') { ?>
            <div class="card mb-1 border-blue border-darken-1" style="padding:10px">
              <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                <a href="main/index/aanwijzing_kualifikasi_chat_rekanan/?reqId=<?=$reqId?>" class="<?= CLASS_BTN_INFO ?> mr-1"><i class="fa fa-refresh"></i> Refresh</a>
          ...
          <?php 
            ...
            <div class="form-actions">
              ...
              <?php 
              if ($cekAktif == '0') { ?>
              <a href="main/loadUrl/report/aanwijzing_kualifikasi_cetak_pdf/?reqId=<?=$reqId?>" target="_blank" class="<?= CLASS_BTN_PRIMARY ?>"><i class="fa fa-print"></i> Hasil Aanwijzing</a>
              <?php 
              } ?>
