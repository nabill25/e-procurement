...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "payment_method_json/json",
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_payment_method_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_payment_method_add/?reqId="+anSelectedId);
			  $('div.flexmenumobile').hide()
			  $('div.flexoverlay').css('display', 'none')
		  });
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("payment_method_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("payment_method_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Payment Method</h4>
