...
$dokumen->selectByParams(array("TEMPLATE_REKANAN_ID" => $reqId));
$dokumen->firstRow();

$reqNama = $dokumen->getField("NAMA");
$reqKeterangan = $dokumen->getField("KETERANGAN");
$reqLinkFileTemp = $dokumen->getField("LAMPIRAN");
$reqTanggal = dateToPageCheck($dokumen->getField("TANGGAL"));
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
    		$('#ff').form({
    			url:'dokumen_template_rekanan_json/add',
    			onSubmit:function(){
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Template Dokumen</strong>
        </div>
        <div class="p-1">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
            ...
            <div class="row">
              <div class="form-group col-md-8 mb-2">
                <label>Lampiran ( <small>Format file .zip .pdf .doc & Maksimal ukuran file 2MB </small> )</label><br>
                <input type="file" name="reqLinkFile" id="reqLinkFile" size="30" <?php if($reqLinkFileTemp == "") { ?> required class="easyui-validatebox span9" <?php } ?> maxlength="1" validType="fileType['zip','pdf','doc']"/>
            ...
            <div class="form-actions">
              ...
              <a href="#" onClick="top.closePopup()" class="<?= CLASS_BTN_DANGER ?> mr-1"> <i class="fa fa-close"></i> Tutup</a>
