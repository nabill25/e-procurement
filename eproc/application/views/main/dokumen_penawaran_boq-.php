        ...
        <div class="card-body area-datatable">
          <div class="row">
            <div class="form-group col-md-12 mb-2">
              ...
              // {
              ?>
                <a href="main/index/dokumen_penawaran_boq/?reqId=<?=$reqId?>" class="btn btn-primary disabled">
                  <span class="fa fa-angle-double-right"></span>
                  <?=translate("Nilai Penawaran" , "Item Penawaran & Bill of Quantity")?>
                </a>
                <!-- <a href="main/index/dokumen_penawaran_rekanan/?reqId=<?php //$reqId?>" class="btn btn-primary"> <span class="fa fa-angle-double-right"></span>
                    <?php // translate("Dokumen Penawaran", "Proposal Documents")?>
                </a> -->
              ...
              ?>
                <!-- <a href="main/index/dokumen_penawaran_boq/?reqId=<?=$reqId?>" class="btn btn-primary disabled">
                  <span class="fa fa-angle-double-right"></span>
                  <?php //translate("Item Penawaran & Bill of Quantity", "Item Penawaran & Bill of Quantity")?>
                </a>
                <a href="main/index/dokumen_penawaran_rekanan/?reqId=<?php //$reqId?>" class="btn btn-primary"> <span class="fa fa-angle-double-right"></span>
                  <?php //translate("Dokumen Penawaran", "Proposal Documents")?>
                </a> -->
                  ...
                  <td colspan="5">
                    ...
                    <table class="table table-striped">
                      ...
                      <tr class="<?=$style?>">
                        ...
                        <td valign="top" <?=$style?> style="text-align: center">
                         <?=$rekanan_paket_penawaran->getField("QUANTITY")?></td>
                        <td valign="top" <?=$style?>>
                          <?php
                          // if($kirimPenawaran == 1)
                         ...
                         <?php
...

                          {
                           ...
                           ?>
                            ...
                            OnFocus="FormatAngka('reqUnitPrice<?=$i?>')" OnKeyUp="FormatUang('reqUnitPrice<?=$i?>'); summary();" OnBlur="FormatUang('reqUnitPrice<?=$i?>')" <?= $readOnly; ?> >
                             ...
                             ?>
                           <br>
                           <!-- <input type="file" name="reqLinkFile[]" id="reqLinkFile<?=$i?>" class="easyui-validatebox" validType="fileType['xls']" onChange="$('#reqSubmit').click()" /> -->
                          ...
                          <?php
                           ...
                           ?>
                           <br>
                           Rincian Penawaran Anda : <a href="uploads/penawaran/<?=$rekanan_paket_penawaran->getField("BOQ_REKANAN")?>" target="_blank" class="badge badge-pill badge-primary"><span class="fa fa-download"></span> download</a>
                           <br>
                           <?php
                           }
                           ?>
                           <br>
                           Rincian BoQ : <a href="uploads/boq/<?=$rekanan_paket_penawaran->getField("BOQ_FILE")?>" class="badge badge-pill badge-primary" target="_blank"><span class="fa fa-download"></span> download</a>
                  ...
                  <td colspan="2" align="right">
                   <?php
                    ...
                    ?>
                      ...
                      <!-- </div> -->
                      <!-- <input type="submit" name="reqSubmit" id="reqSubmit" value="Lanjut" class="btn btn-primary"> -->
                    <?php
                      }
                    }
                    ?>
...
<script type="text/javascript">
  ...
  <?php /*?>function prosesSelanjutnya()
  {
    <?php
    ...
    ?>
      var win = $.messager.progress({
                    title:'Kirim Email',
                    msg:'Mengirim email sertifikat dokumen penawaran...'
                  });
      ...
      .fail(function() {
        $.messager.progress('close');
        $.messager.alert('Info', 'Kirim email sertifikat gagal.', 'info');
      });
    <?php
      }
      else
