  ...
  <div class="card-content">
    <div class="p-1">
      <div class="p-1">
        ...
        $libplanningChecklist = new libplanning();
        echo $libplanningChecklist->checklist($reqId,$sirupId);
        ?>

        <?php 
        $libplanning2 = new libplanning();
        echo $libplanning2->headerRevisiPermohonan($reqId);
        ?>
        ...
        echo $libplanning->sirup($reqId,$sirupId); // Detail RUP dan Permohonan
        ?>

        <?php
        // echo $reqId.'--'.$sirupId;
        echo $libplanning->headerPRAttachment($reqId,$sirupId); // Detail PR

        if ($this->USER_TYPE_ID == '9') {
          echo $libplanning->headerPermohonanDokumenUnit($reqId);
        } else {
