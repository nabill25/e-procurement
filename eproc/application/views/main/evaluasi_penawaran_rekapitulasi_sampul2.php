...
$paket_rekanan->selectByParams2(array("PAKET_ID" => $reqId), -1, -1, " AND A.TANGGAL_DAFTAR IS NOT NULL AND A.LULUS_PENDAFTARAN = 1 AND A.LULUS_KUALIFIKASI = 1 AND KIRIM_PENAWARAN = 1 ", '', 'ORDER BY A.LULUS_PENAWARAN_URUT ASC');
  // code...
} else { // Harga Terendah
$paket_rekanan->selectByParams2(array("PAKET_ID" => $reqId), -1, -1, " AND A.TANGGAL_DAFTAR IS NOT NULL AND A.LULUS_PENDAFTARAN = 1 AND A.LULUS_KUALIFIKASI = 1 AND KIRIM_PENAWARAN = 1 ");
}
      ...
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body area-datatable">
          <div class="form-group col-md-12 mb-2">
            <div class="col-md-12">
              <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
                ...
                ?>
                  ...
                  <li role="presentation" style="width: 50% !important" class="active"><a href="main/index/evaluasi_penawaran_rekapitulasi/?reqId=<?=$reqId?>"><i class="fa fa-list-alt" aria-hidden="true"></i>
                    <p>Rekapitulasi</p>
                    </a>
                  </li>
                <?php
            ...
            <?php
            // } ?>
            <!-- <a href="main/index/evaluasi_penawaran_harga/?reqId=<?=$reqId?>" class="btn btn-primary disabled"><span class="fa fa-money"></span> Koreksi Aritmatik & Evaluasi Harga</a>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-hover table-responsive">
                ...
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top"> b. Harga Perkiraan </td>
                ...
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
                  <td valign="top"> c. % penawaran terkoreksi terhadap Harga Perkiraan </td>
                  <?php
                  for($i=0;$i<count($arrRekanan);$i++)
                  {
                  ...
                  <tr>
                    ...
                    for($i=0;$i<count($arrRekanan);$i++)
                    {
                        ...
                        { // Lulus
                            ...
                            {
                              $hasil = "Memenuhi Syarat <br> <small style='color:red'><i>Diatas Harga Perkiraan</i></small>";
                              $notifNegosiasi = 'Ya';
              ...
              <div class="form-actions">
                ...
                <button type="submit" name="reqSimpan" id="reqSimpan" class="<?= CLASS_BTN_PRIMARY ?> pull-right" style="<?php if ($reqBidding == 1) { echo'display:none'; } ?>"><i class="fa fa-check-square-o"></i> Simpan</button>
                <a class="<?= CLASS_BTN_INFO ?> mr-1" href="main/loadUrl/report/evaluasi_penawaran_rekapitulasi_excel/?reqId=<?=$reqId?>" target="_blank" ><?= BTN_PRINT ?> Rekapitulasi</a>
                <?php
                // 1:Tender, 2:Pengadaan langsung, 3:Tender Terbatas, 4:Seleksi Langsung, 5:Penunjukan Langsung, 6:e-Purchasing, 7:Tender Cepat, 8:Kompetisi, 10:Tender Kualifikasi
                if ($reqMetodePengadaan == '1' || $reqMetodePengadaan == '2' || $reqMetodePengadaan == '8'|| $reqMetodePengadaan == '10') {
                ...
                <!-- <a href="<?php // base_url('main/index/paket_lelang_tambah/?reqId='.$reqId) ?>" class="<?php // CLASS_BTN_PRIMARY ?> pull-right mr-1"><span class="fa fa-pencil"> Ubah Sistem Negosiasi</span></a> -->
