...
// $this->load->view ('main', NULL, TRUE);

$this->libsession->cekSession();   
// echo $this->USER_TYPE_ID; die();
...
// 1-e-Tender ,7-e-Tender Cepat, 2-Pengadaan Langsung ,5-Penunjukan Langsung Cepat, 6:Pembelian langsung, 8:Kompetisi
$getTahun = isset($_GET['tahun']) ? $_GET['tahun'] : 'all';
// $getTahun = $_GET['tahun'];
if ($getTahun != 'all'){
    $tahun = 'Tahun '.$getTahun;
  if ($unitkerja != 'all') {
    $countTender = $countTender->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "1", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $sumTender = $sumTender->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "1", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $countTenderTerbatas = $countTenderTerbatas->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $sumTenderTerbatas = $sumTenderTerbatas->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $countTenderCepat = $countTenderCepat->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "7", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $sumTenderCepat = $sumTenderCepat->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "7", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $countPengadaanLangsung = $countPengadaanLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "2", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $sumPengadaanLangsung = $sumPengadaanLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "2", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $countPenunjukanLangsung = $countPenunjukanLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "5", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun));
    $sumPenunjukanLangsung = $sumPenunjukanLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "5", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
    $countPembelianLangsung = $countPembelianLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun));
    $sumPembelianLangsung = $sumPembelianLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "A.UNIT_KERJA_ID" => $unitkerja, "extract(year from A.TANGGAL)" => $getTahun)); 
  } else {
    ...
    $countTenderTerbatas = $countTenderTerbatas->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "extract(year from A.TANGGAL)" => $getTahun)); 
    $sumTenderTerbatas = $sumTenderTerbatas->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "extract(year from A.TANGGAL)" => $getTahun)); 
    ...
    $countPembelianLangsung = $countPembelianLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "extract(year from A.TANGGAL)" => $getTahun));
    $sumPembelianLangsung = $sumPembelianLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "extract(year from A.TANGGAL)" => $getTahun)); 
  }
} else { 
  $tahun = ''; 
  if ($unitkerja != 'all') {
    $countTender = $countTender->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "1", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumTender = $sumTender->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "1", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $countTenderTerbatas = $countTenderTerbatas->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumTenderTerbatas = $sumTenderTerbatas->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "3", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $countTenderCepat = $countTenderCepat->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "7", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumTenderCepat = $sumTenderCepat->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "7", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $countPengadaanLangsung = $countPengadaanLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "2", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumPengadaanLangsung = $sumPengadaanLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "2", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $countPenunjukanLangsung = $countPenunjukanLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "5", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumPenunjukanLangsung = $sumPenunjukanLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "5", "A.UNIT_KERJA_ID" => $unitkerja));  
    $countPembelianLangsung = $countPembelianLangsung->getCountByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "A.UNIT_KERJA_ID" => $unitkerja)); 
    $sumPembelianLangsung = $sumPembelianLangsung->getSumByParams(array("A.PAKET_METODE_LELANG_ID" => "6", "A.UNIT_KERJA_ID" => $unitkerja)); 
  } else {
...
$(window).on("load", function(){
    ...
    var chartData = {
        ...
        datasets: [
          ...
          for ($i=0; $i < 5 ; $i++) { 
            $color = array('#76b82a','#ea5b1b','#38H076','#F98E76','#ffcc33','#010066');
            // $label = array('Tender','Tender_Cepat','Penunjukan_Langsung','Pengadaan_Langsung');
            $label = array('Tender','Tender_Terbatas','Tender_Cepat','Penunjukan_Langsung','Pengadaan_Langsung','Pembelian_Langsung');
          ?>
          {
...
<div class="row">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=1&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=3&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
                    <div class="media-body text-left">
                        <h3 class="orange"><?= $countTenderTerbatas ?></h3>
                        <span>e-Tender Terbatas</span>
                    </div>
                    <div class="media-right media-middle">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        ...
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=7&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
                    <div class="media-body text-left">
                    ...
                    <div class="media-right media-middle">
                        <i class="ft-clock deep-orange font-large-1 float-right"></i>
                    </div>
                </div>
                <div class="mb-0">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=5&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
                    <div class="media-body text-left">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=2&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
                    <div class="media-body text-left">
  ...
  <div class="col-md-2">
    ...
    <div class="card box-shadow-0 animated zoomIn" data-appear="appear" data-animation="zoomIn">
        <div class="card-content">
            <div class="card-body" onclick="openAdd('main/loadUrl/main/dashboard_detail/?metode=6&tahun=<?=$getTahun?>&uki=<?=$unitkerja?>')" style="cursor: pointer; padding: .7em">
                <div class="media">
                    <div class="media-body text-left">
...
$(function() {
  ...
  var tahun   = $('#tahun').val();
    ...
    if (activePoints[0]) {
      ...
      // alert(label+'-'+value);
      var url = 'main/loadUrl/main/dashboard_detail_pie/?jenis='+label+'&jumlah='+value+'&tahun='+tahun+'&uki=<?= $unitkerja ?>';
      openAdd(url);
    }
  };
});
