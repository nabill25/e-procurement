...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 11,
		"aoColumns": [
		...
		columnDefs: [
			// Tambahkan target 2 agar "PT PT Lorem Ipsum" ter-hide
			// Dan HAPUS target 7 agar gambar Centang Status Validasi tidak ter-hide
			{ className: 'never', targets: [0,9] }, 
			{ className: 'text-center', targets: [ 6, 7, 9 ] }
		]
		});
