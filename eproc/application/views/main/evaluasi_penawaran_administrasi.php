...
$this->load->model(array("PaketEvaluasiAdminTawar","Paketpemenang"));
...
$arrEvaluasiFile1  = EVALUASI_PANAWARAN;
$aktif_evaluasi = $paket_tahap->getCountByParamsAktif(array("URUT" => $arrEvaluasiFile1[$jenis_tahap], "PAKET_ID" => $reqId, "TAMPILKAN" => 1));
$aktif_evaluasi2 = $paket_tahap->getCountByParamsBerlalu(array("URUT" => $arrEvaluasiFile1[$jenis_tahap], "PAKET_ID" => $reqId, "TAMPILKAN" => 1));
...
{
  $cekAktif = "0";//"Password akan terbuka pada : ".$paket_tahap->getField("JAM_BUKA");
}
// echo $info; die;
        ...
        if ($cekAktif == '0') {
           echo '<div class="alert alert-danger" style="color:#fff">
                    <span style="color: #fff">
                      Evaluasi Penawaran belum dimulai.
                    </span>
                  </div>';
        } else 
        { ?>
          <div class="form-group col-md-12 mb-2">
            <div class="col-md-12">
                <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
                  <li role="presentation" class="active"><a href="main/index/evaluasi_penawaran_administrasi/?reqId=<?=$reqId?>"><i class="fa fa-check" aria-hidden="true"></i>
            ...
            <!-- <a href="main/index/evaluasi_penawaran_administrasi/?reqId=<?=$reqId?>" class="btn btn-primary disabled"><i class="fa fa-check"></i> Evaluasi Administrasi</a> -->
          ...
          <div class="table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  <td width="20%">Upload BA Evaluasi Administrasi</td>
                  <td>
                ...
                <table class="table table-bordered table-hover">
                    <tr>
                      ...
                      while($paket_evaluasi_admin->nextRow())
                      {
                        ...
                        // echo '<th width="10%" style="text-align:center">'.$paket_evaluasi_admin->getField("NAMA").'</th>';
                    ...
                    ?>
                      <tr>
                        ...
                        <!-- </td> -->
                        <!-- <td>                                   -->
                          <textarea class="form-control" name="reqUraian[]" id="reqUraian<?=$check?>" <?php if($status == "1" || $status == "") { ?> style="display:none;" <?php } ?> placeholder="alasan tidak memenuhi syarat..." <?= $formReadOnly ?>><?=$uraian?></textarea>
                          <textarea class="form-control" name="reqKeterangan[]" id="reqKeterangan<?=$check?>" <?php if($status == "0") { ?> style="display:none;" <?php } ?> placeholder="keterangan tambahan.." <?= $formReadOnly ?>><?=$keterangan?></textarea>
                        </td>
                      </tr>
                    <?php
                    $no++;
