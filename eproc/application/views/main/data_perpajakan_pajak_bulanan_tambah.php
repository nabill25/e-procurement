  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Laporan Pajak Bulanan(PPN) </h4>
                  ...
                  <table class="border-double table mb-0">
                    <tbody>
                      <tr class="judul-kolom">
                        ...
                        <th>Nomor</th>
                        <th>Tanggal</th>
                        <th class="text-center">File PPN <small> (Format file .pdf & Maksimal ukuran file 2MB)</small></th>
                      </tr>
                      <?php
                      for($i=1;$i<=12;$i++)
                      {
                      ...
                      <script type="text/javascript">
                       ...
                       <tr >
                         ...
                         <td class="text-center"><input type="file" name="reqLinkFilePPN[]" class="easyui-validatebox"  validType="fileType['pdf']" />
