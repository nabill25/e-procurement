        ...
        <div class="row row-treegrid">
        	<div class="col-md-12 col-treegrid">
                ...
                <div id="idpencarian" class="area-pencarian">
                    <label>Ketik nama pengalaman : <input class="" placeholder="" name="reqPencarian" aria-controls="example" type="search"></label>
                </div>
				<div id="tableContainer" class="tableContainer tableContainer-treegrid">
                	<table id="treeSatker" class="easyui-treegrid" style="width:700px;height:300px"
                            data-options="
                                url: 'rekanan_pengalaman_json/get_data_pengalaman',
                                method: 'get',
                                idField: 'id',
                                treeField: 'text'
                            ">
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'PENGALAMAN_BIDANG'" >Bidang Usaha</th>
    ...
    $(document).ready( function () {
		...
		$('input[name=reqPencarian]').keypress(function( event ) {
			if ( event.which == 13 ) {
				...
				var urlApp = 'rekanan_pengalaman_json/get_data_pengalaman/?reqSearch='+ value;
				$('#treeSatker').treegrid(
				{
					url: urlApp
				});	
        ...
        $('#treeSatker').treegrid({
              onDblClickRow: function(param){
					top.tambahPengalaman(param.id, param.NAMA);
              }
        });
    });
