        ...
        <div class="row row-treegrid">
        	<div class="col-md-12 col-treegrid">
            	<div class="area-konten-atas">
                	<div class="judul-halaman">Pihak Lain
                    	<div class="info">
				...
				<div id="tableContainer" class="tableContainer tableContainer-treegrid">
                	<table id="treeSatker" class="easyui-treegrid" style="width:700px;height:300px"
                            data-options="
                                url: 'users_base_json/get_data_daftar_pihak_lain/?reqId=<?=$reqId?>',
                                method: 'get',
                                idField: 'id',
                                treeField: 'text'
                            ">
                        <thead>
                            <tr>
                                <th data-options="field:'USER_NAMA'" >USER_NAMA</th>
                                <th data-options="field:'USER_LOGIN'" >USER_LOGIN</th>
                                <th data-options="field:'USER_TYPE'" >USER_TYPE</th>
                            </tr>
                        </thead>
                    </table>
                </div>
    ...
    $(document).ready( function () {
        $('#treeSatker').treegrid({
              onDblClickRow: function(param){
				 top.tambahPihakLain(param.id, param.USER_NAMA, param.USER_LOGIN, param.USER_TYPE);
              }
        });
    });
