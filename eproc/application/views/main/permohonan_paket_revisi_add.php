...
$pparId = new Permohonanpaketapprovalrevisi();
...
<html lang="en">
  <head>
    ...
    function openAdd(pageUrl) {
  	...
  	$(function(){
  		$('#ff').form({
  			url:'permohonan_paket_approval_json/addRevisi',
  			onSubmit:function(){
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Revisi Usulan</strong>
        </div>
        <div class="p-1">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                <label>Catatan</label>
                <input type="text" name="reqCatatan" value="<?=$reqCatatan?>" title="" class="form-control easyui-validatebox span9" required >
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                <label>Lampiran File ( <small>.pdf .docx .xlsx</small> )</label><br>
                <input type="file" name="reqLinkFile" id="reqLinkFile" size="30" <?php if($reqLinkFileTemp == "") { ?> class="easyui-validatebox span9" <?php } ?> maxlength="1" validType="fileType['pdf','docx','xlsx']"/>
