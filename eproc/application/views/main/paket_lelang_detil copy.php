...
$paket_metode_lelang_id = $paket->getField("PAKET_METODE_LELANG_ID"); // 1-e-Tender, 3-Tender Terbatas,7-e-Tender Cepat, 2-Pengadaan Langsung ,5-Penunjukan Langsung Cepat, 6-Pembelian langsung
...
<div class="row"> 
  <div class="col-md-3 col-sm-3">
    <div class="jqueryui-ele-container">
      <ul class="menu-icons">
        <li class="ui-widget-header btn-primary text-white"><div>Info Detail</div></li> 
        <!--  FOR PANITIA -->
        <?
        ...
        { 
          ...
          if($this->USER_LOGIN_ID == $paket_user_id || $idPanitia > 0)
          {
            ...
            $editpaket = 0;
            // 1-e-Tender ,2-Pengadaan Langsung, 3-Tender Terbatas ,5-Penunjukan Langsung Cepat,7-e-Tender Cepat
        ...
        ?>
            <li>
              <div>
                <a href="main/index/paket_lelang_tambah/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span> Edit Paket Pengadaan 
                  <?php if ($editpaket == 0) { echo $wajib; } else { echo $sudahwajib; }  ?></span></a>
              </div>
            </li>
            <?php 
          ...
          if($this->USER_LOGIN_ID == $paket_user_id || $idPanitia > 0 || $this->USER_TYPE_ID == 7) // KEPALA PENGADAAN
          { 
            if (($idPanitia > 0 || $this->USER_TYPE_ID == 7) && ($paket_metode_lelang_id == '1' || $paket_metode_lelang_id == '7')) {  // KHUSUS PANITIA & KEPALA PENGADAAN
             ?>
              <li>
                <div>
            ...
            <?php 
            if (($paket_metode_lelang_id == '1' || $paket_metode_lelang_id == '7') && $this->USER_LOGIN_ID == $paket_user_id ) { ?>
            <li>
              <div>
            ...
            {
              if ($paket_metode_lelang_id != '7' && ($this->USER_LOGIN_ID == $paket_user_id || $idPanitia > 0)) {
            ?>
              <!-- <li>
                <div>
            ...
            ?>
                ...
                <li>
                  <div>
                    <a href="main/index/paket_lelang_tambah_negosiasi_undangan/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span>  Negosiasi </a>
                  </div>
                </li>   
            <?
                }
          ...
          ?>
            ...
            <li>
              <div>
                <a href="main/loadUrl/report/dokumen_pembukaan_penawaran_ba_pdf/?reqId=<?=$reqId?>" target="_blank"> <span class="fa fa-angle-double-right"></span>  Hasil Pembukaan Penawaran </a>
              </div>
            </li>   
            <li>
              <div>
                ...
                ?>
                  ...
                  if($aktif_dok_penawaran1 > 0 || $aktif_dok_penawaran2 > 0)
                  {
                    ...
                    ?>
                      <li>
                        <div>
                          <a href="main/index/dokumen_penawaran_boq/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span>  <?=translate("Dokumen Penawaran", "Submit Proposal")?></a>
                        </div>
                      </li>  
                    <?
                    }
                  ...
                  if($reqKirimPenawaran == "1")
                  {
                    ...
                    ?>
                      <li>
                        <div>
                          <a href="main/index/dokumen_penawaran_password/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span> <?=translate("Upload File .cert ".$uploadPassTitle, "Upload Certificate File")?></a>
                        </div>
                      </li>   
                    <?
                    }
                  ...
                  if($reqLulusPenawaranSampul1 == "1")
                  {
                    ...
                    ?>
                      <li>
                        <div>
                          <a href="main/index/dokumen_penawaran_password_sampul2/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span>  Upload File .cert File 2 </a>
                        </div>
                      </li>  
                    <?
                    }
                  ...
                  else
                  {
                    ...
                    ?>
                      <li>
                        <div>
                          <a href="main/index/negosiasi_rekanan/?reqId=<?=$reqId?>"> <span class="fa fa-angle-double-right"></span> <?=translate("Negosiasi", "Negotiation")?> </a>
                        </div>
                      </li>   
                    <?
                    } 
          ...
          ?>
            ...
            ?>
              <li>
                <div>
                  <a href="main/loadUrl/report/paket_cetak_pdf/?reqId=<?=$reqId?>" target="_blank"> <span class="fa fa-angle-double-right"></span>  Cetak Laporan Paket </a>
                </div>
              </li>   
            <?php 
            }  
        ...
        <div class="card-body">
          ...
          <form id="ff" class="easyui-form form-horizontal" method="post" data-options="novalidate:true" enctype="multipart/form-data">
              ...
              ?>
                  ...
                  ?>
                    ...
                    { 
                      $alertPenyedia .= "Anda telah mendaftar paket pada ".getFormattedDate($reqTanggalDaftar)." dengan <b> no. registrasi : ".$reqKodeRekanan.'</b><br>';  

                    } // END if (($paket_metode_lelang_id == '1' || $paket_metode_lelang_id == '7'))
                    else {  
                      $alertPenyedia .= "Anda telah diundang paket ini <br>";  
                    }
                    ?>
                      ...
                      <!-- <li class="gagal"> -->
                        ...
                        <div class="alert alert-danger">
                          ...
                          <?=translate("<b>Anda tidak dapat melanjutkan proses lelang.</b>", "You cannot proceed to the next stage.")?>
                          <br>
                          <?=translate("Verifikasi data pendaftaran anda gagal dengan alasan sebagai berikut : <b><u>".$paket_rekanan_daftar->getField("LULUS_PENDAFTARAN_KETERANGAN").'</u></b>', "Tender registration failed, the following reasons")?>
                        </div>    
                        <?
                        ?> 
                      <?
                      ...
                      } else
                      {
                        if($status_dok_kualifikasi1 > 0 || $status_dok_kualifikasi2 > 0)
                        {
                          ...
                          ?>
                           <!--  <div class="alert alert-primary">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>  -->
                              <?php $alertPenyedia .= translate("Anda telah memasukkan data kualifikasi", "You have completed the prequalification data"); ?>.
                            <!-- </div>    -->
                          <?
                          } else
                          {
                          ?>
                            <!-- <div class="alert alert-danger">
                              <button type="button" class="close" data-dismiss="alert">&times;</button> -->
                              <?php $alertPenyedia .= translate("Anda belum memasukkan data kualifikasi", "You have not completed the pra-qualification data")?>.
                            <!-- </div>    -->
                          <?
                          }
                        }
                        ...
                        if($publish_ba_kualifikasi == "1")
                        {
                          ...
                          ?>
                            <div class="alert alert-primary">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>
                              <?=translate("Anda telah lolos pada tahap kualifikasi", "You have passed the prequalification stage")?>.
                            </div>   
                          <?
                          }
                        }
                        ...
                        if ($paket_metode_lelang_id != '7') { 
                          ...
                          ?>
                            <!-- <div class="alert alert-danger">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <?=translate("Anda belum mengikuti Aanwijzing", "You have not completed the Aanwijzing Chat")?>.
                            </div>   -->
                          <?
                            } else
                            {
                          ?>
                            <!-- <div class="alert alert-primary">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>
                              <?=translate("Anda telah mengikuti Aanwijzing", "You have completed the Aanwijzing Chat")?>.
                            </div>  -->
                          <?
                            }
                          }
                        ...
                        ?>
                            <!-- <div class="alert alert-primary">
                              <button type="button" class="close" data-dismiss="alert">&times;</button> -->
                              <?php $alertPenyedia .= translate("Anda telah memasukkan dokumen penawaran", "You have completed the Bidding Documents").'<br>'?>
                            <!-- </div>   -->
                            <?
                              ...
                              ?>
                                  <div class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <?=translate("Anda belum mengupload File .cert dokumen penawaran".$sampul1, "You have not uploaded bidding document ".$sampul1." password")?>.
                                  </div>
                              <?
                              }
                              else
                              ...
                              ?>
                                  <!-- <div class="alert alert-primary">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button> -->
                                    <?php $alertPenyedia .= translate("Anda telah mengupload File .cert dokumen penawaran".$sampul1, "You have uploaded the bidding document ".$sampul1." password").'<br>'?>
                                  <!-- </div> -->
                              <?
                              }
                        ...
                        ?>
                              <div class="alert alert-danger">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <?=translate("Anda belum memasukkan dokumen penawaran", "You have not completed the bidding documents")?>.
                              </div>   
                        <?
                            }
                          }
                        ...
                        ?>
                            <div class="alert alert-primary">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>
                              <?=translate("Anda telah lolos evaluasi penawaran File 1", "You have passed the bid evaluation of Cover 1")?>.
                            </div>   
                            ...
                            ?>
                              <div class="alert alert-danger">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <?=translate("Anda belum mengupload File .cert File 2", "You have not uploaded bidding document cover 2 password")?>.
                              </div>  
                            <?
                            } else
                            {
                            ?>
                              <div class="alert alert-primary">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <?=translate("Anda telah mengupload File .cert File 2", "You have uploaded the bidding document cover 2 password")?>.
                              </div>   
                            <?
                            }
                          } else
                          {
                            ...
                            <div class="alert alert-danger">
                              <button type="button" class="close" data-dismiss="alert">&times;</button>
                              <?=translate("Anda gagal pada tahap evaluasi penawaran File 1", "You have failed the bid evaluation of Cover 1")?>.
                            </div>   
                            <?
                          }
                        }
                    ...
                    ?>
                      ...
                      ?>
                          <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                              <?=translate("Anda gagal pada tahap kualifikasi", "You failed the prequalification stage")?>, <?=translate("Alasan", "Reason")?> : <?=$reqLulusKualifikasiKeterangan;?>.
                          </div>   
                          <?
                        }
                      }
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table mb-0">
                        ...
                        <?
                          ...
                          ?>
                          <tr <? if($now == 1) { ?>style="background: #967adc; color: #fff" <? } ?>>
                            <td width="5%" <? if($now == 1) { ?>style="font-weight:bold" <? } ?>>
                              <?=$i?>.
                            </td>
                            <td width="60%" <? if($now == 1) { ?>style="font-weight:bold" <? } ?>> 
                              <?=$paket_tahap_jadwal->getField("NAMA")?> <? if($paket_tahap_jadwal->getField("HADIR") == 1) { ?><b style="color: blue; font-size: 1.1em">*</b><? } ?>
                            </td>
                            <td width="35%" <? if($now == 1) { ?>style="font-weight:bold" <? } ?>> 
                                <div class="badge badge-border border-info badge-square">
                                  <span class="info">
                                  <i class="fa fa-clock-o font-medium-2"></i>
                                    <!-- <span style="color:#000"> -->
                                      <span <? if($now == 1) { ?>style="background: #967adc; color: #fff" <? } ?>>
          ...
          <div class="form-actions">
            ...
            switch ($paket_metode_lelang_id) {
              ...
              case '3':
              case '7':
                echo '<a href="main/index/paket_lelang" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a>';
                break;
              case '2':
              case '5':
                echo '<a href="main/index/paket_lelang2" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a>';
                break;
              case '6':
                echo '<a href="main/index/pembelian_langsung" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a>';
                break;
