              ...
              <table class="table table-bordered table-hover"> 
                ...
                { ?>
                  ...
                  <!-- <tr>
                    ...
                    //       $hasil = "<span style='color:red; font-weight:bold'>Gagal evaluasi harga penawaran.</span>";                
                ...
                <?php 
                if ($reqMetodeEvaluasiId != '2') { // Sistem Harga Terendah  ?>
                <tr>
                  <td valign="top">
                  <?php 
                  // 1-e-Tender ,2-Pengadaan Langsung ,5-Penunjukan Langsung Cepat,7-e-Tender Cepat
                  ...
                  <?php 
                  if ($paket->getField("BIDDING") == '0' || $paket->getField("BIDDING") == '') { // jika Sistem Negosiasi  ?>
                    <td valign="top" colspan="2"><strong> HARGA NEGOSIASI </strong></td>
                  <?php 
                  } else { ?>
                    <td valign="top" colspan="2"><strong> HARGA E-REVERSE AUCTION </strong></td>
                  <?php 
                  } ?>
                  <?php
                  for($i=0;$i<count($arrRekanan);$i++)
                  ...
                  ?>
                      ...
                      <?php 
                      if ($paket->getField("BIDDING") == '0' || $paket->getField("BIDDING") == '') { // jika Sistem Negosiasi  
                        if ($reqRekananIdPemenang == $arrRekananId[$i]) { // tampilkan untuk penyedia yang di nego (karena hanya 1 penyedia yang dinego)
                          echo numberToIna($jumlahNegosiasi[$i]); 
                         } else {
                          echo "-";
                         }
                      } else {  
                        echo numberToIna($arrPaketRekananNilaiAuction[$i]);
                      } ?>
                      </td>
                  <?php
                  }
