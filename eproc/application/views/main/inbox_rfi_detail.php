...
$arrStatement = array("A.INBOXID" => $id, "A.PARENT" => 0, "A.INBOXCATEGORYID" => '1');
              ...
              <div class="col-lg-12 col-xl-12">
                <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                  <div class="card collapse-icon accordion-icon-rotate">
                    ...
                    <div id="accordion51" role="tabpanel" aria-labelledby="heading51" class="card-collapse collapse show" aria-expanded="true">
                      <div class="card-content">
                        <div class="card-body">
                          ...
                          if ($this->USER_TYPE_ID != '2' && $this->USER_TYPE_ID != '9') { // Bukan Administrator & Bukan Perencana
                          ?>
                          <hr>
                          <a href="main/index/inbox_rfi_penyedia_add?id=<?=$inboxid?>" class="<?= CLASS_BTN_PRIMARY ?> icon-action-undo iconsize pull-left" target="_blank"> Reply</a><br><br>
                          <?php
                          } ?>
                        </div>
                      </div>
                    ...
                    <?php
                    $no=1;
                    if ($this->USER_TYPE_ID == '2' || $this->USER_TYPE_ID == '9') { // Admin VMS, Perencana/Pengguna
                      $dataInboxReplay->selectByPenerima(array("A.PARENT" => $inboxid, "A.INBOXCATEGORYID" => '1'), -1, -1); // 1:RFI 2:Survey 3:Complain
                    } else {
                      $dataInboxReplay->selectByPenerima(array("A.PARENT" => $inboxid, "A.INBOXCATEGORYID" => '1', "A.CREATED_BY" => $this->REKANAN_ID), -1, -1); // 1:RFI 2:Survey 3:Complain
                    }
                        ...
                        <div id="accordion<?= $no ?>" role="tabpanel" aria-labelledby="heading<?= $no ?>" class="card-collapse collapse">
                          <div class="card-content">
                            <div class="card-body">
                              ...
                              <?php
                              if ($dataInboxReplay->getField("CREATED_BY") != $this->REKANAN_ID && $this->USER_TYPE_ID != '2' && $this->USER_TYPE_ID != '9') {
                               ?>
                              <hr>
                              <a href="main/index/inbox_rfi_penyedia_add?id=<?=$inboxid?>" class="btn btn-primary icon-action-undo iconsize pull-left" target="_blank"> Reply</a><br><br>
                              <?php
                              } ?>
                            </div>
                          </div>
