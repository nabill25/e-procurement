...
$showRecord = 5;
$pageView = "paket_json/tendernon/";

if($this->USER_TYPE_ID == 6) // Rekanan
{
  // $arrStatement = array("JENIS_PENGADAAN" => "LELANG", "PUBLISH_PAKET" => "1", "A.PAKET_METODE_LELANG_ID|| IN " => "(2,4,5,6,8,9)");
  $arrStatement = array("PUBLISH_PAKET" => "1", "A.PAKET_METODE_LELANG_ID|| IN " => "(2,4,5,6,8,9)");
  $rowCount = $paket->getCountByParamsPaketRekanan2($arrStatement, $this->REKANAN_ID);
  $paket->selectByParamsPaketRekananNonTender($arrStatement, $showRecord, 0, $this->REKANAN_ID);
}
else
{ // 1-e-Tender ,7-e-Tender Cepat, 2-Pengadaan Langsung ,5-Penunjukan Langsung Cepat
  if((int)$this->USER_TYPE_ID == 3 || $this->USER_TYPE_ID == 7 || $this->USER_TYPE_ID == 9 || $this->USER_TYPE_ID == 10 || $this->USER_TYPE_ID == 11 || $this->USER_TYPE_ID == 27 || $this->USER_TYPE_ID == 20)
...
<?php
if($this->USER_TYPE_ID == "3" || $this->USER_TYPE_ID == "11") //PANITIA, PejabatPembeli
{
?>
  <script>
        ...
        <div class="card-header">
          <!-- <h4 class="card-title">Tender</h4> -->
           <?php if($this->USER_TYPE_ID == "3") { // PANITIA  ?>
               <a title="#" onClick="openAdd('main/loadUrl/main/cetak_filter_tahun?reqMetode=tendernon');" class="<?= CLASS_BTN_INFO ?> mr-1 text-white" ><?= BTN_PRINT ?></a>
            <?php } ?>
            ...
            <div class="col-md-1 d-none d-sm-block">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" onclick="setSort('0')">Paket Selesai</a>
                  <a class="dropdown-item" onclick="setSort('1')">Paket Berjalan</a>
                  <a class="dropdown-item" onclick="setSort('2')">Paket Batal</a>
                  <a class="dropdown-item" onclick="setSort('3')">Paket Gagal</a>
                </div>
              </div>
            </div>
            <div class="col-md-11">
              <div class="card-block">
                <fieldset>
                  <div class="input-group">
                    <input type="text" id="reqPencarian" class="form-control" placeholder="Cari Non Tender . . .">
                              ...
                              while($paket_tahap_tender->nextRow())
                              {
                               ...
                               <!-- <p class="mb-0  mt-1">
                                <span class="badge badge-warning" style="color: #000">
                                  Tahap : <?php // echo $paket_tahap_tender->getField("NAMA") ?>
                                </span>
                               </p>  -->
                               <?php
                               }
                              ...
                              <p class="mb-0 mt-1">
                                ...
                                ?>
                                 ...
                                 if(((int)$this->USER_TYPE_ID == 3 || (int)$this->USER_TYPE_ID == 11) && $paket->getField("USER_LOGIN_ID") == $this->USER_LOGIN_ID && ($paket->getField("PAKET_METODE_LELANG_ID") == "2" ||  $paket->getField("PAKET_METODE_LELANG_ID") == "4" ||  $paket->getField("PAKET_METODE_LELANG_ID") == "5" || $paket->getField("PAKET_METODE_LELANG_ID") == "6" || $paket->getField("PAKET_METODE_LELANG_ID") == "8"))
                                 {
                                  ...
                                  // } else if($paket_panitia_belum_validasi->countRow() != 0) {
                                 ?>
