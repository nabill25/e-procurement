          ...
          <div class="form-group col-md-12 mb-2">
            <div class="col-md-12">
              <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
                ...
                <li role="presentation" class="active"><a href="main/index/evaluasi_penawaran_harga/?reqId=<?=$reqId?>"><i class="fa fa-money" aria-hidden="true"></i>
                  <p>Evaluasi Harga</p>
                  </a></li>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  <td width="20%"> Harga Perkiraan Sendiri</td>
                  <td> <?=$reqMataUang?> <?=currencyToPage($reqOwnerEstimate)?> </td>
                </tr>
                <tr>
                  <td width="20%">Upload BA Evaluasi Harga</td>
                  <td>
              ...
              <table class="table table-bordered table-hover">
                ...
                if($allowPassword == 1)
                {
                  ...
                  while($rekanan_paket_penawaran->nextRow())
                  {
                    ...
                    for($i=0;$i<count($arrRekanan);$i++)
                    {
                      ...
                      for ($g=0; $g < count($a) ; $g++) {
                        ...
                        if ($rekanan_evaluasi_teknis_tawar->countRow() > 0) {
													...
													if ($rekanan_evaluasi_teknis_tawar->getField("MEMENUHI_SYARAT") == '1') {
                      ...
                      <tr>
                        ...
                        { ?>
                          ...
                          if($rekanan_paket_penawaran->getField("BOQ_".$arrPaketRekananId[$i]) == "")
                            ...
                            {
                              // if ($reqMetodeLelang == '2') { // Pengadaan Langsung 
                            ?>
                          <br>
                         <a href="uploads/penawaran/<?php echo $rekanan_paket_penawaran->getField("BOQ_".$arrPaketRekananId[$i])?>" class="badge badge-dark">download rincian BoQ</a>
                          <?php
                            // }
                          }
                          ?>
                    ...
                    $no++;
                    $check++;
                    } // end of for($i=0;$i<count($arrRekanan);$i++)
