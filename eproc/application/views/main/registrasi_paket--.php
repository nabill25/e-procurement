        ...
        <div class="card-body area-datatable">
	        ...
	        <form id="ff" class="easyui-form form-horizontal" method="post" enctype="multipart/form-data">
		        ...
		        <div class="form-actions">
				    ...
				    <a href="main/index/tender" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a>
				    <button type="submit" class="btn btn-primary pull-right">Lanjut Daftar <i class="fa fa-arrow-right"></i></button>
			  	</div>
