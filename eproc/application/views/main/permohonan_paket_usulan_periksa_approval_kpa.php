          ...
          <table class="table table-striped table-hover" id="tbl_bidang">
            <tr>
              <td> 
                  ...
                  <input value="51252" name="reqApprove" id="reqApprove" onchange="handleChange(this);" type="radio" style="cursor:pointer"/> &nbsp; Kembalikan ke PKPA
              </td>
            </tr>
            <tr id="trPPKom">
              <td>
                <label>Pilih PPKom</label><br>
                  <input type="text" class="easyui-combobox" name="reqPIC" id="reqNama" title="PPKom harus diisi" data-options=" required: true, filter: function(q, row) { return row['text'].toLowerCase().indexOf(q.toLowerCase()) != -1; }, valueField: 'id', textField: 'text', url: 'panitia_json/panitia_combo_json_ppkom/?reqUnitKerja=<?=$this->UNIT_KERJA_ID?>'" value=""  style="width:400px;"><br>
