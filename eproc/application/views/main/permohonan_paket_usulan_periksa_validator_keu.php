        ...
        ?>
         ...
         <form id="ff" method="post" class="form-horizontal" role="form">
          ...
          <table class="table table-striped table-hover" id="tbl_bidang">
            <tr>
              <td> 
                  <input value="51" name="reqApprove" id="" type="radio" style="cursor:pointer" checked="" /> &nbsp; Setujui dan teruskan ke Approval PKPA &nbsp;&nbsp;
                  <input value="41242" name="reqApprove" id="" type="radio" style="cursor:pointer"/> &nbsp; Kembalikan ke Validator Perencana
              </td>
            </tr>
            <tr> 
              <td>Catatan <br>
