          ...
          <table class="table table-bordered">
            ...
            { ?>
                  ...
                  <tr style="background-color: #967adc; color: #fff; font-size: 1.2em">
                    <td align="center" colspan="5"><b>FILE I</b></td>
                  </tr>
                  <?php
                  }
                  ?>
                  <tr>
                    ...
                    <th style="width: 25%; text-align: center"><?=translate("Aksi", "Action")?></th>
                  </tr>
                  <tr class="gelap" style="background-color: #b7b7b7; color: #000">
                    ...
                    if($paket_evaluasi_admin_tawar->getField("WAJIB") == '1')
                      ...
                      {
                      ?>
                          <a href="uploads/penawaran/<?=$paket_evaluasi_admin_tawar->getField("PATH_FILE")?>" target="_blank"><span class="fa fa-download"></span></a>
                          <?php
                          if($kirimPenawaran == "1")
                          {}
                          else
                          ...
                          ?>
                           -
                          <a onClick="deleteData('dokumen_pengadaan_upload_rekanan/delete_dokumen/', '<?=$paket_evaluasi_admin_tawar->getField("PAKET_DOKUMEN_ID")?>')"><span class="fa fa-trash"></span></a>
                      <?php
                          }
                          $jumlahUploadAdmin++; ?>
                        <br>
                  ...
                  <tr class="gelap" style="background-color: #b7b7b7; color: #000">
                    ...
                    <tr class="terang">
                      ...
                      {
                      ?>
                          <a href="uploads/penawaran/<?=$paket_evaluasi_teknis_tawar->getField("PATH_FILE")?>" target="_blank"><span class="fa fa-download"></span></a>
                          <?php
                          if($kirimPenawaran == "1")
                          {}
                          else
                          ...
                          ?>
                           -
                          <a onClick="deleteData('dokumen_pengadaan_upload_rekanan/delete_dokumen/', '<?=$paket_evaluasi_teknis_tawar->getField("PAKET_DOKUMEN_ID")?>')"><span class="fa fa-trash"></a>
                      <?php
                          }
                          $jumlahUploadTeknis++; ?>
                          <br>
                  ...
                  <tr class="gelap" style="background-color: #b7b7b7; color: #000">
                      ...
                      <td colspan="5">Dokumen Harga</td>
                        ...
                        <tr class="terang">
                          ...
                          {
                          ?>
                              <a href="uploads/penawaran/<?=$paket_evaluasi_harga_tawar->getField("PATH_FILE")?>" target="_blank"><span class="fa fa-download"></span>
                            </a>
                              <?php
                              if($kirimPenawaran == "1")
                              {}
                              ...
                              ?>
                               -
                              <a onClick="deleteData('dokumen_pengadaan_upload_rekanan/delete_dokumen/', '<?=$paket_evaluasi_harga_tawar->getField("PAKET_DOKUMEN_ID")?>')"><span class="fa fa-trash"></a>
                              <?php
                              }
                              $jumlahUploadHarga++;
                              ?>
             ...
             // {
              ?>
                ...
                ?>
                  <div class="alert alert-info">
                    <ul>
                      <li><font color="#FF0000">*</font> Rekanan wajib mengupload dokumen penawaran.</li>
                      <li>Untuk merubah dokumen penawaran, silahkan klik tombol <span class="fa fa-trash"> kemudian upload ulang file anda.</li>
                      <?php
