...
$(document).ready(function() {
  ...
  "bProcessing": true,
  "bServerSide": true,
  "sAjaxSource": "contracting_rekanan_json/jsonlegal",
  "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
  columnDefs: [{ className: 'never', targets: [ 0, 2, 3, 4 ] }]
  });
      ...
      <div class="card border-bottom-primary" style="zoom: 1;">
        <div class="card-header">
          ...
          <!-- <div class="heading-elements" id="tombol">
            <a href="kontrak/index/contracting_dashboard?tahun=<?php //$getTahun ?>" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a>
          </div> -->
        </div>
