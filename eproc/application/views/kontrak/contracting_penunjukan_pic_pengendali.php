...
<html lang="en">
  <head>
    ...
    $(function(){
      $('#ff').form({
        url:'contracting_json/tunjuk_pic_pengendali',
        onSubmit:function(){
    ...
    <div class="card-content">
      <div class="p-1">
        <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
          <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>PIC Pengendali</strong>
        </div>
        <div class="p-1">
          <?php
            ...
            <table class="table table-bordered table-hover p-1">
                <tbody>
                  <tr>
                    <td width="25%">PIC</td>
                    <td width="75%"> 
                        <input type="text" class="easyui-combobox" name="reqPIC" title="PIC harus diisi" data-options=" required: true, filter: function(q, row) { return row['text'].toLowerCase().indexOf(q.toLowerCase()) != -1; }, valueField: 'id', textField: 'text', url: 'contracting_json/pic_pengendali_combo_json/?unitkerja=<?=$this->UNIT_KERJA_ID?>'" value="<?= $reqPICPengendali ?>"  style="width:300px;"> 
                    </td>
                  </tr>
                  <tr>
                    <td width="25%">Nama Pengawas Unit Kerja</td>
                    <td width="75%"> 
                        <input type="text" class="form-control easyui-validatebox" name="reqNamaPengawasUnitKerja" title="Nama Pengawas Unit Kerja harus diisi" value="<?= $reqNamaPengawasUnitKerja ?>"  required> 
                    </td>
                  </tr>
                </tbody>
             </table> 
