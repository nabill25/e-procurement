...
$spkpks->selectViewPKSSPK(array("A.CONTRACTINGREKANANID" => $reqId, "A.REKANAN_ID" => $reqRekananId)); 
$spkpks->firstRow();
...
$proses5->selectProses5(array("A.CONTRACTINGREKANANID" => $reqId, "A.REKANAN_ID" => $reqRekananId)); 
$proses5->firstRow();
...
<html lang="en">
  <head>
    ...
    $(function(){
      $('#ff').form({
        url:'contracting_json/addBASTHasilMulti',
        onSubmit:function(){
