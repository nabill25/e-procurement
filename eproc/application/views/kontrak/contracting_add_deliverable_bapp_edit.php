  ...
  <head>
    ...
    $(function(){
      $('#ffAddDeliverable').form({
        url:'contracting_json/addDeliverableEditBAPP',
        onSubmit:function(){
      ...
      <div class="card-content">
        <div class="p-1">
          <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
            <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Upload BAPP</strong>
          </div>
          <div class="p-1" >
                  ...
                  <tbody id="tbodyDeliverable">
                    ...
                    <tr>
                      ...
                      <td> 
                        ...
                        <?= UPLOAD_PDF_ZIP_2MB ?>
                        <input type="hidden" name="reqLinkFileTemp" id="reqLinkFileTemp" value="<?= $datadelivery->getField('FILE_BAPP') ?>" />
                        <?php 
                        if (file_exists('uploads/kontrak/'.$datadelivery->getField('FILE_BAPP')) && $datadelivery->getField('FILE_BAPP') != '' ) {
                          echo '<br><a href="uploads/kontrak/'.$datadelivery->getField('FILE_BAPP').'" target="_blank" class="badge badge-primary"><span class="fa fa-download"> Download </span></a>';
                        } ?>
                      </td> 
                    </tr> 
                    <?php
