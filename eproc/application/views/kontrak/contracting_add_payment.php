...
<body class="body-popup"> 
                    ...
                    if($datapayment->countRow() > 0) { 
                      ...
                      <tr>
                        ...
                        <?php 
                         ...
                         <td>
                          <input type="text" class="form-control easyui-validatebox" required name="payketerangan[]" id="<?=$no?>" value="<?= $datapayment->getField('PAY_KETERANGAN') ?>">
                         </td>  
                         <td>
    ...
    function hitungTotal() {
        ...
        if (total > HPS) {
          ...
          document.getElementById('totalNilai').value = formatRupiah(total);
          $('#btnSimpan').hide();
        } else {
          document.getElementById('totalNilai').value = formatRupiah(total);
          $('#notifHPS').html("");
