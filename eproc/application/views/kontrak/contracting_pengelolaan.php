...
if ($this->LEVEL_KONTRAK == '3' && $this->USER_TYPE_ID != '20') { // Khusus Pengendali
...
$(document).ready(function() {
  ...
  "bProcessing": true,
  "bServerSide": true,    
  "sAjaxSource": "contracting_rekanan_json/jsonPengendalian?reqProses=3",  
  ...
  $("#example tbody").click(function(event) {
      ...
      anSelectedPICPengendali = element[11]; // PIC Pengendali
  }); 
          ...
          <div class="form-body"> 
            <div class="row">
              <div class="form-group col-md-12 mb-2">
                ...
                <?php 
                if ($this->PENUNJUK_PIC == '1' && $this->LEVEL_KONTRAK == '2') {  ?>
