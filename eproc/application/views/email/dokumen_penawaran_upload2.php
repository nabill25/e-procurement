	            ...
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <p>
	                <table style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:12px;margin-bottom:0;color:#5F5F5F; border-collapse:collapse; width:100%;">
                      <tr>
                        <td bgcolor="#023047" align="center" style="color:#FFF; border:1px solid #000; padding:10px 8px; text-transform:uppercase;" colspan="4"><b>DOKUMEN FILE 1</b></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td bgcolor="#8ecae6" style="padding:4px 8px; border:1px solid #000; color: #000; text-transform:uppercase" colspan="4">I. Dokumen Administrasi</td>
                      </tr>
                        <?php
                        $i=1;
                        ...
                        ?>
                      <tr>
                          <td bgcolor="#8ecae6" style="padding:4px 8px; border:1px solid #000; color:#000; text-transform:uppercase" colspan="4">II. Dokumen Teknis</td>
                      </tr>
                        <?php
                        $i=1;
                        ...
                        ?>
  					  <tr>
                        <td bgcolor="#023047" align="center" style="color:#FFF; border:1px solid #000; padding:10px 8px; text-transform:uppercase;" colspan="4"><b>DOKUMEN FILE 2</b></td>
                      </tr>
                      <tr>
                        <td bgcolor="#219ebc" align="center" style="color:#FFF; border:1px solid #000; padding:4px 8px; text-transform:uppercase;">No.</td>
                        <td bgcolor="#219ebc" align="center" style="color:#FFF; border:1px solid #000; padding:4px 8px; text-transform:uppercase; width:40%">Nama Dokumen</td>
                        <td bgcolor="#219ebc" align="center" style="color:#FFF; border:1px solid #000; padding:4px 8px; text-transform:uppercase;">Nama File</td>
                        <td bgcolor="#219ebc" align="center" style="color:#FFF; border:1px solid #000; padding:4px 8px; text-transform:uppercase;">Ukuran File</td>
                      </tr>
                      <tr>
                          <td bgcolor="#8ecae6" style="padding:4px 8px; border:1px solid #000; color: #000; text-transform:uppercase" colspan="4">I. Dokumen Harga</td>
                      </tr>
                        <?php
                        $i=1;
