	        ...
	        <tbody>
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <h1 style="font-size: 20px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000; margin-bottom: 10%;">Notifikasi Pembuktian</h1> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                ...
	                Selamat, Perusahaan <?php // $paket_rekanan->getField("NAMA")?> diundang untuk mengikuti klarifikasi teknis dan negosiasi pekerjaan "<?php //$paketInfo->nama?> " melalui sistem e-Procurement <?php // SYSTEM_NAME_PT ?><br/>
	            	Jadwal pelaksanaan sebagai berikut :</a> -->

	            	Yang Terhormat <?=$paket_rekanan->getField("NAMA")?>,<br><br>
	            	Menunjuk paket pengadaan "<?= $paketInfo->nama?>", kami bermaksud mengundang Saudara untuk Pembuktian dokumen. Adapun dokumen yang dibawa adalah seluruh dokumen asli yang telah saudara upload, pada: <br>
	              </p> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	              Selanjutnya diminta Sudara terlebih dahulu melakukan konfirmasi untuk kami susun jadwal Pembuktian. Untuk lebih jelasnya dapat menghubungi <?= SYSTEM_EMAIL ?>.<br>
          	  ...
          	  <tr>
						      <td style="padding:4px 8px; width:20%">Tanggal</td>
						      <td style="padding:4px 8px; width:1%">:</td>
						      <td style="padding:4px 8px;"><?php // datetimeToPage($metode->getField("TANGGAL_AWAL"), "date")?> s/d <?php //datetimeToPage($metode->getField("TANGGAL_AKHIR"), "date")?></td>
						  </tr> -->
						  <?php
						  // if($metode->getField("JAM_AWAL") == "")
						  // {}
						  ...
						  ?>
						  <!-- <tr>
						      <td style="padding:4px 8px;">Waktu</td>
						      <td style="padding:4px 8px; width:1%">:</td>
						      <td style="padding:4px 8px;">Silahkan hubungi Pelaksana Pengadaan PAM JAYA</td>
						  </tr> -->
						  <?php
						  // }
						  ?>
	              ...
	              <!-- <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	               Berdasarkan Jadwal di atas penyedia barang jasa harap login melalui aplikasi <a href="<?php // base_url()?>" target="_blank">e-Procurement - <?php // SYSTEM_NAME_PT ?></a> pilih detil paket pekerjaan "<?php //$paketInfo->nama?>" kemudian klik menu Klarifikasi Teknis & Negosiasi. 
	               </p> -->
