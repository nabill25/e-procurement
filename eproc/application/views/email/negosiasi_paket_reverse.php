	        ...
	        <tbody>
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <h1 style="font-size: 20px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000; margin-bottom: 10%;">Notifikasi Klarifikasi</h1> 
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	            	...
	            	Menunjuk paket pengadaan "<?= $paketInfo->nama?>", kami bermaksud mengundang Saudara untuk Klarifikasi dokumen. Adapun dokumen yang dibawa adalah seluruh dokumen asli yang telah saudara upload. <br><br>
	               
	              Selanjutnya diminta Sudara terlebih dahulu melakukan konfirmasi untuk kami susun jadwal Klarifikasi. Untuk lebih jelasnya dapat menghubungi <?= SYSTEM_EMAIL ?>.<br>
	              ...
	              <p>
	                <!-- <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; " width="100%">
	                	  <tr>
						      ...
						      <td style="padding:4px 8px;"><?php // datetimeToPage($metode->getField("TANGGAL_AWAL"), "date")?></td>
						  </tr> -->
						  <?php
						  ...
						  <!-- <tr>
						      ...
						      <td style="padding:4px 8px; width:1%">:</td>
						      <td style="padding:4px 8px;"><?php // $metode->getField("JAM_AWAL")?> sampai dengan selesai</td>
						  </tr> -->
						  <?php
						  // }
						  ?>
