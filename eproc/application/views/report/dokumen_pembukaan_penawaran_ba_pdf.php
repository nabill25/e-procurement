...
/* LOGIN CHECK */
if($this->USER_LOGIN_ID == "" || $this->USER_TYPE_ID != '3' && $this->USER_TYPE_ID != '10' && $this->USER_TYPE_ID != '11') {
...
if($reqSistemSampul == "2")
	...
	$link_report = "dokumen_pembukaan_penawaran_ba";
...
$html .= file_get_contents(SYSTEM_URL_EMAIL."/main/loadUrl/report/".$link_report."?reqId=".$reqId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));//".$link_report."?reqId=".$reqId);						
