...
// echo $reqMetodeLelang; die();
$paket_rekanan = new PaketRekanan();

$jenis_tahap = $paket_tahap_metode->getJenisTahapById($reqId);

$arrDokumenPenawaran            = DOKUMEN_PENAWARAN; // ikn
$paket_tahap->selectByParamsTahapan(array("A.URUT" => $arrDokumenPenawaran[$jenis_tahap], "A.PAKET_ID" => $reqId, "A.TAMPILKAN" => 1, "A.HADIR" => 0));
$paket_tahap->firstRow();
$tanggal_akhir = $paket_tahap->getField('TANGGAL_AKHIR');
...
?>        
    <div class="area-dokumen">
                ...
                <table class="table">
                <tr class="tr">
                    <td colspan="5" class="padding5"><?=$no_urut?>. <?=$paket_rekanan->getField("FULL_NAMA_REKANAN")?></td>
                </tr>
                <?php
				...
				?>
                <tr class="tr-bc">
                  <td align="center" class="td" colspan="5">FILE 1 <?php if($paketInfo->bahasa == "EN") echo "/ <em>COVER 1</em>"; ?></td>
                </tr>                
                <?php
				}
				?>
          ...
          if ($reqMetodeLelang == '7') {
                ...
                <tr class="tr">
                    <!-- <td class="padding5" style="text-align: center">I</td> -->
                    <td class="padding5" colspan="5">Dokumen Administrasi <?php if($paketInfo->bahasa == "EN") echo "/ <em>Administrative Documents</em>"; ?></td>
                      ...
                      ?>
                <tr class="tr">
                    <!-- /*<td class="padding5" style="text-align: center">II</td>*/ -->
                ...
                if($reqSistemSampul == "2")
        				...
        				?>
                <tr class="tr-bc">
                  <td align="center" colspan="5" class="td">FILE 2 <?php if($paketInfo->bahasa == "EN") echo "/ <em>COVER 2</em>"; ?></td>
                </tr>   
                <tr class="sub-judul1">
                  <td class="tdno" align="center">No&nbsp; <?php if($paketInfo->bahasa == "EN") echo "/ <em>Number</em>"; ?></td>
                  <td class="td" align="center" style="width:40%">Nama Dokumen <?php if($paketInfo->bahasa == "EN") echo "/ <em>Documents Name</em>"; ?></td>
                  <td class="td font10" align="center">Nama File <?php if($paketInfo->bahasa == "EN") echo "/ <em>File Name</em>"; ?></td>
                  <td class="td font10" align="center">Ukuran <?php if($paketInfo->bahasa == "EN") echo "/ <em>File Size</em>"; ?></td>
                  <td class="td font10" align="center">Tgl Upload <?php if($paketInfo->bahasa == "EN") echo "/ <em>Upload Date</em>"; ?></td>
                </tr>             
                <?php 
				        $rowawi = "I";
        				}
        ...
        <?php 
                ...
                <tr class="tr">
                    <!-- <td class="padding5" style="text-align: center"><?=$romawi?></td> -->
                    <td class="padding5" colspan="5">Dokumen Harga <?php if($paketInfo->bahasa == "EN") echo "/ <em>Pricing Document</em>"; ?></td>
                </tr>
                      <?php
                      $i=1;
