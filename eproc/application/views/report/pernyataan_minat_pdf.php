...
$html = file_get_contents(base_url()."cetak/loadUrl/report/pernyataan_minat_excel/?reqId=".$reqId."&reqRekananId=".$reqRekananId."&reqPaketRekananId=".$reqPaketRekananId, false, stream_context_create($arrContextOptions));
