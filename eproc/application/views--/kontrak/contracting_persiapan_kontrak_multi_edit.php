...
$getProses = $this->input->get("getProses") ?: $this->session->userdata('setProsesKontrak'); 
...
$proses4->selectProses4(array("A.CONTRACTINGREKANANID" => $reqConRekId));  
$proses4->firstRow();
...
$(document).ready(function() {
  ...
  $('#reqPelaksanaanDari, #reqPelaksanaanSampai, #reqLegalTanggal').datebox({
    editable: false
  });
        ...
        <div class="card-body">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data"> 
            ...
            <div class="row">
              ...
              <div class="form-group col-md-12 mb-2">
                <label>Nilai Kontrak Maksimal</label>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3 mb-2">
                ...
                <input type="text" name="reqJenisPengadaan" class="easyui-combobox span4" data-options="valueField:'id',textField:'text',url:'contracting_json/comboJenisPengadaan'"  value="<?=$reqJenisPengadaan?>" style="width: 300% !important" required/>
              </div>  
              <div class="form-group col-md-3 mb-2">
            ...
            <div class="form-actions">
              ...
              ?>
              <a href="kontrak/index/<?= $back ?>?reqId=<?=$reqConRekId?>&reqProses=<?= $getProses ?>" class="<?= CLASS_BTN_DANGER ?> mr-1 text-white"> <i class="fa fa-arrow-left"></i>  Kembali </a> 
              <?php 
              } else 
              { // tidak ada perubahan ?>
              <a href="kontrak/index/contracting_persiapan_kontrak_payung?reqId=<?=$reqConRekId?>" class="<?= CLASS_BTN_DANGER ?> mr-1"> <?= BTN_KEMBALI ?> </a> 
              <?php 
              } ?>
