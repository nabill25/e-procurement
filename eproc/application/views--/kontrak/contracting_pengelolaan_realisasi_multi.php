                          ...
                          <table id="deliveriable" class="border-double table mb-0 table-bordered mb-2 table-responsive" style="width:100%">
                            ...
                            if ($datasuratpesanan->countRow() > 0) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <a onclick="openAdd('main/loadUrlKontrak/kontrak/contracting_update_surat_pesanan_material?reqSuratPesananId=<?= $datasuratpesanan->getField('SURATPESANANID')?>')"> <i class="fa fa-pencil"></i></a>
                                </td>
                              </tr>
                              <?php
                              $no++;
