      ...
      ?>
          ...
          <div class="form-actions">
            ...
            <div class="table-responsive">
              <table id="addendum" class="border-double table mb-0 table-bordered mb-2" style="width: 100%">
                ...
                $addendum->selectByParams(array("CONTRACTINGREKANANID"=>$reqId, "APPROVED_KASUBDIT" => "1"),-1,-1);
                if ($addendum->countRow() > 0) {
                  ...
                  <tr>
                      ...
                      <?php 
                        if ($this->USER_TYPE_ID == '6') { // PENYEDIA
                          if ($addendum->getField('APPROVED_PENYEDIA') == '1') {
                            // echo '<a onClick="approvalAddendum(\'contracting_json/approvalAddendumPenyedia/\', '.$addendum->getField("CONTRACTING_ADDENDUM_ID").',\'0\')" class="fa fa-check btn-xs btn-primary" style="padding:5px; border-radius:4px; color:#fff"></a>';
                            echo '<span class="fa fa-check btn-xs btn-primary" style="padding:5px; border-radius:4px; color:#fff"> <small>Disetujui</small></span>';
                          } else {
                            if ($addendum->getField('NOMOR')) {
                              if ($addendum->getField('ADDENDUM_FILE_PENYEDIA')) {
                                echo '<span class="fa fa-check btn-xs btn-primary" style="padding:5px; border-radius:4px; color:#fff"> <small>Disetujui</small></span>';
                                // echo '<a onClick="approvalAddendum(\'contracting_json/approvalAddendumPenyedia/\', '.$addendum->getField("CONTRACTING_ADDENDUM_ID").',\'1\')" class="btn-xs btn-danger" style="padding:5px; border-radius:4px; color:#fff"><small class="blinking-element">Setujui?</small></a>';
                              } else {
                                echo '<a onClick="openAddFrame(\'main/loadUrlKontrak/kontrak/contracting_add_addendum_file_penyedia?reqAidi='.$addendum->getField('CONTRACTING_ADDENDUM_ID').'&reqConRekId='.$addendum->getField('CONTRACTINGREKANANID').'\')" class="btn-xs btn-danger" style="padding:5px; border-radius:4px; color:#fff"><small class="blinking-element">Upload&nbsp;Dok.&nbsp;Addendum&nbsp;(TTD)?</small></a>';
                              }
                            } 
                          }
                        } else {
                          if ($addendum->getField('APPROVED_PENYEDIA') == '1') {
                            ...
                            echo '<span class="fa fa-times btn-xs btn-danger" style="padding:5px; border-radius:4px; color:#fff"></span>';
                          }
                        }
                        ?>
                    </td> 
                    <td>
                      <?php 
                      if($addendum->getField('NOMOR')) {
                        echo $addendum->getField('NOMOR');
                      } else {
                        echo '<span class="btn-xs btn-danger" style="padding:5px; border-radius:4px; color:#fff"><small>Sedang&nbsp;Proses</small></span>';
                      }
                      ?>  
                    </td>
                    ...
                    <td class="text-center"><?= getFormattedDateShort2(dateTimeToPageCheck($addendum->getField('TANGGAL_KONTRAK_DARI'))) ?> <br>sd<br> <?= getFormattedDateShort2(dateTimeToPageCheck($addendum->getField('TANGGAL_KONTRAK_SAMPAI'))) ?></td> 
                    <td class="text-center"><?= getFormattedDateShort2(dateTimeToPageCheck($addendum->getField('TANGGAL_PENYELESAIAN_KONTRAK_AWAL'))) ?> <br>sd<br> <?= getFormattedDateShort2(dateTimeToPageCheck($addendum->getField('TANGGAL_PENYELESAIAN_KONTRAK_AKHIR'))) ?></td> 
                  </tr>
                  <?php
                  }
                ...
                if ($datadelivery->countRow() > 0) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      Laporan Selesai: <?= $datadelivery->getField('TANGGAL_TERIMA') ? getFormattedDateShort($datadelivery->getField('TANGGAL_TERIMA')) : '-'; ?></small></td>
                    <td>
                      <?php 
            ...
            <div class="table-responsive mb-2">
              <table id="tabletermin" class="border-double table mb-0 table-bordered mb-2" style="width: 100%">
                <tr class="backcolornew">
                  ...
                  <?php
                  // } ?>
                  <th width="150px" class="text-center">Tanggal <br>Selesai Administrasi</th>
                ...
                if ($datapayment->countRow() > 0) {
                  ...
                  <tr>
                    ...
                    <td class="text-center"><?= getFormattedDateShort($datapayment->getField('PAY_DATE_DARI')).'<br> sd <br> '.getFormattedDateShort($datapayment->getField('PAY_DATE_SAMPAI')) ?></td>
                    <?php
                    // } ?>
            ...
            <!-- <div class="card mb-1 border-blue border-darken-1">
              <div class="card-content">
                ...
                <small style="font-size:0.9em">
                  <a onclick="openAdd('main/loadUrlKontrak/kontrak/contracting_file_add?reqAidi=<?= $reqId ?>&reqProses=4&reqJenis=Perubahan Kontrak&reqType=penyedia')" class="badge badge-primary pull-right mr-1 text-white"> <i class="fa fa-plus-circle"></i> Tambah Dokumen </a>
                </small>
                <?php 
                // } ?>
                </h5>
                  <div class="table-responsive">
                    <table id="dokumenFileIdTable" class="border-double table mb-0 table-bordered mb-2" style="width: 100%">
                      <?php // echo  $this->libkontrak->getTableFilePenyedia($reqId," AND A.FILE_JENIS = 'Perubahan Kontrak' AND FILE_PUBLISH_PENYEDIA = '1'") ?>
                    </table>
                  </div>
                </div>
              </div>
