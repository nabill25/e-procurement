...
<html lang="en">
  <head>
    ...
    $(function(){
      $('#ff').form({
        url:'contracting_json/addBerakhirKontrak',
        onSubmit:function(){
  ...
  <div class="card-content">
    <div class="p-1">
      <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
        <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong>Berakhir Kontrak </strong>
      </div> 
      <div class="p-1">
        <form id="ff" class="form-horizontal" role="form" method="post" novalidate >
          <div class="row">
            <div class="form-group col-md-12 mb-2">
              <label>Alasan Berakhir <sup>Tuliskan dengan detail disini</sup></label>
