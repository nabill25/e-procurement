  ...
  <head>
    ...
    $(function(){
      $('#ffAddDeliverable').form({
        url:'contracting_json/addPayment2',
        onSubmit:function(){
    ...
    function createRowPayment()
    {
     ...
     $(document).ready(function() {
      $('#reqPayDateDari, #reqPayDateSampai').datebox({
        editable: false
      }); 
    }); 
            ...
            <form id="ffAddDeliverable" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="padding:0 50px">
              <div class="table-responsive">
                <?php if ($reqMetodePembayaran == '2') { ?>
                 <a onclick="createRowPayment()" class="<?= CLASS_BTN_PRIMARY ?> mb-1" style="color:#fff"> <span class="fa fa-plus text-white font-medium-2 icon-line-height" data-toggle="tooltip" data-placement="top" title=""></span> Tambah</a> 
                <?php } ?>
