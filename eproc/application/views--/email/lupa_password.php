	          ...
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                ...
	                Anda telah melakukan permintaan perubahaan password pada sistem <a href="<?= SYSTEM_NAME_URL ?>"> e-Procurement - <?= SYSTEM_NAME_PT ?></a> dengan data sebagai berikut
	              </p>
	              ...
	              <p>
	                <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; " width="100%">
			            <tr>
							    ...
							    <tr>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">Nama Perusahaan</td>
							      <td style="padding:4px 8px; border:1px solid #f4f4f4;">: <?=$rekanan->getField("NAMA")?></td>
					        </tr>
	                </table>
	              </p>
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	               Silahkan klik <a href="<?=base_url()?>main/index/reset_password/?reqId=<?=md5($reqId."IKUN")?>&reqValidasi=<?=md5(date("dmY"))?>" target="_blank">disini</a> untuk merubah password.
