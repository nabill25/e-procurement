	        ...
	        <tbody>
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
	              ...
	              <!-- <h1 style="font-size: 20px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Single column, dolor sit amet</h1> -->
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                ...
	                Anda memiliki dokumen legalitas yang sudah melewati tanggal berlaku pada sistem <a href="<?= SYSTEM_NAME_URL ?>"> e-Procurement - <?= SYSTEM_NAME_PT ?></a>
	              </p>   

	              <p>
	                <table style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                  ...
	                  <tr>
	                    ...
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;"><?=$rekanan->getField("NAMA")?></td>
	                    </tr> 
	                  <tr>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;">E-mail terdaftar</td>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;">:</td>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;"><?=$rekanan->getField("EMAIL")?></td>
	                    </tr>
	                  <tr>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;">Username</td>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;">:</td>
	                    <td bgcolor="#FFF" style="padding:4px 8px; border:none;"><?=$user_login->getField("USER_LOGIN")?></td>
	                    </tr>
	              ...
	              <p style="text-align: left; font-size: 12px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; ">
	                Silahkan login ke <a href="<?= SYSTEM_NAME_URL ?>"> e-Procurement - <?= SYSTEM_NAME_PT ?></a> dan update dokumen
	              </p>
	          ...
	          <tr>
	            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;" width="596"> 
	              <p style="font-size: 11px; line-height: 18px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 200; text-decoration: none; color: #ffffff;">
	                Administrator e-Procurement<br />
	                <?= SYSTEM_NAME_PT ?> <?=$user_login->getField("UNIT_KERJA")?>
	              </p> 
	            </td>
	          </tr>
	        </tbody>
