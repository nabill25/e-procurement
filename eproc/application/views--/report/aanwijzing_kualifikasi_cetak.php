...
$arrTahapan                  = AANWIJZING_KUALIFIKASI;
...
$paket_aanwijzing_rekanan->selectByParamsPeserta(array("A.PAKET_ID" => $reqId, 'A.PARENT_ID' => 0),'GROUP BY A.REKANAN_KODE');
$i=0;
...
<div class="isi">
  ...
  Rapat aanwijzing dilaksanakan secara online melalui website <?= SYSTEM_EMAIL ?> dengan risalah penjelasan terlampir.
  <div style="height:7px;"></div>
         ...
         <div class="area-dokumen"> 
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="td"><?= $paket_rekanan->getField("KODE_CUT"); ?> <?php //$arrRekanan[$i]["NAMA"]?></td>
                   <!--  <td style="text-align:center"> -->
                        <?php
                        /*
                                $mcrypt = new AES();
								$encrypt_text = "QR CODE VALID UNTUK DOKUMEN NOMOR ".$nomor." (".$arrRekanan[$i]["NAMA"].")";//$paket_pembukaan_validasi->getField("NIP");
			        			$filename = $PNG_TEMP_DIR.$reqId.$arrRekanan[$i]["NAMA"].'.png';

                                //$encrypt_text = $arrRekanan[$i]["QRCODE"];
