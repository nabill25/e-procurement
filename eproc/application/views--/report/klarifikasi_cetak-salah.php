...
$metode = new Metode();
$metode->selectByParams(array("UPPER(A.NAMA)" => "NEGOSIASI"), -1, -1, $reqId);
$metode->firstRow();
            ...
            <table class="table">
                ...
                while($rekanan_paket_penawaran_lampiran->nextRow())
                {
                    ...
                    <tr>
                      ...
                      $php_shoutbox->selectByParams(array("PAKET_PENAWARAN_ID" => $rekanan_paket_penawaran_lampiran->getField("PAKET_PENAWARAN_ID")));
                      $pesan = "";
