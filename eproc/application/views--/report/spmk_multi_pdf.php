...
$html .= file_get_contents(base_url()."main/loadUrl/report/spmk_multi?reqId=".$reqId."&reqRekananId=".$reqRekananId."&unitkerjaid=".$unitkerjaid, false, stream_context_create($arrContextOptions));
