...
//$arrUploadPasswordPenawaran	 = array(0, 12, 7,  12, 7,  11, 7,  12, 12);
...
$html .= file_get_contents(base_url()."main/loadUrl/report/dokumen_penawaran_ba_rekanan?reqId=".$reqId."&rekananid=".$this->REKANAN_ID, false, stream_context_create($arrContextOptions));						
...
$mpdf->Output('dokumen_penawaran_ba.pdf','I');
exit;
//==============================================================
//==============================================================
//==============================================================
