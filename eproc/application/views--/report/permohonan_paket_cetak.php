...
if($reqMode == "fungsional")
{
	...
	elseif($reqStatus == '1')
		$statement .= " AND A.PAKET_ID IS NULL AND A.POSTING IS NOT NULL ";
	elseif($reqStatus == '2')
		$statement .= " AND A.PAKET_ID IS NOT NULL AND A.POSTING IS NOT NULL ";
}
elseif($reqMode == "exec")
{
...
elseif($reqMode == "panitia")
{
	...
	if($reqStatus == '')
		...
		$statement .= " AND PIC = '".$this->USER_LOGIN_ID."'";
}

	$permohonan_paket = new PermohonanPaket();
	// $permohonan_paket->selectByParams($arrStatement, $dsplyRange, $dsplyStart, $statement);
    ...
    <div class="kop-laporan">
        ...
        <div class="data-laporan">
              ...
              <thead>
                   <tr>
                   		<th width="90px">No.</th>
                        <th width="90px">No. RUP</th>
                        <th width="90px">No. PR</th>
                        ...
                        <th width="90px">Harga Perkiraan</th>
				...
				while($permohonan_paket->nextRow())
				{
		             ...
		             ?>
		             	<tr>
		                  ...
		                  <td align="center"><?=$permohonan_paket->getField("KODE_RUP")?></td>
		                  <td align="center"><?=$permohonan_paket->getField("KODE_PR")?></td>
		                  ...
		                  <td align="center"><?=$permohonan_paket->getField("PIC_NAMA")?></td>
		              </tr>
							<?php
							...
							<!-- <thead>
								...
								<!-- <tbody>
									<tr>
										<td align="center"></td>
										<td align="center"><?php // $permohonan_paket_coa->getField("NOMOR") ?></td>
										<td align="center"><?php // $permohonan_paket_coa->getField("KETERANGAN") ?></td>
										<td align="center"><?php // numberToIna($permohonan_paket_coa->getField("BUDGET_AWAL")) ?></td>
										<td align="center"><?php // numberToIna($permohonan_paket_coa->getField("BUDGET_TERPAKAI")) ?></td>
										<td align="center"><?php // numberToIna($permohonan_paket_coa->getField("BUDGET_AKHIR")) ?></td>
								 </tr>
								</tbody> -->
