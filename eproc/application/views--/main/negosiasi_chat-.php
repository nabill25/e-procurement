...
<link rel="stylesheet" href="<?=base_url()?>css/core-bootstrap.css" type="text/css">

<link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700' rel='stylesheet' type='text/css'>
<link href="<?=base_url()?>assets/css/bootplus.css" rel="stylesheet">
<link href="<?=base_url()?>assets/css/bootplus-responsive.css" rel="stylesheet">
...
<!-- Bootstrap Core CSS -->
<?php /*?><link href="lib/startbootstrap-sb-admin-2-1.0.7/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet"><?php */?>
  ...
  <div class="card-content">
    <div class="p-1">
      <!-- <div class="alert alert-info mb-2" role="alert">
        <strong><?=$paket_negoisasi->getField("ITEM")?></strong>
      </div>  -->
      <div class="p-1">
