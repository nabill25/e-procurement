...
$paket_dokumen->selectByParams(array("PAKET_ID" => $reqId, "JENIS_DOKUMEN" => "SANGGAH_KUALIFIKASI", "paket_dokumen_id" => $reqParent, "PARENT_ID" => 0 ));
?>
...
$(document).ready(function() {
	...
	$(function(){
		$('#ff').form({
			url:'paket_sanggah_json/dokumen_sanggah_kualifikasi_tanggapan',
			onSubmit:function(){
        ...
        hideLoad();
				...
				document.location.href = 'main/index/paket_lelang_masa_sanggah_kualifikasi_tanggapan/?reqId=<?=$reqId?>&reqParent=<?=$reqParent?>';
			}
		});
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Jawab Sanggah Kualifikasi
        </h4>
        ...
        <div class="card-body area-datatable">
              ...
              <tbody>
                ...
                <?php
                  ...
                  while($paket_dokumen->nextRow())
                  {
                    ...
                    $paket_dokumen_parent->selectByParams(array("PAKET_ID" => $reqId, "JENIS_DOKUMEN" => "SANGGAH_KUALIFIKASI", "PARENT_ID" => $reqParent ));
                ?>
                <tr >
                    <td><?=$i?>.</td>
          ...
          <div class="card mb-1 border-blue border-darken-1" style="padding:10px">
            ...
            <form id="ff" class="easyui-form " method="post" novalidate enctype="multipart/form-data">
                <div class="alert alert-info">Jawab Sanggah Kualifikasi</div>
                ...
                <div class="form-actions">
                  ...
                  <a href="main/index/paket_lelang_masa_sanggah_kualifikasi/?reqId=<?=$reqId?>" class="<?= CLASS_BTN_DANGER ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
