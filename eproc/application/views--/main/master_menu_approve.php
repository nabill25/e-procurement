...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,		
		"sAjaxSource": "menu_json/json",	
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],	
		columnDefs: [{ className: 'never', targets: [ 0 ]},{className: 'text-center', targets: [ 4 ]  }]
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_menu_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAddFrame("main/loadUrl/main/master_menu_add/?reqId="+anSelectedId);
			  $('div.flexmenumobile').hide()
			  $('div.flexoverlay').css('display', 'none')
		  }); 
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteData("menu_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("menu_json/json");	
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Group & Role</h4>
      ...
      <div class="card-content collapse show border-info border-darken-2">
        <div class="card-body area-datatable">
        	<div class="row" id="sticker">
	            ...
	            <a id="btnEdit" title="Ubah" class="btn round btn-min-width box-shadow-1 btn-info text-white"><span class="fa fa-pencil"></span> Ubah Status</a> 
