        ...
        <div class="p-1">
         ...
         <form id="ff" method="post" class="form-horizontal" role="form">
            <table class="table table-bordered table-hover p-1">
                <tbody>
                  <tr>
                    <td width="25%">Strategi Pengadaan</td>
                    <td width="75%">
                      <div class="row">
                  ...
                  <tr>
                    ...
                    <td width="75%">
                      <div id="panitiaSourching">
                        <input type="text" class="easyui-combobox" name="reqPIC" id="reqNama<?=$no?>" title="Nama harus diisi" data-options=" required: true, filter: function(q, row) { return row['text'].toLowerCase().indexOf(q.toLowerCase()) != -1; }, valueField: 'id', textField: 'text', url: 'panitia_json/panitia_combo_json_penyelia/?unitkerja=<?=$this->UNIT_KERJA_ID?>'" value=""  style="width:300px;">
                      </div>
                    </td>
                  </tr>
                </tbody>
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="<?= CLASS_BTN_PRIMARY ?>"><i class="fa fa-check-square-o"></i> Teruskan</button>
            </div>
