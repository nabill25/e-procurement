...
if ($jenis == 'all') {
  $paket = new Paket();
  $paket->getDashboardDetailPaket2($metodeConvert,$tahun,$bulan,$unitkerja);
  $paketmetodelelang->selectByParams(array('PAKET_METODE_LELANG_ID' => $metodeConvert),-1,-1);
  $paketmetodelelang->firstRow();
  $metodeName = $paketmetodelelang->getField("NAMA");
} else
{
  $paket = new Paketpanitiadash();
  $paket->getDashboardDetailPaket2($metodeConvert,$tahun,$bulan,$user_login_id);
  $paketmetodelelang->selectByParams(array('PAKET_METODE_LELANG_ID' => $metodeConvert),-1,-1);
  $paketmetodelelang->firstRow();
  $metodeName = $paketmetodelelang->getField("NAMA");
}
  ...
  <div class="card-content">
    <div class="p-1">
      <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
        <span class="alert-icon"><i class="fa fa-th"></i></span>  <strong> <?=$metodeName?>  </strong>  <small><?= $bulan .'-'.$tahun?></small>
      </div>
      <div class="p-1">
