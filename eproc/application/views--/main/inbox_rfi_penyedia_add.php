...
$dataInbox    = new Inbox();
$arrStatement = array("A.INBOXID" => $id, "A.PARENT" => 0, "A.INBOXCATEGORYID" => '1', "A.PENERIMA" => $this->REKANAN_ID);
...
$inbox_subject = 'Reply - '.$dataInbox->getField("INBOX_SUBJECT");
...
function backP() {
	window.location.href = "main/index/inbox_rfi_penyedia";
}
		...
		$('#ff').form({
	      ...
	      success:function(data){
	        // $.messager.alert('Info', data, 'info');
	          ...
	          alertSuccess2(data);
	          setTimeout(function () {
	            window.location.href = '<?= base_url('main/index/inbox_rfi_penyedia') ?>';
	          }, 1000);
	        hideLoad();
	      }
	    });
