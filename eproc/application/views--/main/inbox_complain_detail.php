                ...
                <div id="accordionWrap5" role="tablist" aria-multiselectable="true">
                  <div class="card collapse-icon accordion-icon-rotate">
                    ...
                    <div id="accordion51" role="tabpanel" aria-labelledby="heading51" class="card-collapse collapse show" aria-expanded="true">
                      <div class="card-content">
                        <div class="card-body">
                          ...
                          ?>
                          <hr>
                          <a href="main/index/inbox_complain_add?id=<?=$inboxid?>" class="<?= CLASS_BTN_PRIMARY ?> icon-action-undo iconsize pull-left" target="_blank"> Reply</a><br><br>
                          <?php 
                          } ?>
                        </div>
                      </div>
                    ...
                    // if ($this->USER_TYPE_ID == '2') { // Administrator VMS
                      $dataInboxReplay->selectByPenerima(array("A.PARENT" => $inboxid, "A.INBOXCATEGORYID" => '3'), -1, -1); // 1:RFI 2:Survey 3:Complain
                    // } else {
                      // $dataInboxReplay->selectByPenerima(array("A.PARENT" => $inboxid, "A.INBOXCATEGORYID" => '3', "A.CREATED_BY" => $this->REKANAN_ID), -1, -1); // 1:RFI 2:Survey 3:Complain
                    // }
