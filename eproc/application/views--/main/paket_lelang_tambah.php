...
<?php
if ($reqPL != '2' || $reqMetodePengadaan == '2')  // selain 2 (Pembelian Langsung) KBLI wajib di isi
{ ?>
      ...
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">
          ...
          { echo 'Tambah Pengadaan'; } else { 
            ...
            echo '<a class="'.CLASS_BTN_WARNING.' ml-1" onclick="openAddLg(\'main/loadUrl/main/rekam_jejak_kaji_ulang_view/?id='.$reqPermohonanId.'\')"> Rekam Kaji Ulang</a>'; 
          } ?>
        ...
        <div class="card-body">
          <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-2 mb-2" style="<?php if($reqMetodePengadaan == '2') {}else { ?>display:none <?php } ?>" id="displaySistemNegosiasi">
                ...
                <select name="reqBidding" class="easyui-combobox span2" data-options="
                                        ...
                                        }" style="width: 200%" <?php if ($reqPublishPaket == '1') { echo "readonly"; } ?>>
                <option value="0" <?php if($reqBidding == "0") { ?> selected <?php } ?>>Negosiasi</option>
              ...
              <div class="form-group col-md-3 mb-2" style="<?php if($reqMetodePengadaan == '2') {}else { ?>display:none <?php } ?>" id="displayKualifikasiUsaha">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-2 mb-2" id="reqMultiPemenang" <?php if ($reqBidding == '0') {} else { ?> style="display:none" <?php } ?>>
            ...
            <?php
            if ($reqPL != '2' || $reqMetodePengadaan == '2')
            { // Bukan Pembelian Langsung / Purchasing
            ?>
            <div class="row">
              <div class="form-group col-md-12 mb-2">
            ...
            <?php
            // echo $reqPL.'--';
            if ($reqPL != '2' || $reqMetodePengadaan == '2') { // Bukan Pembelian Langsung / Purchasing
            ?>
              ...
              <div class="card-content">
                ...
                <div class="p-1">
                  ...
                  <div class="table-responsive">
                    <div class="form-group col-md-12 mb-2" id="reqMultiBidangUsaha">
                      <input type="radio" name="reqMultiBidangUsaha" title="Keseluruhan terpenuhi" value="1" id=""  <?php if($reqMultiBidangUsaha == "1") { ?> checked="checked" <?php } ?> /> Keseluruhan terpenuhi &nbsp; <!-- AND -->
                      <input type="radio" name="reqMultiBidangUsaha" title="Salah satu terpenuhi" value="0" id=""  <?php if($reqMultiBidangUsaha == "0" || $reqMultiBidangUsaha == "") { ?> checked="checked" <?php } ?> /> Salah satu terpenuhi <!-- OR -->
                  </div>
                    <table class="table table-bordered mb-0">
                      <tbody id="tbodyBidangUsaha">
                        ...
                        if ($paket_bidang_usaha->countRow() > 0) 
                        { 
                          if ($reqMultiBidangUsaha == '0') { // Salah satu terpenuhi 
                              ...
                              <tr>
                                ...
                                <?php
                                  ...
                                  if ($totalPenyedia==0) {
                                    ...
                                    if ($this->USER_TYPE_ID == '3') { // Panitia/Pokja tidak bisa lihat detail
                                      // echo '<span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia';
                          ...
                          } else { // Keseluruhan terpenuhi
                            $paket_bidang_usaha = new PaketBidangUsaha();
                            $paket_bidang_usaha->selectByParams(array("PAKET_ID" => coalesce($reqId, 0)));
                            $paket_bidang_usaha1 = new PaketBidangUsaha();
                            $paket_bidang_usaha1->selectByParams(array("PAKET_ID" => coalesce($reqId, 0)));
                            $queryKBLICount = 0;
                            while($paket_bidang_usaha->nextRow())
                            {
                              $queryKBLI[] = "'".$paket_bidang_usaha->getField("BIDANG_USAHA_ID")."'";
                              $paramKBLI[] = $paket_bidang_usaha->getField("BIDANG_USAHA_ID");
                          ...
                          <?php 
                              ...
                              $paket_bidang_usaha_check = new PaketBidangUsaha();
                              if ($reqKualifikasiRekanan == '3') { // 1:Kecil 2:Non-kecil 3:kecil/non-kecil
                                $paket_bidang_usaha_check->selectCountByParamsBidangUsaha2(array(),-1,-1,'AND A.bidang_usaha_id IN ('.implode(', ',$queryKBLI).')',$queryKBLICount);
                              } else {
                                $paket_bidang_usaha_check->selectCountByParamsBidangUsaha2(array('b.REKANAN_KUALIFIKASI_ID' => $reqKualifikasiRekanan),-1,-1,'AND A.bidang_usaha_id IN ('.implode(', ',$queryKBLI).')',$queryKBLICount);
                              }

                              $paket_bidang_usaha_check->firstRow();
                              $totalPenyedia = $paket_bidang_usaha_check->getField("COUNT") ? $paket_bidang_usaha_check->getField("COUNT") : 0;
                              if ($totalPenyedia==0) {
                                $queryKBLICount = '<span class="badge badge-danger" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia';
                              } else {
                                if ($this->USER_TYPE_ID == '3') { // Panitia/Pokja tidak bisa lihat detail
                                  // $queryKBLICount = '<span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia';
                                  // $queryKBLICount = '<a onClick="openAdd(\'main/loadUrl/main/bidang_usaha_check2?id='.implode(',',$paramKBLI).'|-|'.$reqKualifikasiRekanan.'\');"><span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia</a>';
                                  $queryKBLICount = '<span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia';
                                } else {
                                  // $queryKBLICount = '<a onClick="openAdd(\'main/loadUrl/main/bidang_usaha_check2?id='.implode(',',$paramKBLI).'|-|'.$reqKualifikasiRekanan.'\');"><span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia</a>';
                                  $queryKBLICount = '<span class="badge badge-primary" style="padding:5px 10px">'.$totalPenyedia.'</span> Penyedia';
                            ...
                            echo '<tr><td colspan="2">'.$queryKBLICount.'</td></tr>';
                          }
                        }
                        ?>
                      </tbody>
