	...
	$(function(){
		$('#ff').form({
			...
			success:function(data){
				...
				// document.location.href = 'main/index/paket_lelang_tambah_jadwal/?reqPer=<?=$reqPer?>';
				document.location.href = 'main/index/paket_lelang_tambah_rincian_pekerjaan_permohonan/?reqPer=<?=$reqPer?>';
				// document.location.href = 'main/index/permohonan_paket_fungsional';
			}
		});
        ...
        <div class="card-body">
          ...
          <?php
	        ...
	        <div class="form-actions">
			    ...
			    <a href="main/index/permohonan_paket_fungsional_add/?reqId=<?=$reqPer?>" class="btn btn-danger mr-1 text-white"> <i class="fa fa-arrow-left"></i> Kembali </a> 
