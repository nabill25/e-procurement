...
$(document).ready(function() {
	...
	oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 10,
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "rekanan_tipe_json/json",
		...
		new $.fn.dataTable.Responsive( oTable );
		  ...
		  $("#example tbody").click(function(event) {
		   ...
		   $('#btnAdd').on('click', function () {
			  openAdd("main/loadUrl/main/master_rekanan_tipe_add");
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  openAdd("main/loadUrl/main/master_rekanan_tipe_add/?reqId="+anSelectedId);
		  ...
		  $('#btnDelete').on('click', function () {
				...
				deleteDataWithNotif("rekanan_tipe_json/delete/", anSelectedId);
		  });
...
{
	oTable.fnReloadAjax("rekanan_tipe_json/json");
}
  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Bentuk Usaha </h4>
