                        ...
                        <div class="card-body">
                          <ul class="menu-icons">
                            ...
                            <li> 
                              ...
                              <li> 
                                <div>
                                  <a title="" href="main/loadUrl/main/daftar_rekanan_administrasi_ijin/?reqId=<?=$reqId?>&reqIjinUsahaId=1" target="popupFrame"><span class="fa fa-angle-double-right"></span>
                                  SIUP</a>
                                </div>
                              </li>  
                              <li> 
                                <div>
                                  <a title="" href="main/loadUrl/main/daftar_rekanan_administrasi_ijin/?reqId=<?=$reqId?>&reqIjinUsahaId=3" target="popupFrame"><span class="fa fa-angle-double-right"></span>
                                  SIUJK</a>
                                </div>
                              </li>  
                              <li> 
                                <div>
                                  <a title="" href="main/loadUrl/main/daftar_rekanan_administrasi_ijin/?reqId=<?=$reqId?>&reqIjinUsahaId=4" target="popupFrame"><span class="fa fa-angle-double-right"></span>
                                  SIUI</a>
                                </div>
                              </li>  
                              <li> 
                                <div>
                                  <a title="" href="main/loadUrl/main/daftar_rekanan_administrasi_ijin/?reqId=<?=$reqId?>&reqIjinUsahaId=5" target="popupFrame"><span class="fa fa-angle-double-right"></span>
                                  Ijin Lain</a>
                                </div>
                              </li>  
                              <li> 
                            ...
                            if ($reqRekananTipeId != '7') { ?>
                              ...
                              <li> 
                                <div>
                                  ...
                                  Laporan Pajak Bulanan(PPH/PPN)</a>
                                </div>
                              </li>   
                            <?php 
                            } else { ?> 
