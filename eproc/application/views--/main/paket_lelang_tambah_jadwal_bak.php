                                            ...
                                            ?>
                                                <tr valign="top" class="gelap">
                                                  <td><?=$no?>.</td>
                                                    ...
                                                    <td>                                    
                                                    <input type="text" class="easyui-datebox" name="reqTanggalMulai[<?=$i?>]" id="reqTanggalMulai<?=$i?>" value="<?=$tmpTanggalMulai?>" <? if($disabledTanggalAwal == "1") { ?> readonly style="width:80px; background:#F1F1F1;" <? } else { ?> style="width:80px"  <? } ?> />                                                    
                                                    </td>
                                                    ...
                                                    <td><input type="text" class="easyui-datebox" style="width:80px" name="reqTanggalSelesai[<?=$i?>]" id="reqTanggalSelesai<?=$i?>" onchange="checkTanggal('reqTanggalMulai<?=$i?>', 'reqTanggalSelesai<?=$i?>')" value="<?=datetimeToPage($metode->getField("TANGGAL_AKHIR"), "date")?>" />
                                                    </td>
                                                    <?
                                                ...
                                                if($metode->getField("JENIS_TAHAP") == 1 || $metode->getField("JENIS_TAHAP") == 2 || $metode->getField("JENIS_TAHAP") == 7 || $metode->getField("JENIS_TAHAP") == 11 || $metode->getField("JENIS_TAHAP") == 12)
                                                {
                                                    ...
                                                    ?>
                                                        <tr valign="top" class="gelap">
                                                            ...
                                                            <td></td>
                                                            <td>
                                                                <input type="text" class="easyui-datebox" style="width:80px" name="reqTanggalPublish" id="reqTanggalPublish" value="<?=$tempPublishTanggal?>" />                                                                
                                                            </td>
                                                            <td>
