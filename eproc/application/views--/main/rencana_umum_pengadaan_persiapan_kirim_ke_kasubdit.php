...
<html lang="en">
  <head>
    ...
    $(function(){
      $('#ff').form({
        url:'permohonan_paket_usulan_json/permohonan_usulan_add_kirim_ke_kasubdit',
        onSubmit:function(){
          $('#btnSubmit').html('<i class="fa fa-send"></i> Proses . . .');
          return $(this).form('validate');
        },
        success:function(data){
          $('#btnSubmit').html('<i class="fa fa-send"></i> Kirim ke Kasubdit');
      ...
      <div class="p-1">
        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" style="width:100%">
          ...
          <div class="form-actions">
            ...
            <button id="btnSubmit" type="submit" class="<?= CLASS_BTN_PRIMARY ?>"> <i class="fa fa-send"></i> Kirim ke Kasubdit</button>
          </div>
