...
<html lang="en">
  ...
  <script type="text/javascript">
    ...
    function getNotif(a,b) {
      console.log(a);
      $.getJSON("chat_json/getNotif/<?= $reqId ?>/2/"+b, function(data) {
        if (data.countchat > 0) {
    ...
    function updateRead() {
      ...
      if (rekananid) {
        $.getJSON("chat_json/updateRead?reqId=<?= $reqId ?>&reqJenis=2&reqRekananId="+rekananid, function(data) {
        });
      }
    }
                ...
                <div class="row">
                  <div class="col-md-3 text-left">
                    ...
                    for ($i=0; $i < $totalRekanan; $i++) { 
                      ...
                      $rekanan = new Rekanan();
                      // $rekanan->selectByParams(array("A.REKANAN_ID" => decryptIkn($reqRekananId[$i])));
