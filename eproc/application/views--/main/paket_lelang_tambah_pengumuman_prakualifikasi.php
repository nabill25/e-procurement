  ...
  <div class="col-md-12 col-sm-12">
    <div class="card">
      <div class="card-header card-head-inverse bg-primary">
        <h4 class="card-title text-white">Pengumuman Prakualifikasi 
        </h4>
              ...
              <div class="form-group col-md-12 mb-2">
                ...
                <?php 
                	$paket_dokumen = new PaketDokumen();
        					$paket_dokumen->selectByParams(array("PAKET_ID" => $reqId, "JENIS_DOKUMEN" => "PENGUMUMAN_PRA"));
                  ...
                  <?php   if ($paket_dokumen->getField("PATH_FILE")=='')
                      ...
                      {
                  ?>
                  <div>temp : <?=$paket_dokumen->getField("PATH_FILE")?></div><br>
