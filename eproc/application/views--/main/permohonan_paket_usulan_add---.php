              ...
              <div class="card-body" id="body-content-pr">
                ...
                <div class="tab-content px-1 pt-1">
                  ...
                  if ($reqStatusApprovalAnalisa == '4') {
                     echo '<div class="alert alert-info"> <b><i>Catatan Kasubdit </i></b>: '.$reqNoteKasubdit.'</div>';
                   } ?>
                      <div class="row">
                              ...
                              <div class="card-content">
                                ...
                                <div class="row mt-2">
                                  ...
                                  <div class="form-group col-md-4 mb-2">
                                    <label>Jenis Kontrak</label>
                                       <input type="text" name="reqJenisKontrak" class="easyui-combobox span4" data-options="valueField:'id',textField:'text',url:'contracting_json/comboJenisKontrak'"  value="<?=$reqJenisKontrak?>" style="width: 300% !important" required/>
                                  </div>
                                  <!-- <div class="form-group col-md-4 mb-2">
                                ...
                                <div class="p-1">
                                  <div class="alert bg-primary alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                                    ...
                                    if ($countCek && ($reqStatusApprovalAnalisa == '3' || $reqStatusApprovalAnalisa == '4')) { ?>
                                     <div class="badge badge-pill badge-warning">
                                        <a onclick="createRowNotaDinas()" data-toogle=""><span class="fa fa-plus text-white icon-line-height" data-toggle="tooltip" data-placement="top" title="Tambah Data"></span> Tambah Dok &nbsp;&nbsp;</a>
                                      </div>
                                    <?php 
                                    } ?>
                                  ...
                                  <div class="form-actions">
                                    ...
                                    if ($totalFile >= 1 && ($reqStatusApprovalAnalisa == '3' || $reqStatusApprovalAnalisa == '4')) { ?>
                            ...
                            <tbody> 
                              ...
                              if ($Permohonanpaketapprovalrevisi->countRow() > 0) {
                                while ($Permohonanpaketapprovalrevisi->nextRow()) {
                                  ...
                                  echo    '<td class="text-center"><a target="_blank" href="uploads/permohonan/'.$Permohonanpaketapprovalrevisi->getField('FILE').'"><span class="fa fa-download"></span> Download</a></td>';
                                  } else {
