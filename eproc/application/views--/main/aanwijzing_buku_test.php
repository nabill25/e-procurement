...
<html lang="en" class="no-js">
	<head>
        ...
        <!-- FONT AWESOME -->
        <link rel="stylesheet" href="lib/font-awesome-4.7.0/css/font-awesome.css" type="text/css"><?php */?>
...
<body>
    <div class="container container-aps">
        <div class="row">
            <div class="col-md-12">
                <div class="menu-panel" style="overflow:scroll; border:4px solid green !important; position:absolute;">
                ...
                <div class="bb-custom-wrapper">
                    ...
                    ?>
                        <div class="bb-item" id="item<?=$i?>">
                            ...
                            <div id="separuh-kiri-tombol" style="border:10px solid red;">
                            <?
                            if($this->USER_TYPE_ID == 6)
                            {
                            ...
                            <div id="separuh-kiri" style="background-size:100% 100%; border:10px solid yellow;">
                                <img src="uploads/lelang/<?=substr($prefix_halaman,0, strlen($prefix_halaman)-4)?>_<?=$i?>.Jpeg">
                            </div>
                            <div id="separuh-kanan" style="border:10px solid cyan;">
