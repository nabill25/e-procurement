...
|--------------------------------------------------------------------------
|
| Limit connections to your REST server to allowed IP addresses
|
| Usage:
| 1. Set to TRUE and select an auth option for extreme security (client's IP
|    address must be in allow and they must also log in)
| 2. Set to TRUE with auth set to FALSE to allow allowed IPs access with no login
| 3. Set to FALSE but set 'auth_override_class_method' to 'allow' to
|    restrict certain methods to IPs in your allow
|
*/
$config['rest_allowed_ip_enabled'] = FALSE;
...
|--------------------------------------------------------------------------
|
| Prevent connections to the REST server from denied IP addresses
|
| Usage:
| 1. Set to TRUE and add any IP address to 'rest_deny_ip'
|
*/
$config['rest_deny_ip_enabled'] = FALSE;
