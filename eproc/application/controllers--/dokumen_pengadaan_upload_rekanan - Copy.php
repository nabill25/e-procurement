...
class dokumen_pengadaan_upload_rekanan extends CI_Controller {
	...
	function email() 
	{
		...
		if($paketInfo->sistem_sampul == "2")
		{
			...
			$reqFilename  = "1_".$paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number."-".$paket_rekanan->getField("KODE_REKANAN");
			$reqToken	  = md5("1_".$paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number.$paket_rekanan->getField("TANGGAL_DAFTAR_ENKRIPSI").$paket_rekanan->getField("KODE_REKANAN").$reqId.$paketInfo->user_login_id);
			...
			$reqFilename2 = "2_".$paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number."-".$paket_rekanan->getField("KODE_REKANAN");
			$reqToken2	  = md5("2_".$paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number.$paket_rekanan->getField("TANGGAL_DAFTAR_ENKRIPSI").$paket_rekanan->getField("KODE_REKANAN").$reqId.$paketInfo->user_login_id);			
			...
			$mail->Subject  =  "Konfirmasi Upload Dokumen Penawaran Sistem 2(dua) Sampul";
		...
		{
			$reqFilename= $paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number."-".$paket_rekanan->getField("KODE_REKANAN");
			$reqToken= md5($paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number.$paket_rekanan->getField("TANGGAL_DAFTAR_ENKRIPSI").$paket_rekanan->getField("KODE_REKANAN").$reqId.$paketInfo->user_login_id);
	...
	function upload_password_penawaran()
	{
		...
		if($reqSistemSampul == "2")
			$reqFileValidasi = "1_".$paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number."-".$paket_rekanan_validasi->getField("KODE_REKANAN").".cert";
		else
			$reqFileValidasi = $paketInfo->publish_ba_penawaran.$paketInfo->pr_group_number."-".$paket_rekanan_validasi->getField("KODE_REKANAN").".cert";
	...
	function upload_password_penawaran_sampul2()
	{
		...
		$reqFileValidasi = "2_".$paketInfo->pr_group_number."-".$paket_rekanan_validasi->getField("KODE_REKANAN").".cert";
