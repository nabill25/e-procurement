...
class Main extends CI_Controller {
	...
	function __construct() {
		   ...
		   stristr($this->uri->segment(3, ""), "paket_lelang_tambah"))
		{
			...
			if($this->USER_TYPE_ID == "3" || $this->USER_TYPE_ID == "7" || $this->USER_TYPE_ID == "9" || $this->USER_TYPE_ID == "11" || $this->USER_TYPE_ID == "12") // ikn tambah buat 7=Kepala Pengadaan 11:pejabat pengadaan 12:Kontrak
			{}
			else
				redirect(base_url());
		}
		...
		{
			if($this->USER_TYPE_ID == "1" || $this->USER_TYPE_ID == "2" || $this->USER_TYPE_ID == "11" || $this->USER_TYPE_ID == "3" || $this->USER_TYPE_ID == "18"|| $this->USER_TYPE_ID == "19" || $this->USER_TYPE_ID == "26") // 1:admin, 2. admin vms, 18:approval vms, 19:Rekomendasi VMS, 26:Senior Manager, 11:Pejabat Pengedaan, 3: Pokja
			{}
			else
				redirect(base_url());
		}
