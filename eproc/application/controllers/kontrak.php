...
class Kontrak extends CI_Controller {
	...
	function __construct() {
		   ...
		   stristr($this->uri->segment(3, ""), "paket_lelang_tambah"))
		{
			...
			if($this->USER_TYPE_ID == "3" || $this->USER_TYPE_ID == "7" || $this->USER_TYPE_ID == "9" || $this->USER_TYPE_ID == "11" || $this->USER_TYPE_ID == "12") // ikn tambah buat 7=fronliner 11:pejabat pengadaan 12:Kontrak
			{}
			else
