...
class contracting_json extends CI_Controller {
	...
	function contracting_paket()
	{
		...
		$statement  .= " AND A.UNIT_KERJA_ID = '".$this->UNIT_KERJA_ID."' "; // Update 11-07-2026
	...
	function pic_combo_json()
	{
		...
		$user_login->selectByParams(array(),-1,-1," AND UNIT_KERJA_ID = '".$unitkerja."' AND USER_AKTIF = '1' AND USER_TYPE_ID = '12' AND LEVEL_KONTRAK = '1' ");
	...
	function pic_pengendali_combo_json()
	{
		...
		$user_login->selectByParams(array(),-1,-1," AND UNIT_KERJA_ID = '".$unitkerja."' AND USER_AKTIF = '1' AND USER_TYPE_ID = '12' AND LEVEL_KONTRAK = '2' ");
	...
	function pic_penyelesai_combo_json()
	{
		...
		$user_login->selectByParams(array(),-1,-1," AND UNIT_KERJA_ID = '".$unitkerja."' AND USER_AKTIF = '1' AND USER_TYPE_ID = '12' AND LEVEL_KONTRAK = '3' ");
	...
	function tunjuk_pic_bypass()
	{
		...
		if($paket->updatePICKontrakBypass()) {
			// Insert Rekam Jejak
		    $this->load->library("librekamjejak");
		    $this->librekamjejak->insertRJ('901','',$reqId,'null','901');
		    // param 1: Posisi/'1-22', param 2: Keterangan/'', param 3: Paket_id/'null', param 4: permohonan_id/'null'
