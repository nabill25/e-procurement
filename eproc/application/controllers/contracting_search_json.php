...
class contracting_search_json extends CI_Controller {
	...
	function json()
  	{
	    ...
	    if(isset($reqPage)){
          ...
          $arrSerialized = str_replace('"', '@', $arrSerialized);   
      		$pagConfig = array('baseURL'=>'contracting_search_json/json', 'showRecord' => '\''.$reqShow.'\'', 'totalRows'=>$rowCount, 'currentPage'=>$dsplyStart, 'perPage'=>$dsplyRange, 'contentDiv'=>$reqContent, 'searchText' => $reqPencarian, 'arrSerialized' => $this->input->post("array_serialized"));
