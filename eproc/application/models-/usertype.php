 ...
 */
  ...
  class UserType extends Entity{ 
    ...
    **/ 
	...
	{
		$str = "SELECT USER_TYPE_ID, NAMA
				FROM USER_TYPE WHERE USER_TYPE_ID IS NOT NULL"; 
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(USER_TYPE_ID) AS ROWCOUNT FROM USER_TYPE WHERE USER_TYPE_ID IS NOT NULL "; 
		while(list($key,$val)=each($paramsArray))
		{
			$str .= " AND $key = '$val' ";
		}
