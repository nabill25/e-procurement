  ...
  class PermohonanPaket extends Entity{
    ...
    **/
	...
	function insert()
	{
		...
		// 	   NOTA_DINAS, NAMA, KETERANGAN, NO_PPA, TANGGAL, LAST_CREATE_USER, NILAI, PENGADAANLANGSUNG,BUDGET_AWAL,BUDGET_TERPAKAI,BUDGET_AKHIR,TAHUN_ANGGARAN)
    ...
    function insertPermohonan()
	{
		...
		$str = "
			...
			INSERT INTO PERMOHONAN_PAKET (
			   ...
			   ANGGARAN, JENIS_BARANG_JASA, PERKIRAAN_BIAYA_HARGA, NILAI, WAKTU_PENGGUNA_BARANGJASA, RENCANA_PENGADAAN, LAST_CREATE_USER, LAST_CREATE_DATE, CARA_PENGADAAN, USER_LOGIN_ID, UNIT_KERJA_ID,CREATED_BY,CREATED_DATE)
