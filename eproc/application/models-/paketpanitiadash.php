 ...
 */
  ...
  class Paketpanitiadash extends Entity{
  ...
  //   ";
		...
		if ($tahun == '' || $tahun == 'all') {
			if ($unitkerja == 'all') {
				$str = "
					...
					and z.paket_metode_lelang_id=1 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=3 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Terbatas,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=8 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Kompetisi,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=7 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Cepat,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=2 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pengadaan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=5 and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Penunjukan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					...
					from (
					SELECT cast(a.month_angka as text and (z.user_login_id=".$userloginid." OR z.user_tim_pengadaan && ARRAY[".$userloginid."] )), a.month_ina
					from month a
				...
				$str = "
					...
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=1 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=3 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Terbatas,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=8 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Kompetisi,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=7 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Cepat,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=2 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pengadaan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=5 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Penunjukan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=6 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=9 and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Offline
					from (
			...
			if ($unitkerja == 'all') {
				$str = "
					...
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=3
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Terbatas,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=8
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Kompetisi,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=7
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Cepat,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=2
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pengadaan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=5
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Penunjukan_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=6
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Langsung,
					( SELECT count(z.paket_id)
					from view_paket_dashboard z
					where
					z.bulan_permohonan_angka = a.month_angka
					and z.paket_metode_lelang_id=9
					and z.tahun_anggaran = '".$tahun."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Offline
					from (
					SELECT cast(a.month_angka as text), a.month_ina
					from month a
					order by a.month_id asc
		  	...
		  	";
				...
				$str = "
						...
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=1
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=3
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Terbatas,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=8
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Kompetisi,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=7
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Tender_Cepat,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=2
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pengadaan_Langsung,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=5
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Penunjukan_Langsung,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=6
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Langsung,
						( SELECT count(z.paket_id)
						from view_paket_dashboard z
						where
						z.bulan_permohonan_angka = a.month_angka
						and z.paket_metode_lelang_id=9
						and z.tahun_anggaran = '".$tahun."' and z.unit_kerja_id='".$unitkerja."' and (z.user_login_id=".$userloginid." or z.user_tim_pengadaan && ARRAY[".$userloginid."] )) Pembelian_Offline
						from (
						SELECT cast(a.month_angka as text), a.month_ina
						from month a
						order by a.month_id asc
	...
	function getDashboardDetailPaket($metode_lelang,$tahun,$unitkerja,$userloginid,$bulan)
	{
		if ($tahun == '' || $tahun == 'all') {
			if ($unitkerja == 'all') {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_metode_lelang_id = '".$metode_lelang."'  and (a.user_login_id=".$userloginid." OR a.user_tim_pengadaan && ARRAY[".$userloginid."])
		  		";
			} else {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_metode_lelang_id = '".$metode_lelang."' and a.unit_kerja_id='".$unitkerja."' and  (a.user_login_id=".$userloginid." OR a.user_tim_pengadaan && ARRAY[".$userloginid."])
		  		";
			}
		} else {
			if ($unitkerja == 'all') {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_metode_lelang_id = '".$metode_lelang."' and a.tahun_anggaran = '".$tahun."' and (a.user_login_id=".$userloginid." OR a.user_tim_pengadaan && ARRAY[".$userloginid."])
			  	";
			} else {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_metode_lelang_id = '".$metode_lelang."' and a.tahun_anggaran = '".$tahun."' and a.unit_kerja_id='".$unitkerja."' and (a.user_login_id=".$userloginid." OR a.user_tim_pengadaan && ARRAY[".$userloginid."])
			  	";
			}
		}
	...
	function getDashboardDetailPaket2($metode_lelang,$tahun,$bulan,$userloginid)
	{
		if ($tahun == '' || $tahun == 'all') {
			...
			$str = "
				SELECT a.* from view_paket_dashboard a
				WHERE a.paket_metode_lelang_id = '".$metode_lelang."' and a.tahun_anggaran = '".$tahun."' and a.month_ina = '".$bulan."' and a.user_login_id=".$userloginid."
		  	";
		}
	...
	function getDashboardPie($unitkerja,$userloginid,$tahun=null)
	{
		if ($tahun == '' || $tahun == 'all') {
				$str = "SELECT paket_jenis_id_nama, count(paket_jenis_id) total
					...
					WHERE unit_kerja_id = '".$unitkerja."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
				...
				$str = "SELECT paket_jenis_id_nama, count(paket_jenis_id) total
					FROM view_paket_dashboard
					WHERE tahun_anggaran = '".$tahun."' AND unit_kerja_id = '".$unitkerja."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
					GROUP BY paket_jenis_id_nama, paket_jenis_id
					ORDER BY paket_jenis_id ASC
					";
		}
	...
	function getDashboardPieDetail($unitkerja,$paketjenis,$tahun,$userloginid)
	{
		if ($tahun == '' || $tahun == 'all') {
			if ($unitkerja == 'all') {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_jenis_id = '".$paketjenis."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
		  		";
			} else {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_jenis_id = '".$paketjenis."' and a.unit_kerja_id = '".$unitkerja."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
		  		";
			}
		} else {
			if ($unitkerja == 'all') {
				$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_jenis_id = '".$paketjenis."' and a.tahun_anggaran = '".$tahun."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
			  	";
			 } else {
			 	$str = "
					SELECT a.* from view_paket_dashboard a
					WHERE a.paket_jenis_id = '".$paketjenis."' and a.tahun_anggaran = '".$tahun."' and a.unit_kerja_id = '".$unitkerja."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])
			  	";
			 }
		}
		// echo $str;
	...
	function getDashboardGauge($unitkerja,$userloginid,$tahun=null)
	{
		if ($tahun == '' || $tahun == 'all') {
			if ($unitkerja == 'all') {
				$str = "SELECT
						(select count(paket_id) total_paket from view_dashboard_paket_proses WHERE (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])),
						(select count(paket_id) total_paket_proses from view_dashboard_paket_proses where proses = '1' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."]))
						";
			} else {
				$str = "SELECT
					(select count(paket_id) total_paket from view_dashboard_paket_proses where unit_kerja_id = '".$unitkerja."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])),
					(select count(paket_id) total_paket_proses from view_dashboard_paket_proses where proses = '1' and unit_kerja_id = '".$unitkerja."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."]))
					";
			}
		} else {
			if ($unitkerja == 'all') {
				$str = "SELECT
						(select count(paket_id) total_paket from view_dashboard_paket_proses where tahun_anggaran='".$tahun."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])),
						(select count(paket_id) total_paket_proses from view_dashboard_paket_proses where proses = '1' and tahun_anggaran='".$tahun."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."]))
						";
			} else {
				$str = "SELECT
						(select count(paket_id) total_paket from view_dashboard_paket_proses where tahun_anggaran='".$tahun."' and unit_kerja_id = '".$unitkerja."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."])),
						(select count(paket_id) total_paket_proses from view_dashboard_paket_proses where proses = '1' and tahun_anggaran='".$tahun."' and unit_kerja_id = '".$unitkerja."' AND (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."]))
						";
			}
		}
		// echo $str;
	...
	{
    	$str = "SELECT * from view_dashboard_paket_proses WHERE unit_kerja_id = '".$unitkerja."' and (user_login_id=".$userloginid." OR user_tim_pengadaan && ARRAY[".$userloginid."]) ";
		if ($tahun == '' || $tahun == 'all') {
		} else {
...
//		echo $str;
    ...
    function getCountByParams($paramsArray=array(), $statement='')
	{
		$str = "select COUNT(*) AS ROWCOUNT
                  ...
                  SELECT A.* FROM (
                    ...
                    (SELECT ARRAY_AGG ( DISTINCT X.USER_LOGIN_ID ) PAKET_PANITIA_ID FROM PAKET_PANITIA V JOIN USER_LOGIN X ON V.NIP=X.NIP WHERE V.PAKET_ID=A.PAKET_ID) USER_TIM_PENGADAAN,
										...
										A.JENIS_PENGADAAN, PR_GROUP_NUMBER, A.LOKASI, A.TANGGAL, date_part('month'::text, A.tanggal) AS bulan, date_part('month'::text, I.tanggal) AS bulan_permohonan, date_part('year'::text, A.tanggal) AS TAHUN, date_part('year'::text, I.RENCANA_PENGADAAN) AS TAHUN_PERMOHONAN, I.TAHUN_ANGGARAN, I.PERMOHONAN_PAKET_ID
                    FROM    PAKET A
                            LEFT JOIN PAKET_METODE_LELANG B ON A.PAKET_METODE_LELANG_ID = B.PAKET_METODE_LELANG_ID
                            LEFT JOIN PAKET_METODE_KUALIFIKASI C ON A.PAKET_METODE_KUALIFIKASI_ID = C.PAKET_METODE_KUALIFIKASI_ID
                            LEFT JOIN PAKET_METODE_EVALUASI D ON A.PAKET_METODE_EVALUASI_ID = D.PAKET_METODE_EVALUASI_ID
    ...
    function getSumByParams($paramsArray=array(), $statement='')
	{
		$str = "select SUM(NILAI) AS ROWCOUNT
                        from ( SELECT
                      A.NILAI, A.PAKET_METODE_LELANG_ID, A.TANGGAL, A.UNIT_KERJA_ID, A.USER_LOGIN_ID,
                      (
						SELECT
							ARRAY_AGG ( DISTINCT X.USER_LOGIN_ID ) PAKET_PANITIA_ID
						FROM
							PAKET_PANITIA V
							JOIN USER_LOGIN X ON V.NIP = X.NIP
						WHERE
							V.PAKET_ID = A.PAKET_ID
						) USER_TIM_PENGADAAN,
						date_part('month'::text, A.tanggal) AS bulan, date_part('month'::text, I.RENCANA_PENGADAAN) AS bulan_permohonan, date_part('year'::text, A.tanggal) AS TAHUN, date_part('year'::text, I.RENCANA_PENGADAAN) AS TAHUN_PERMOHONAN, I.TAHUN_ANGGARAN
                    FROM    PAKET A
                            LEFT JOIN PAKET_METODE_LELANG B ON A.PAKET_METODE_LELANG_ID = B.PAKET_METODE_LELANG_ID
                            LEFT JOIN PAKET_METODE_KUALIFIKASI C ON A.PAKET_METODE_KUALIFIKASI_ID = C.PAKET_METODE_KUALIFIKASI_ID
                            LEFT JOIN PAKET_METODE_EVALUASI D ON A.PAKET_METODE_EVALUASI_ID = D.PAKET_METODE_EVALUASI_ID
