...
//                        @return boolean
                        ...
                        public function set_file_name($filename)
                        {
                            ...
                            if(is_array($filename)){
                                    ...
                                    $this->_multi_file_name_override = $filename;
                            //Single file upload.
                            } else {
                                    //Set file name override.
                                    $this->_file_name_override = $filename;
...
//                        set file_name_as_prefix on the fly
                        
                        public function set_file_name_as_prefix($flag = FALSE){
                            $this->file_name_as_prefix = ($flag == TRUE) ? TRUE : FALSE;
                        }
						...
						if(!empty($this->_multi_file_name_override[$i])){
							...
							if(!$this->is_allowed_filetype(TRUE)){
								...
								return FALSE;
                                                ...
                                                else if($this->_file_name_override != '' AND $this->file_name_as_prefix == TRUE)
                                                {
                                                    $this->file_name = $this->_prep_filename($this->_file_name_override.'_'.$this->file_name);
