...
class libbreadcrumb
{
    ...
    function breadikn($pg,$reqId)
    {
      ...
      switch ($pg) {
        ...
        case 'blacklist_kontrak':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Daftar Blacklist Kontrak</li>";
          break;
        ...
        case 'data_administrasi_ijin_usaha':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Data Administrasi</li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> N I B</li>";
        break;

        case 'data_administrasi_ijin_usaha_ubah':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Data Administrasi</li>";
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/data_administrasi_ijin_usaha\">N I B</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Form</li>";
        break;
        ...
        case 'permohonan_penunjukan_pic':
          if ($this->_CI->USER_TYPE_ID == '7') { // Manajer Peng.
              $lablePIC = 'Ketua';
            } else {
              $lablePIC = 'PIC';
            } 
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Penunjukan ".$lablePIC." Paket</li>";
          break;
        ...
        case 'permohonan_paket_pic_add':
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/rencana_umum_pengadaan_persiapan\">Persiapan</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Metode Pengadaan</li>";
          break;
        ...
        case 'contracting_pengguna':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Penilaian </li>";
        break;

        case 'contracting_po':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Update No. PO </li>";
        break;

        case 'contracting_paket_sppbj':
        ...
        case 'contracting_paket':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item active\">Selesai Pemilihan</li>";
        ...
        case 'contracting_penunjukan_pic':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Penunjukan PIC</li>";
        break;
        ...
        case 'contracting_surat_perjanjian':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item\"> <a href=\"kontrak/index/contracting_paket_sppbj?tahun=".$getTahun."\">SPPBJ</a></li>";
        ...
        case 'contracting_detail':
          ...
          if ($this->_CI->LEVEL_KONTRAK == '3' && $contractingrekanan->getField('CONTRACTINGPROSESID') == '3') {
            $breadcrumb .= "<li class=\"breadcrumb-item\"> <a href=\"kontrak/index/contracting_serah_terima\">Kontrak</a></li>";
          } else {
            $breadcrumb .= "<li class=\"breadcrumb-item\"> <a href=\"".$contractingrekanan->getField('CP_LINK')."?tahun=".$getTahun."\">Kontrak</a></li>";
          }
          // if ($reqProses == '4') {
        ...
        case 'contracting_serah_terima':
          $getTahun = $this->_CI->session->userdata('setTahunKontrak') ?: 'all';
          // $breadcrumb .= "<li class=\"breadcrumb-item active\">Manajemen Kontrak</li>";
          // $breadcrumb .= "<li class=\"breadcrumb-item active\"><a href=\"kontrak/index/contracting_persiapan?tahun=".$getTahun."\">Persiapan</a></li>";

          // $breadcrumb .= "<li class=\"breadcrumb-item\"> <a href=\"kontrak/index/contracting_dashboard?tahun=".$getTahun."\">Kontrak</a></li>";

          $pg = str_replace("contracting_persiapan", "Kontrak", $pg).'';
          $pg = str_replace("contracting_pengelolaan", "Pengendalian", $pg).'';
          $pg = str_replace("contracting_permasalahan", "Pengendalian ", $pg).'';
          $pg = str_replace("contracting_serah_terima", "Penyelesaian", $pg).'';
          $pg = str_replace("sppbj", "SPPBJ", $pg).'';
          $pg = str_replace('contracting', '', $pg);
          $breadcrumb .= "<li class=\"breadcrumb-item active\">".ucwords(str_replace("_", " ", $pg))."</li>";
        ...
        case 'contracting_pengelolaan_realisasi_multi';
          ...
          elseif ($pg == 'contracting_notifikasi'): $active = 'Notifikasi';
          elseif ($pg == 'contracting_persiapan_kontrak'): $active = 'Kontrak';
        ...
        case 'data_perpajakan_pkp':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Data Perpajakan </li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> PKP - Non PKP </li>";
          break;
        ...
        case 'permohonan_paket_kaji_ulang':
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Kaji Ulang</li>";
          break;

        case 'permohonan_paket_kaji_ulang_add':
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/permohonan_paket_kaji_ulang\">Kaji Ulang</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\"> Forum</li>";
          break;
        ...
        case 'paket_lelang_tambah_negosiasi_undangan':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/paket_detil/?eid=".$reqId."&key=".$uuid."\">Paket Detail</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\">Setting Notifikasi Pembuktian</li>";
        break;
        ...
        case 'klarifikasi_chat':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/paket_detil/?eid=".$reqId."&key=".$uuid."\">Paket Detail</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item active\">Pembuktian Dokumen Penawaran</li>";
        break;
        ...
        case 'klarifikasi_chat_tanggapan':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/paket_detil/?eid=".$reqId."&key=".$uuid."\">Paket Detail</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/klarifikasi_chat/?reqId=".$reqId."\">Pembuktian Dokumen Penawaran</a></li>";
        ...
        case 'negosiasi_item_rekanan':
          ...
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/paket_detil/?eid=".$reqId."&key=".$uuid."\">Paket Detail</a></li>";
          $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/negosiasi_rekanan/?reqId=".$reqId."\">Negosiasi</a></li>";
        ...
        case 'paket_lelang_tambah_bypass': 
              $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"kontrak/index/paket_detil_bypass/?eid=".$reqId."&key=".$uuid."\">Paket Detail Bypass</a></li>";
              $breadcrumb .= "<li class=\"breadcrumb-item active\"> Edit</li>";
          break;

        case 'paket_lelang_tambah_jadwal_bypass': 
              $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"kontrak/index/paket_detil_bypass/?eid=".$reqId."&key=".$uuid."\">Paket Detail Bypass</a></li>";
              $breadcrumb .= "<li class=\"breadcrumb-item active\"> Jadwal</li>";
          break;

        case 'paket_lelang_tambah_daftar_peserta_bypass': 
              $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"kontrak/index/paket_detil_bypass/?eid=".$reqId."&key=".$uuid."\">Paket Detail Bypass</a></li>";
              $breadcrumb .= "<li class=\"breadcrumb-item active\"> Peserta</li>";
          break;

        case 'paket_lelang_tambah_penentuan_pemenang_bypass': 
              $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"kontrak/index/paket_detil_bypass/?eid=".$reqId."&key=".$uuid."\">Paket Detail Bypass</a></li>";
              $breadcrumb .= "<li class=\"breadcrumb-item active\"> Penetapan Pemenang</li>";
          break;
        ...
        default:
          if (stristr($pg, "paket_lelang_tambah")) {
            ...
            if ($pg_monitoring == '_rincian_pekerjaan_permohonan') {
              ...
              if ($pg == 'paket_lelang_tambah_negosiasi_item') {
                $breadcrumb .= "<li class=\"breadcrumb-item\"><a href=\"main/index/paket_lelang_tambah_negosiasi/?reqId=".$reqId."\">Negosiasi</a></li>";
              }
    ...
    function cetakcopyrightPenyedia()
    {
      $html  = '';
      $html .= 'Dokumen ini SAH dan dikeluarkan oleh sistem e-Procurement.';
      return $html;
    }
