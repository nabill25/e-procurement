...
$getApi = json_decode($curl->_simple_call('get','http://destination/api/paketdetail/13', array('key'=>'i760fa232aa251271f3abf6d91993af2f9f6b4k39en')), TRUE);
echo "<pre>"; print_r($getApi); 
