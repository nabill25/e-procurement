...
class bidang_usaha_json extends CI_Controller {
	...
	function json()
	{
		...
		// } else {
		// 	$bidang_usaha->selectByParamsAll(array("BIDANG_USAHA_PARENT_ID" => "0"), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%')) ");
		// 	$bidang_usaha->selectByParams(array(), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
		...
		while($bidang_usaha->nextRow())
		{
			...
			// $parent->selectByParamsAll(array("BIDANG_USAHA_PARENT_ID" => $bidang_usaha->getField("BIDANG_USAHA_ID")), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
			$parent->selectByParamsAll(array("BIDANG_USAHA_PARENT_ID" => $bidang_usaha->getField("BIDANG_USAHA_ID")), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%')) ");
	...
	function jsonaktif()
	{
		...
		while($bidang_usaha->nextRow())
		{
			...
			$parent = new BidangUsaha();
			$parent->selectByParams(array("BIDANG_USAHA_PARENT_ID" => $bidang_usaha->getField("BIDANG_USAHA_ID"), "BIDANG_USAHA_JENIS" => "1"), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
			...
			while($parent->nextRow())
			{
				...
				$child->selectByParams(array("BIDANG_USAHA_PARENT_ID" => $parent->getField("BIDANG_USAHA_ID")), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
				$k=0;
				while($child->nextRow())
				{
					$arr_child[$k]['id'] = $child->getField("BIDANG_USAHA_ID");
					$arr_child[$k]['text'] = $child->getField("NAMA_VIEW");
					$arr_child[$k]['aktif'] = $child->getField("STATUS_BIDANG_USAHA");


					$sub = new BidangUsaha();
					$sub->selectByParams(array("BIDANG_USAHA_PARENT_ID" => $child->getField("BIDANG_USAHA_ID")), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
					$l=0;
					while($sub->nextRow())
					{
						...
						$detil->selectByParams(array("BIDANG_USAHA_PARENT_ID" => $sub->getField("BIDANG_USAHA_ID")), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
						$m=0;
						while($detil->nextRow())
						{
	...
	function jsonaktifsbu()
	{
		...
		while($bidang_usaha->nextRow())
		{
			...
			$parent = new BidangUsaha();
			$parent->selectByParams(array("BIDANG_USAHA_PARENT_ID" => $bidang_usaha->getField("BIDANG_USAHA_ID"), "BIDANG_USAHA_JENIS" => "99"), -1, -1, " AND ((UPPER(NAMA) LIKE '%".strtoupper($reqSearch)."%') OR (UPPER(KODE) LIKE '%".strtoupper($reqSearch)."%') OR EXISTS(SELECT 1 FROM BIDANG_USAHA X WHERE UPPER(X.NAMA) LIKE '%".strtoupper($reqSearch)."%' AND X.BIDANG_USAHA_ID LIKE A.BIDANG_USAHA_ID || '%')) ");
