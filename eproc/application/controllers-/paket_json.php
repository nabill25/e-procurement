              ...
              <div class="p-1">
                ...
                <?php
                    ...
                    <p class="mb-0 mt-1">
                      ...
                      /* STATUS PEMBUAT PAKET PANITIA */
                      if($this->USER_TYPE_ID == 3 || $this->USER_TYPE_ID == 7 || $this->USER_TYPE_ID == 9  || $this->USER_TYPE_ID == 11 || $this->USER_TYPE_ID == 10 || $this->USER_TYPE_ID == 27 || $this->USER_TYPE_ID == 28) // panitia, kepala peng, pengguna, pejabat pembeli
                      {
                      ?>
                        <span class="badge badge-info">
                          <i class="fa fa-cog"></i> Pembuat Paket : <strong><?=$paket->getField("USER_LOGIN")?></strong>
